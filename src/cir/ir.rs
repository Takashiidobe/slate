...
impl CirOpKind {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            CirOpKind::AtomicClear => "cir.atomic.clear",
            CirOpKind::AtomicFence => "cir.atomic.fence",
            CirOpKind::AtomicFetch => "cir.atomic.fetch",
            CirOpKind::AtomicTestAndSet => "cir.atomic.test_and_set",
            ...
            CirOpKind::CleanupScope => "cir.cleanup.scope",
            ...
            CirOpKind::ReturnAddress => "cir.return_address",
