...
pub(crate) fn call_summary(name: &str) -> Option<CallSummary> {
    match name {
        ...
        "fflush" => Some(CallSummary::Fflush),
        "remove" => Some(CallSummary::Remove),
        "toupper" => Some(CallSummary::Toupper),
        "tolower" => Some(CallSummary::Tolower),
        "sin" => Some(CallSummary::Sin),
        "cos" => Some(CallSummary::Cos),
        "tan" => Some(CallSummary::Tan),
        "log" => Some(CallSummary::Log),
        "log10" => Some(CallSummary::Log10),
        "log2" => Some(CallSummary::Log2),
        "pow" => Some(CallSummary::Pow),
        "sqrt" => Some(CallSummary::Sqrt),
        "exp" => Some(CallSummary::Exp),
        "exp2" => Some(CallSummary::Exp2),
        "fmod" => Some(CallSummary::Fmod),
        "lround" => Some(CallSummary::Lround),
        "llround" => Some(CallSummary::Llround),
        "__muldc3" => Some(CallSummary::MulDc3),
        "__divdc3" => Some(CallSummary::DivDc3),
        "pthread_create" => Some(CallSummary::PthreadCreate),
        "pthread_join" => Some(CallSummary::PthreadJoin),
