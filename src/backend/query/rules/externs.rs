...
pub(in crate::backend) fn unused_known_declarations() -> QueryRule<Definition> {
    QueryRule::new(
...
pub(in crate::backend) fn unused_header(header: impl Into<String>) -> QueryRule<Definition> {
    QueryRule::new(
        Pass::PruneUnusedDefinitions,
        "prune_unused_header",
        Definition {
