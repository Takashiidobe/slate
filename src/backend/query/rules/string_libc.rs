use crate::backend::facts::{AsciiNumericSign, AstPath, PathSegment, StringLibcFunction};
...
fn string_kind_for_buffer(kind: crate::backend::facts::StringBufferKind) -> Option<StringKind> {
    use crate::backend::facts::StringBufferKind;
    match kind {
