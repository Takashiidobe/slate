...
use crate::backend::facts::{self, walk};
...
use crate::backend::salsa::{FixupDb, FunctionInput, ProgramInput, SalsaFacts};
...
pub(in crate::backend) struct NullCheckDominance {
    pub(in crate::backend) proof: NullCheckProof,
    pub(in crate::backend) guard_stmt: Option<StatementRef>,
}

#[derive(Debug, Clone, PartialEq, Eq, salsa::SalsaValue)]
pub(in crate::backend) struct OptionBoxLocalPlanInput<'db> {
    pub(in crate::backend) binding: BindingRef<'db>,
    pub(in crate::backend) elem_ty: Type,
    pub(in crate::backend) decl_stmt: StatementRef,
    pub(in crate::backend) assignments: Vec<OptionBoxAssignmentInput>,
    pub(in crate::backend) deref_sites: Vec<ExprSite>,
}

#[derive(Debug, Clone, PartialEq, Eq, salsa::SalsaValue)]
pub(in crate::backend) struct OptionBoxAssignmentInput {
    pub(in crate::backend) stmt: StatementRef,
    pub(in crate::backend) kind: OptionBoxAssignKind,
    pub(in crate::backend) alloc_source: Option<StatementRef>,
}

#[derive(Debug, Clone, PartialEq, Eq, salsa::SalsaValue)]
pub(in crate::backend) struct OptionBoxComparisonInput {
    pub(in crate::backend) if_stmt: StatementRef,
...
#[derive(Debug, Clone, PartialEq, Eq, salsa::SalsaValue)]
pub(in crate::backend) struct InterproceduralAllocCallerInput<'db> {
    pub(in crate::backend) caller: FunctionRef<'db>,
    pub(in crate::backend) pointer_name: String,
    pub(in crate::backend) decl_stmt: StatementRef,
    pub(in crate::backend) call_temp_stmt: StatementRef,
    pub(in crate::backend) free_stmt: Option<StatementRef>,
}

#[derive(Debug, Clone, PartialEq, Eq, salsa::SalsaValue)]
pub(in crate::backend) struct CallRecord {
    pub(in crate::backend) site: ExprSite,
    pub(in crate::backend) trivial_unsafe_site: Option<ExprSite>,
    pub(in crate::backend) target: CallTarget,
    pub(in crate::backend) args: Vec<ExprSite>,
    pub(in crate::backend) evidence: Vec<Evidence>,
}

pub(in crate::backend) struct QueryContext<'snapshot> {
...
impl<'db> ProgramInput {
    ...
    pub(in crate::backend) fn byte_source(
        self,
        db: &'db dyn FixupDb,
        site: ExprSite,
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn const_u8(self, db: &dyn FixupDb, site: ExprSite) -> QueryResult<u8> {
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn const_usize(
        self,
        db: &dyn FixupDb,
        site: ExprSite,
    ) -> QueryResult<usize> {
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn full_byte_view(
        self,
        db: &'db dyn FixupDb,
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn first_nul(
        self,
        db: &'db dyn FixupDb,
        source_site: ExprSite,
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn prefix_contains(
        self,
        db: &dyn FixupDb,
        count: ExprSite,
        nul: NulPosition,
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn counted_loop(
        self,
        db: &'db dyn FixupDb,
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn counted_slice_loop(
        self,
        db: &'db dyn FixupDb,
        statement: StatementRef,
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn lazy_singletons(
        self,
        db: &dyn FixupDb,
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn atomic_promotions(
        self,
        db: &dyn FixupDb,
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn callee_alloc_summary(
        self,
        db: &'db dyn FixupDb,
        item_index: usize,
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn interprocedural_alloc_eligibility(
        self,
        db: &'db dyn FixupDb,
        item_index: usize,
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn interprocedural_alloc_chain(
        self,
        db: &'db dyn FixupDb,
        item_index: usize,
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn interprocedural_alloc_callers(
        self,
        db: &'db dyn FixupDb,
        item_index: usize,
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn ptr_len_slice_plans(
        self,
        db: &'db dyn FixupDb,
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn proof_struct_field_ownership(
        self,
        db: &dyn FixupDb,
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn string_param_lift_indices(
        self,
        db: &'db dyn FixupDb,
        item_index: usize,
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn proof_function_by_name(
        self,
        db: &'db dyn FixupDb,
        name: String,
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn option_box_local_candidates(
        self,
        db: &'db dyn FixupDb,
        item_index: usize,
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn option_box_comparisons(
        self,
        db: &'db dyn FixupDb,
        item_index: usize,
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn proof_buffer_pointer_fields(
        self,
        db: &'db dyn FixupDb,
        item_index: usize,
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn calls_in(
        self,
        db: &'db dyn FixupDb,
        item_index: usize,
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn all_calls(self, db: &'db dyn FixupDb) -> Vec<CallRecord> {
        self.functions(db)
            .iter()
            .flat_map(|input| {
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn all_binding_refs(self, db: &'db dyn FixupDb) -> Vec<BindingRef<'db>> {
        self.functions(db)
            .iter()
            .flat_map(|&input| {
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn reference_domain(
        self,
        db: &dyn FixupDb,
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn proof_anonymous_structs(
        self,
        db: &dyn FixupDb,
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn definition_users(
        self,
        db: &dyn FixupDb,
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn definition_group_users(
        self,
        db: &dyn FixupDb,
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn proof_heap_ownership(
        self,
        db: &'db dyn FixupDb,
        item_index: usize,
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn proof_file_ownership(
        self,
        db: &'db dyn FixupDb,
        item_index: usize,
...
impl<'snapshot> QueryContext<'snapshot> {
    ...
    pub(in crate::backend) fn all_calls(&self) -> impl Iterator<Item = &CallRecord> {
        self.salsa().all_calls().iter()
    }

    pub(in crate::backend) fn symbol_use_count(&self, name: &str) -> usize {
        self.symbol_uses.get(name).map_or(0, Vec::len)
    }

    pub(in crate::backend) fn call_arg_types(&self, call: &CallRecord) -> Vec<Option<Type>> {
        let Some(function) = self.salsa().function_by_item_index(call.site.item_index) else {
    ...
    pub(in crate::backend) fn local_value(
        &self,
    ...
    pub(in crate::backend) fn value_local(&self, site: &ValueSite, name: &str) -> ResolvedValue {
        self.resolved_value_at(site.item_index, &site.path, name)
    }

    pub(in crate::backend) fn binding_at(
        &self,
        item_index: usize,
        definition: &AstPath,
        name: &str,
    ...
    pub(in crate::backend) fn binding_def_use(
        &self,
    ...
    pub(in crate::backend) fn binding_initializer(
        &self,
        binding: &BindingRef<'snapshot>,
    ...
    pub(in crate::backend) fn enclosing_statement(
        &self,
    ...
    pub(in crate::backend) fn enclosing_statements(
        &self,
        statement: &StatementRef,
    ...
    pub(in crate::backend) fn statement_reachable(
        &self,
        statement: &StatementRef,
    ) -> QueryResult<bool> {
        let predicate = Predicate::StatementReachable;
        let site = statement_evidence_site(statement);
        let Some(function) = self.salsa().function_by_item_index(statement.item_index) else {
            return Err(Rejection::new(
                predicate,
                Some(site),
                RejectionReason::MissingEvidence,
    ...
    pub(in crate::backend) fn binding_value(
        &self,
        binding: &BindingRef<'snapshot>,
    ) -> ResolvedValue {
        let usage = self
    ...
    pub(in crate::backend) fn binding_requires_mut(
        &self,
        binding: &BindingRef<'snapshot>,
    ) -> QueryResult<bool> {
        ...
        let required = match self.salsa().function_by_item_index(binding.item_index) {
            ...
            None => self.salsa().binding_requires_mut_by_binding(binding.id),
        };
        Ok(Proof::new(
            required,
            vec![Evidence {
    ...
    pub(in crate::backend) fn borrow_alias_reasons(
        &self,
        binding: &BindingRef<'snapshot>,
        ...
        let reasons = match self.salsa().function_by_item_index(binding.item_index) {
            ...
            None => self.salsa().borrow_alias_reasons_by_binding(binding.id),
        };
        let evidence = vec![Evidence {
            predicate,
            site: expression_site(binding.item_index, &binding.definition.0),
    ...
    pub(in crate::backend) fn binding_type(
        &self,
        binding: &BindingRef<'snapshot>,
    ) -> QueryResult<Type> {
    ...
    pub(in crate::backend) fn binding_usage(
        &self,
        binding: &BindingRef<'snapshot>,
    ) -> QueryResult<Usage> {
    ...
    pub(in crate::backend) fn binding_resolved_value(
        &self,
        binding: &BindingRef<'snapshot>,
    ...
    fn resolved_value_at(
        ...
        let Some(function) = self.salsa().function_by_item_index(item_index) else {
    ...
    pub(in crate::backend) fn extern_fn(&self, matcher: &ExternFn) -> QueryResult<()> {
    ...
    pub(in crate::backend) fn all_exprs(&self, item_index: usize) -> QueryResult<Vec<ExprSite>> {
    ...
    pub(in crate::backend) fn expression_sites(&self) -> Vec<ExprSite> {
        self.expression_sites.clone()
    }

    pub(in crate::backend) fn expression_roles(
        &self,
        expression: &ExpressionRef,
    ...
    pub(in crate::backend) fn expression_kind(
        &self,
        expression: &ExpressionRef,
    ...
    pub(in crate::backend) fn parent_expression_kind(
        &self,
        expression: &ExpressionRef,
    ) -> Option<ExpressionKind> {
    ...
    pub(in crate::backend) fn is_bare_pointer_dereference(
        &self,
        expression: &ExpressionRef,
    ) -> bool {
    ...
    pub(in crate::backend) fn ancestor_expression_kinds(
        &self,
        expression: &ExpressionRef,
    ) -> Vec<ExpressionKind> {
    ...
    pub(in crate::backend) fn expression(&self, site: &ExprSite) -> QueryResult<ExpressionRef> {
    ...
    pub(in crate::backend) fn expression_dependencies(
        &self,
        expression: &ExpressionRef,
    ...
    pub(in crate::backend) fn statement_expression(
        &self,
        statement: &StatementRef,
        index: usize,
    ) -> QueryResult<ExpressionRef> {
    ...
    pub(in crate::backend) fn statement_initializer(
        &self,
        statement: &StatementRef,
    ...
    pub(in crate::backend) fn statement_is_movable_declaration(
        &self,
        statement: &StatementRef,
    ) -> QueryResult<bool> {
    ...
    pub(in crate::backend) fn declaration_uses_in_statement(
        &self,
    ...
    pub(in crate::backend) fn statement_in_container(
        &self,
    ...
    pub(in crate::backend) fn statements_between(
        &self,
        start: &StatementRef,
        end: &StatementRef,
    ...
    pub(in crate::backend) fn following_statements(
        &self,
        statement: &StatementRef,
    ) -> QueryResult<Vec<StatementRef>> {
        let predicate = Predicate::StatementRegion;
    ...
    pub(in crate::backend) fn statement_range(
        &self,
        start: &StatementRef,
        end: &StatementRef,
    ...
    pub(in crate::backend) fn atomic_compare_exchange_shape(
        &self,
    ...
    pub(in crate::backend) fn statement(
        &self,
        statement: &StatementRef,
    ) -> QueryResult<&'snapshot IndentStmt> {
        let site = statement_evidence_site(statement);
    ...
    pub(in crate::backend) fn statement_binding(
        &self,
        statement: &StatementRef,
    ) -> QueryResult<BindingRef<'snapshot>> {
        let proof = self.statement(statement)?;
    ...
    pub(in crate::backend) fn statement_effects(
        &self,
        statement: &StatementRef,
    ...
    pub(in crate::backend) fn observed_statement_effects(
        &self,
        statement: &StatementRef,
    ...
    pub(in crate::backend) fn parent_expression(
        &self,
        expression: &ExpressionRef,
    ) -> QueryResult<ExpressionRef> {
    ...
    pub(in crate::backend) fn argument_position(
        &self,
        expression: &ExpressionRef,
    ...
    pub(in crate::backend) fn ancestor_expressions(
        &self,
        expression: &ExpressionRef,
    ) -> QueryResult<Vec<ExpressionRef>> {
    ...
    pub(in crate::backend) fn expression_call(
        &self,
        expression: &ExpressionRef,
    ...
    pub(in crate::backend) fn expression_values(
        &self,
        expression: &ExpressionRef,
    ...
    pub(in crate::backend) fn expression_effects(
        &self,
        expression: &ExpressionRef,
    ) -> QueryResult<ExpressionEffects> {
        let predicate = Predicate::ExpressionEffects;
    ...
    pub(in crate::backend) fn expression_place(
        &self,
        expression: &ExpressionRef,
    ...
    pub(in crate::backend) fn expression_type(
        &self,
        expression: &ExpressionRef,
    ) -> QueryResult<Type> {
        let predicate = Predicate::ExpressionType;
                ...
                function
                    .and_then(|function| {
                        self.salsa()
                            ...
                            .or_else(|| self.salsa().callsite(function, &expression.site.path))
                    })
    ...
    pub(in crate::backend) fn expression_binding(
        &self,
        expression: &ExpressionRef,
    ) -> QueryResult<BindingRef<'snapshot>> {
        let predicate = Predicate::Binding;
        ...
        candidates.extend(self.salsa().bindings_written_under(
            function,
            name.as_str(),
    ...
    pub(in crate::backend) fn binding_uses(
        &self,
        binding: &BindingRef<'snapshot>,
    ) -> QueryResult<BindingUses<'snapshot>> {
    ...
    pub(in crate::backend) fn binding_uses_in_statement(
        &self,
        binding: &BindingRef<'snapshot>,
        statement: &StatementRef,
    ) -> QueryResult<BindingUses<'snapshot>> {
    ...
    pub(in crate::backend) fn binding_uses_in_expression(
        &self,
        binding: &BindingRef<'snapshot>,
        expression: &ExpressionRef,
    ) -> QueryResult<BindingUses<'snapshot>> {
    ...
    pub(in crate::backend) fn assign_value_sites(&self) -> &BTreeSet<ExprSite> {
    ...
    pub(in crate::backend) fn cast_at(&self, site: &ExprSite) -> QueryResult<CastFact<'snapshot>> {
    ...
    pub(in crate::backend) fn null_check_dominates(
        &self,
        binding: &BindingRef<'snapshot>,
        deref_site: &ExprSite,
    ) -> QueryResult<NullCheckDominance> {
        let predicate = Predicate::NullCheckDominance;
        let Some(function) = self.salsa().function_by_item_index(deref_site.item_index) else {
            return Err(Rejection::new(
                predicate,
    ...
    pub(in crate::backend) fn pointer_option_eligible(
        &self,
        binding: &BindingRef<'snapshot>,
    ) -> QueryResult<()> {
        ...
        let Some(resolved) = self.salsa().binding_by_local_path(
            function,
            binding.name.as_str(),
            &binding.definition,
        ) else {
    ...
    pub(in crate::backend) fn pointer_comparison_kind(
        &self,
        site: &ExprSite,
    ...
    pub(in crate::backend) fn callsite_at(
        &self,
        site: &ExprSite,
    ...
    pub(in crate::backend) fn call_argument_pinning(
        &self,
        site: &ExprSite,
    ...
    pub(in crate::backend) fn printf_call_at(
        &self,
        site: &ExprSite,
    ...
    pub(in crate::backend) fn has_printf_extern(&self) -> bool {
    ...
    pub(in crate::backend) fn setlocale_calls_stay_c(&self) -> bool {
    ...
    pub(in crate::backend) fn c_string_literal(&self, site: &ExprSite) -> QueryResult<Vec<u8>> {
    ...
    pub(in crate::backend) fn child(&self, site: &ExprSite, index: usize) -> ExprSite {
        child_site(site, index)
    }

    pub(in crate::backend) fn string_buffer(
        &self,
        site: &ValueSite,
    ...
    pub(in crate::backend) fn value_uses(
        &self,
        site: &ValueSite,
        name: &str,
        ...
        let Some(binding) = self
            .salsa()
            .binding_by_local_path(function, name, &site.path)
        else {
            return Err(Rejection::new(
                predicate,
                Some(evidence_site),
    ...
    pub(in crate::backend) fn string_pointer_view_sites(
        &self,
        site: &ValueSite,
        name: &str,
    ) -> QueryResult<Vec<ExprSite>> {
    ...
    pub(in crate::backend) fn string_use_allows_lift(
        &self,
        site: &ValueSite,
        name: &str,
        use_site: &ExprSite,
    ...
    pub(in crate::backend) fn string_copy_rewrite_sites(
        &self,
        site: &ValueSite,
        name: &str,
    ...
    pub(in crate::backend) fn string_libc_use(
        &self,
        site: &ExprSite,
    ...
    pub(in crate::backend) fn ascii_numeric_sign(
        &self,
        binding: &BindingRef<'snapshot>,
    ...
    pub(in crate::backend) fn binding_constant_zero(
        &self,
        binding: &BindingRef<'snapshot>,
    ) -> QueryResult<()> {
    ...
    pub(in crate::backend) fn pointer_origin(
        &self,
        site: &ValueSite,
        name: &str,
        ...
        let mut origins = self
            ...
            .filter_map(|fact| {
                Some((
                    self.salsa().binding_name(fact.pointer)?.to_string(),
                    ArrayElementPointerOrigin {
                        pointer_name: self.salsa().binding_name(fact.pointer)?.to_string(),
                        base_name: self.salsa().binding_name(fact.base)?.to_string(),
    ...
    pub(in crate::backend) fn has_anonymous_structs(&self) -> bool {
        !self.anonymous_struct_facts().is_empty()
    }

    pub(in crate::backend) fn has_lazy_singletons(&self) -> bool {
        !self.lazy_init_singleton_facts().is_empty()
    }

    pub(in crate::backend) fn has_ptr_len_slices(&self) -> bool {
        !self.ptr_len_slice_facts().is_empty()
    }

    pub(in crate::backend) fn has_sort_search_calls(&self) -> bool {
    ...
    pub(in crate::backend) fn has_atomic_promotions(&self) -> bool {
    ...
    pub(super) fn snapshot_salsa(&self) -> &'snapshot SalsaFacts {
        self.salsa()
    }

    pub(in crate::backend) fn expr(&self, site: &ExprSite) -> Option<&'snapshot Expr> {
        walk::target_expr_at_path(self.program, site.item_index, &site.path)
    }

    pub(in crate::backend) fn all_definitions(&self) -> impl Iterator<Item = &DefinitionSite> {
        self.definitions.values().flatten()
    }

    pub(in crate::backend) fn all_functions(&self) -> Vec<FunctionRef<'snapshot>> {
        self.salsa()
            .function_facts()
            .iter()
            .filter_map(|fact| {
    ...
    pub(in crate::backend) fn all_bindings(&self) -> &'snapshot [BindingRef<'snapshot>] {
        self.salsa().all_binding_refs()
    }

    pub(in crate::backend) fn function_def(
        &self,
    ...
    pub(in crate::backend) fn parameter_function(
        &self,
    ...
    pub(in crate::backend) fn parameter_uses(
        &self,
        parameter: &ParameterRef<'snapshot>,
    ) -> QueryResult<BindingUses<'snapshot>> {
        if self.parameter_def(parameter).is_none() {
    ...
    pub(in crate::backend) fn direct_calls(
        &self,
        function: &FunctionRef<'snapshot>,
    ) -> QueryResult<Vec<CallRecord>> {
    ...
    pub(in crate::backend) fn function_reachability(
        &self,
        function: &FunctionRef<'snapshot>,
    ...
    pub(in crate::backend) fn function_call_domain(
        &self,
        function: &FunctionRef<'snapshot>,
    ...
    pub(in crate::backend) fn call_argument(
        &self,
        call: &CallRecord,
        index: usize,
    ) -> QueryResult<ExpressionRef> {
    ...
    pub(in crate::backend) fn definition_function(
        &self,
        definition: &DefinitionSite,
    ) -> QueryResult<FunctionRef<'snapshot>> {
        let predicate = Predicate::Function;
    ...
    pub(in crate::backend) fn function_snapshot(
        &self,
        function: &FunctionRef<'snapshot>,
    ...
    pub(in crate::backend) fn dispatch_regions(
        &self,
        function: &FunctionRef<'snapshot>,
    ) -> QueryResult<Vec<DispatchRegion>> {
        let (definition, mut evidence) = self.function_snapshot(function)?.into_parts();
        let regions = crate::backend::facts::goto::recognize_dispatch_loops(&definition.body)
            .into_iter()
    ...
    pub(in crate::backend) fn switch_dispatch_flat(
        &self,
    ...
    pub(in crate::backend) fn va_list_alias(
        &self,
        function: &FunctionRef<'snapshot>,
    ...
    pub(in crate::backend) fn function_bindings(
        &self,
        function: &FunctionRef<'snapshot>,
    ...
    pub(in crate::backend) fn function_expressions(
        &self,
        function: &FunctionRef<'snapshot>,
    ) -> QueryResult<Vec<ExpressionRef>> {
        let mut proof = self.function_snapshot(function)?;
    ...
    pub(in crate::backend) fn statement_tail(
        &self,
        statement: &StatementRef,
    ...
    pub(in crate::backend) fn all_parameters(&self) -> Vec<ParameterRef<'snapshot>> {
        self.all_bindings()
            .iter()
            .filter_map(|binding| {
    ...
    pub(in crate::backend) fn parameter_def(
        &self,
    ...
    pub(in crate::backend) fn statement_container(
        &self,
        container: &StatementContainerRef,
    ) -> Option<&'snapshot [IndentStmt]> {
    ...
    pub(in crate::backend) fn match_arm(&self, arm: &MatchArmRef) -> Option<&'snapshot MatchArm> {
    ...
    pub(in crate::backend) fn enum_variant(
        &self,
        variant: &EnumVariantRef,
    ) -> Option<&'snapshot crate::backend::rust_ast::EnumConst> {
    ...
    pub(in crate::backend) fn type_use(
        &self,
    ...
    pub(in crate::backend) fn definitions_in_group(
        &self,
        group: &DefinitionGroup,
    ) -> Vec<DefinitionSite> {
        self.definitions
...
impl<'snapshot> QueryContext<'snapshot> {
    pub(in crate::backend) fn anonymous_structs(&self) -> QueryResult<AnonymousStructSet> {
    ...
    pub(in crate::backend) fn const_u8(&self, site: &ExprSite) -> QueryResult<u8> {
        self.salsa().const_u8(site)
    }

    pub(in crate::backend) fn const_usize(&self, site: &ExprSite) -> QueryResult<usize> {
    ...
    pub(in crate::backend) fn pure(&self, site: &ExprSite) -> QueryResult<StableExpr> {
    ...
    pub(in crate::backend) fn lazy_singletons(&self) -> QueryResult<LazySingletonSet> {
        self.salsa().proof_lazy_singletons()
    }

    pub(in crate::backend) fn atomic_promotions(&self) -> QueryResult<AtomicPromotionSet> {
        self.salsa().proof_atomic_promotions()
    }

    pub(in crate::backend) fn heap_ownership_facts(
        &self,
        function: &FunctionRef<'snapshot>,
    ...
    pub(in crate::backend) fn file_ownership_facts(
        &self,
        function: &FunctionRef<'snapshot>,
    ...
    pub(in crate::backend) fn ptr_len_slices(&self) -> QueryResult<PtrLenPlanSet> {
    ...
    pub(in crate::backend) fn struct_field_ownership_facts(
        &self,
    ) -> QueryResult<Vec<StructFieldOwnershipFact>> {
    ...
    pub(in crate::backend) fn function_by_name(
        &self,
        name: &str,
    ) -> QueryResult<FunctionRef<'snapshot>> {
    ...
    pub(in crate::backend) fn buffer_pointer_fields(
        &self,
        function: &FunctionRef<'snapshot>,
    ...
    pub(in crate::backend) fn reference_domain(&self) -> QueryResult<ReferenceDomain> {
...
fn qualified_path(path: &crate::backend::rust_ast::Path) -> String {
    path.segments
        .iter()
        .map(crate::backend::rust_ast::Ident::as_str)
        .collect::<Vec<_>>()
        .join("::")
}
...
fn ptr_len_plans_from_facts<'db>(
    ...
    for ((function, ptr_param), calls) in grouped {
        let Some(function_fact) = functions.iter().find(|fact| fact.id == function) else {
            continue;
        };
        let Some(ptr_binding) = bindings.iter().find(|binding| binding.id == ptr_param) else {
            continue;
        };
