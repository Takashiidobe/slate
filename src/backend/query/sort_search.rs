...
pub(super) fn rewrite_program(program: &mut Program) -> Option<usize> {
    ...
    changed.then_some(comparators.len())
}
...
fn prim_layout(p: crate::backend::rust_ast::Prim) -> Option<Layout> {
    let size = match p {
        ...
        crate::backend::rust_ast::Prim::I64
        | crate::backend::rust_ast::Prim::U64
        | crate::backend::rust_ast::Prim::F64 => 8,
        crate::backend::rust_ast::Prim::I128
        | crate::backend::rust_ast::Prim::U128
        | crate::backend::rust_ast::Prim::F128 => 16,
        crate::backend::rust_ast::Prim::Isize | crate::backend::rust_ast::Prim::Usize => {
            return None;
        }
    };
...
fn same_type(a: &Type, b: &Type) -> bool {
    crate::backend::codegen::type_to_string(a) == crate::backend::codegen::type_to_string(b)
}
