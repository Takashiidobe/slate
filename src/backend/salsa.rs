...
use crate::backend::rust_ast::{Expr, FnDef, Item, Program};
use salsa::Setter;
use salsa::plumbing::AsId;
use std::collections::{BTreeMap, BTreeSet};

#[salsa::db]
pub(in crate::backend) trait FixupDb: salsa::Database {}

#[salsa::db]
#[derive(Default)]
pub(in crate::backend) struct Database {
...
pub(in crate::backend) struct ProgramInput {
    #[returns(ref)]
    pub(in crate::backend) program: Program,
    #[returns(ref)]
    pub(in crate::backend) items: Vec<ItemInput>,
}

#[salsa::input]
pub(in crate::backend) struct ItemInput {
    #[returns(ref)]
    pub(in crate::backend) item: Item,
}

#[salsa::interned]
pub(in crate::backend) struct FunctionInput<'db> {
    #[returns(copy)]
    pub(in crate::backend) program: ProgramInput,
    #[returns(copy)]
    pub(in crate::backend) function: FunctionId<'db>,
    #[returns(copy)]
    pub(in crate::backend) item: ItemInput,
    #[returns(copy)]
...
impl<'db> ProgramInput {
    ...
    pub(in crate::backend) fn base_walk(self, db: &dyn FixupDb) -> facts::walk::BaseWalk {
        facts::walk::BaseWalk::new(db, self.program(db))
    }

    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn functions(self, db: &'db dyn FixupDb) -> Vec<FunctionInput<'db>> {
        self.items(db)
            .iter()
            .enumerate()
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn function_facts(self, db: &'db dyn FixupDb) -> Vec<FunctionFact<'db>> {
        self.functions(db)
            .iter()
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn struct_field_ownership(
        self,
        db: &dyn FixupDb,
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn anonymous_structs(
        self,
        db: &dyn FixupDb,
...
impl<'db> FunctionInput<'db> {
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn body(self, db: &dyn FixupDb) -> FnDef {
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn bindings_typed(self, db: &'db dyn FixupDb) -> Vec<BindingFact<'db>> {
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn binding_types_typed(
        self,
        db: &'db dyn FixupDb,
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn effects(self, db: &dyn FixupDb) -> Vec<EffectFact<'db>> {
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn values(self, db: &dyn FixupDb) -> Vec<ValueFact<'db>> {
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn strings(self, db: &dyn FixupDb) -> facts::strings::Collected<'db> {
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn counted_loops(
        self,
        db: &dyn FixupDb,
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn atomic_locals(self, db: &dyn FixupDb) -> Vec<AtomicLocalFact<'db>> {
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn option_box(
        self,
        db: &dyn FixupDb,
    ) -> (
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn heap_ownership(
        self,
        db: &dyn FixupDb,
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn file_ownership(
        self,
        db: &dyn FixupDb,
...
impl<'db> ProgramInput {
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn interprocedural_alloc(
        self,
        db: &dyn FixupDb,
    ) -> (
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn ptr_len_slices(
        self,
        db: &dyn FixupDb,
        definitions: ProgramInput,
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn string_param_lifts(
        self,
        db: &dyn FixupDb,
        definitions: ProgramInput,
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn lazy_init_singletons(
        self,
        db: &dyn FixupDb,
        definitions: ProgramInput,
    ...
    #[salsa::tracked(returns(ref))]
    pub(in crate::backend) fn atomic_globals(
        self,
        db: &dyn FixupDb,
        definitions: ProgramInput,
...
pub(in crate::backend) struct SalsaFacts {
    db: Database,
...
impl SalsaFacts {
    pub(in crate::backend) fn new_empty() -> Self {
    ...
    pub(in crate::backend) fn set_program(&mut self, program: &Program) {
    ...
    pub(in crate::backend) fn byte_source<'db>(
        &'db self,
        site: &ExprSite,
    ...
    pub(in crate::backend) fn full_byte_view<'db>(
        &'db self,
        source: &ByteSource<'_>,
        count: &ExprSite,
    ...
    pub(in crate::backend) fn proof_counted_loop<'db>(
        &'db self,
    ...
    pub(in crate::backend) fn proof_counted_slice_loop<'db>(
        &'db self,
        statement: &StatementRef,
    ...
    pub(in crate::backend) fn proof_lazy_singletons(&self) -> QueryResult<LazySingletonSet> {
        self.program.lazy_singletons(&self.db).clone()
    }

    pub(in crate::backend) fn proof_atomic_promotions(&self) -> QueryResult<AtomicPromotionSet> {
        self.program.atomic_promotions(&self.db).clone()
    }

    pub(in crate::backend) fn proof_callee_alloc_summary<'db>(
        &'db self,
    ...
    pub(in crate::backend) fn proof_interprocedural_alloc_eligibility<'db>(
        &'db self,
        function: &FunctionRef<'_>,
    ...
    pub(in crate::backend) fn proof_interprocedural_alloc_chain<'db>(
        &'db self,
        function: &FunctionRef<'_>,
    ...
    pub(in crate::backend) fn proof_interprocedural_alloc_callers<'db>(
        &'db self,
        function: &FunctionRef<'_>,
    ...
    pub(in crate::backend) fn proof_ptr_len_slices(&self) -> QueryResult<PtrLenPlanSet> {
    ...
    pub(in crate::backend) fn proof_string_param_lift_indices(
        &self,
        function: &FunctionRef<'_>,
    ...
    pub(in crate::backend) fn proof_function_by_name<'db>(
        &'db self,
        name: &str,
    ...
    pub(in crate::backend) fn proof_option_box_local_candidates<'db>(
        &'db self,
        function: &FunctionRef<'_>,
    ...
    pub(in crate::backend) fn proof_option_box_comparisons(
        &self,
        function: &FunctionRef<'_>,
    ...
    pub(in crate::backend) fn proof_buffer_pointer_fields<'db>(
        &'db self,
        function: &FunctionRef<'_>,
    ...
    pub(in crate::backend) fn proof_calls_in(
        &self,
        function: &FunctionRef<'_>,
    ...
    pub(in crate::backend) fn all_calls(&self) -> &[CallRecord] {
        self.program.all_calls(&self.db)
    }

    pub(in crate::backend) fn call_at(&self, site: &ExprSite) -> Option<CallRecord> {
        let proof = self
            .program
    ...
    pub(in crate::backend) fn proof_reference_domain(&self) -> QueryResult<ReferenceDomain> {
        self.program.reference_domain(&self.db).clone()
    }

    pub(in crate::backend) fn proof_anonymous_structs(&self) -> QueryResult<AnonymousStructSet> {
        self.program.proof_anonymous_structs(&self.db).clone()
    }

    pub(in crate::backend) fn proof_definition_users(
        &self,
    ...
    pub(in crate::backend) fn proof_definition_group_users(
        &self,
    ...
    pub(in crate::backend) fn proof_heap_ownership<'db>(
        &'db self,
        function: &FunctionRef<'_>,
    ...
    pub(in crate::backend) fn proof_file_ownership<'db>(
        &'db self,
        function: &FunctionRef<'_>,
    ...
    pub(in crate::backend) fn def_use<'a>(
        &'a self,
    ...
    pub(in crate::backend) fn effect(
        &self,
    ...
    pub(in crate::backend) fn values_for(&self, function: FunctionId<'_>) -> &[ValueFact<'_>] {
    ...
    pub(in crate::backend) fn string_buffer_at(
        &self,
        function: FunctionId<'_>,
        path: &AstPath,
    ...
    pub(in crate::backend) fn string_pointer_views(
        &self,
        function: FunctionId<'_>,
    ...
    pub(in crate::backend) fn liftable_string_bindings(
        &self,
        function: FunctionId<'_>,
    ...
    pub(in crate::backend) fn string_use_allowed(
        &self,
        function: FunctionId<'_>,
        use_path: &AstPath,
        binding: BindingId<'_>,
    ...
    pub(in crate::backend) fn string_copy_rewrites(
        &self,
        function: FunctionId<'_>,
    ...
    pub(in crate::backend) fn cast_at(
        &self,
        function: FunctionId<'_>,
        path: &AstPath,
    ) -> Option<&CastFact<'_>> {
    ...
    pub(in crate::backend) fn control_flow(
        &self,
        function: FunctionId<'_>,
    ...
    pub(in crate::backend) fn borrow_alias_reasons<'a>(
        &'a self,
        function: FunctionId<'a>,
        binding: BindingId<'a>,
    ...
    pub(in crate::backend) fn binding_requires_mut_by_binding(
        &self,
        binding: BindingId<'_>,
    ) -> bool {
    ...
    pub(in crate::backend) fn borrow_alias_reasons_by_binding(
        &self,
        binding: BindingId<'_>,
    ...
    pub(in crate::backend) fn array_element_pointer_origins(
        &self,
        function: FunctionId<'_>,
    ...
    pub(in crate::backend) fn null_check_dominance_at(
        &self,
        function: FunctionId<'_>,
        deref_path: &AstPath,
    ...
    pub(in crate::backend) fn atomic_locals(&self) -> &[AtomicLocalFact<'_>] {
        self.program.atomic_locals(&self.db)
    }

    pub(in crate::backend) fn pointer_option_safety_of<'a>(
        &'a self,
        function: FunctionId<'a>,
        binding: BindingId<'a>,
    ...
    pub(in crate::backend) fn pointer_comparison_at(
        &self,
        function: FunctionId<'_>,
        path: &AstPath,
    ...
    pub(in crate::backend) fn c_string_literal(
        &self,
        function: FunctionId<'_>,
    ...
    pub(in crate::backend) fn printf_calls(
        &self,
        function: FunctionId<'_>,
    ) -> &[PrintfCallFact<'_>] {
        let Some(input) = self.function_input(function) else {
    ...
    pub(in crate::backend) fn callsites(&self) -> &[CallsiteFact<'_>] {
        self.program.callsites(&self.db, self.program)
    }

    pub(in crate::backend) fn callsite(
        &self,
        function: FunctionId<'_>,
        path: &AstPath,
    ...
    pub(in crate::backend) fn call_arg_at(
        &self,
        function: FunctionId<'_>,
        path: &AstPath,
    ...
    pub(in crate::backend) fn ptr_len_slices(&self) -> &[PtrLenSliceFact<'_>] {
        self.program.ptr_len_slices(&self.db, self.program)
    }

    pub(in crate::backend) fn lazy_init_singletons(&self) -> &[LazyInitSingletonFact<'_>] {
    ...
    pub(in crate::backend) fn struct_field_ownership(&self) -> &[StructFieldOwnershipFact] {
        self.program.struct_field_ownership(&self.db)
    }

    pub(in crate::backend) fn anonymous_structs(&self) -> &[AnonymousStructFact] {
        self.program.anonymous_structs(&self.db)
    }

    pub(in crate::backend) fn atomic_globals(&self) -> &[AtomicGlobalFact] {
        self.program.atomic_globals(&self.db, self.program)
    }

    pub(in crate::backend) fn function_by_item_index(
        &self,
        item_index: usize,
    ) -> Option<FunctionId<'_>> {
        self.program
    ...
    pub(in crate::backend) fn function_name(&self, function: FunctionId<'_>) -> Option<&str> {
        self.program
            .function_facts(&self.db)
            .iter()
    ...
    pub(in crate::backend) fn function_by_name(&self, name: &str) -> Option<FunctionId<'_>> {
        self.program
            .function_facts(&self.db)
            .iter()
    ...
    pub(in crate::backend) fn function_facts(&self) -> Vec<FunctionFact<'_>> {
        self.program.function_facts(&self.db).clone()
    }

    pub(in crate::backend) fn all_binding_refs(&self) -> &[BindingRef<'_>] {
        self.program.all_binding_refs(&self.db)
    }

    pub(in crate::backend) fn binding_by_local_path<'db>(
        &'db self,
    ...
    pub(in crate::backend) fn binding_type_ast(
        &self,
        binding: BindingId<'_>,
    ...
    pub(in crate::backend) fn binding_name(&self, binding: BindingId<'_>) -> Option<String> {
        let input = self.function_input(*binding.function(&self.db))?;
        facts::binding_name(input.bindings_typed(&self.db), binding).map(str::to_string)
    }

    pub(in crate::backend) fn bindings_read_under(
        &self,
        function: FunctionId<'_>,
        name: &str,
        path: &AstPath,
    ...
    pub(in crate::backend) fn bindings_written_under(
        &self,
        function: FunctionId<'_>,
        name: &str,
        path: &AstPath,
    ...
    pub(in crate::backend) fn binding_names_and_types(
        &self,
        function: FunctionId<'_>,
    ) -> Vec<(String, String)> {
        let Some(input) = self.function_input(function) else {
    ...
    pub(in crate::backend) fn ascii_numeric_string<'a>(
        &'a self,
        binding: BindingId<'a>,
