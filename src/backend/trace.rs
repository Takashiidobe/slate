use crate::backend::facts::{FunctionId, PathSegment};
use crate::backend::rust_ast::{Block, IndentStmt, Item, Program, Stmt};
...
pub(in crate::backend) fn path_location(path: &[PathSegment]) -> TraceLocation {
    TraceLocation {
...
pub(in crate::backend) fn function_path_location(
    salsa: &SalsaFacts,
    function: FunctionId,
    path: &[PathSegment],
) -> TraceLocation {
...
pub(in crate::backend) fn fact(key: impl Into<String>, value: impl Into<String>) -> TraceFact {
