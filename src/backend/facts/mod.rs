...
pub(in crate::backend) fn def_use_query_path(path: &AstPath) -> AstPath {
    AstPath(
        path.0
            .iter()
...
pub(in crate::backend) fn def_use_query_path_overlaps(
    query_path: &AstPath,
    other: &[PathSegment],
) -> bool {
...
pub(in crate::backend) fn binding_by_param_index<'db>(
...
pub(in crate::backend) fn binding_named<'db>(
    bindings: &[BindingFact<'db>],
    function: FunctionId<'db>,
    name: &str,
) -> Option<BindingId<'db>> {
...
pub(in crate::backend) fn binding_type<'a, 'db>(
...
pub(in crate::backend) fn binding_type_ast<'a, 'db>(
    binding_types: &'a [BindingTypeFact<'db>],
    binding: BindingId<'db>,
) -> Option<&'a Type> {
    binding_types
...
pub(in crate::backend) fn def_use_of<'a, 'db>(
...
pub(in crate::backend) fn string_buffer<'a, 'db>(
...
pub(in crate::backend) fn string_pointer_view<'a, 'db>(
...
pub(in crate::backend) fn binding_read_under<'db>(
...
pub(in crate::backend) fn local_binding_at<'a, 'db>(
...
pub(in crate::backend) fn binding_name<'a, 'db>(
    bindings: &'a [BindingFact<'db>],
    binding: BindingId<'db>,
) -> Option<&'a str> {
    bindings
...
pub(in crate::backend) fn string_buffer_at<'a, 'db>(
    string_buffers: &'a [StringBufferFact<'db>],
    function: FunctionId<'db>,
    path: &AstPath,
) -> Option<&'a StringBufferFact<'db>> {
...
pub(in crate::backend) fn string_libc_use<'a, 'db>(
