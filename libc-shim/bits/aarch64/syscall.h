...
enum {
  ...
  __NR_statmount               = 457,
  __NR_listmount               = 458,
  __NR_lsm_get_self_attr       = 459,
  __NR_lsm_set_self_attr       = 460,
  __NR_lsm_list_modules        = 461,
  __NR_mseal                   = 462,
  __NR_setxattrat              = 463,
  __NR_getxattrat              = 464,
  __NR_listxattrat             = 465,
  __NR_removexattrat           = 466,
  __NR_open_tree_attr          = 467,
  __NR_file_getattr            = 468,
  __NR_file_setattr            = 469,
  __NR_listns                  = 470,
};
