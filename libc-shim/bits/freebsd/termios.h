#ifndef _SLATE_BITS_FREEBSD_TERMIOS_H
#define _SLATE_BITS_FREEBSD_TERMIOS_H

#if !defined(_SLATE_LIBC)
#error "Never include <bits/freebsd/termios.h> directly; include a public header instead."
#endif
