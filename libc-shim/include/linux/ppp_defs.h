#ifndef _SLATE_LINUX_PPP_DEFS_H
#define _SLATE_LINUX_PPP_DEFS_H
...
struct ppp_idle { int32_t xmit_idle; int32_t recv_idle; };
struct ppp_idle32 { __s32 xmit_idle; __s32 recv_idle; };
struct ppp_idle64 { __s64 xmit_idle; __s64 recv_idle; };
