#ifndef _SLATE_SYS_STAT_H
#define _SLATE_SYS_STAT_H
...
struct statx_timestamp {
  int64_t  tv_sec;
  uint32_t tv_nsec;
  int32_t  __slate_statx_timestamp_pad1[1];
};
...
struct statx {
  ...
  uint32_t                __slate_statx_pad2;
  uint64_t                __slate_statx_pad3[8];
};

int statx(int, const char *__restrict, int, unsigned int,
