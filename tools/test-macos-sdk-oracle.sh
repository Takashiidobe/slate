...
grep -q 'slate_macos_pthread_create' "$OUTPUT/symbols.txt"
grep -q 'slate_macos_pthread_timedwait' "$OUTPUT/symbols.txt"
grep -q 'slate_macos_pthread_once' "$OUTPUT/symbols.txt"
grep -q 'slate_macos_semaphore' "$OUTPUT/symbols.txt"
grep -q 'slate_macos_sched_yield' "$OUTPUT/symbols.txt"
