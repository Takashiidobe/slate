...
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = std::ptr::addr_of_mut!(value) == std::ptr::addr_of_mut!(value);
...
// REWRITES-NEXT:     let {{__v[0-9]+}}: bool = std::ptr::addr_of_mut!(value) == std::ptr::addr_of_mut!(value);
// REWRITES-NEXT:     ({{__v[0-9]+}} as i32) + ((value == 37) as i32)
// REWRITES-NEXT: }
