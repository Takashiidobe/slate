...
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: bool = std::ptr::addr_of_mut!(value) == std::ptr::addr_of_mut!(value);
...
// COMMON-REWRITES-NEXT:     value = 37;
// COMMON-REWRITES-NEXT:     let {{__v[0-9]+}}: bool = std::ptr::addr_of_mut!(value) == std::ptr::addr_of_mut!(value);
// COMMON-REWRITES-NEXT:     ({{__v[0-9]+}} as i32) + ((value == 37) as i32)
// COMMON-REWRITES-NEXT: }
