...
// LOWERING-NEXT:             let {{__v[0-9]+}}: *mut i32 = a();
// LOWERING-NEXT:             __retval = {{__v[0-9]+}};
// LOWERING-NEXT:             let {{__v[0-9]+}}: *mut i32 = __retval;
// LOWERING-NEXT:             return {{__v[0-9]+}};
// LOWERING-NEXT:         }
// LOWERING-NEXT:     }
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i32 = alloc();
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i32 = b();
// LOWERING-NEXT:     return {{__v[0-9]+}};
// LOWERING-NEXT: }
// LOWERING-EMPTY:
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i32 = c();
...
// REWRITES-NEXT:     let {{__v[0-9]+}}: *mut i32 = c();
