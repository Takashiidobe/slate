...
// LOWERING-DAG: let {{__v[0-9]+}}: *mut i8 = b"translation\0".as_ptr() as *mut i8;
...
// LOWERING-DAG: let {{__v[0-9]+}}: *mut i8 = b"%c %lu %c %lu\n\0".as_ptr() as *mut i8;
// LOWERING-DAG: let {{__v[0-9]+}}: i64 = 0;
// LOWERING-DAG: let {{__v[0-9]+}}: *mut i8 = first.data;
...
// LOWERING-DAG: let {{__v[0-9]+}}: i64 = 0;
// LOWERING-DAG: let {{__v[0-9]+}}: *mut i8 = second.data;
// LOWERING-DAG: let {{__v[0-9]+}}: *mut i8 = unsafe { {{__v[0-9]+}}.add(0) };
// LOWERING-DAG: let {{__v[0-9]+}}: i8 = unsafe { *{{__v[0-9]+}} };
// LOWERING-DAG: let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} as i32;
...
// REWRITES-DAG: let {{__v[0-9]+}}: *mut i8 = std::ptr::null_mut();
// REWRITES-DAG: _compoundliteral.data = {{__v[0-9]+}};
// REWRITES-DAG: let {{__v[0-9]+}}: u64 = 0;
// REWRITES-DAG: _compoundliteral.length = {{__v[0-9]+}};
// REWRITES-DAG: let {{__v[0-9]+}}: *mut i8 = c"slate".as_ptr() as *mut i8;
...
// REWRITES-DAG: let {{__v[0-9]+}}: *mut i8 = std::ptr::null_mut();
// REWRITES-DAG: _compoundliteral2.data = {{__v[0-9]+}};
// REWRITES-DAG: let {{__v[0-9]+}}: u64 = 0;
// REWRITES-DAG: _compoundliteral2.length = {{__v[0-9]+}};
// REWRITES-DAG: let {{__v[0-9]+}}: *mut i8 = c"translation".as_ptr() as *mut i8;
...
// REWRITES-DAG: let {{__v[0-9]+}}: *mut i8 = c"%c %lu %c %lu\n".as_ptr() as *mut i8;
// REWRITES-DAG: let {{__v[0-9]+}}: *mut i8 = first.data;
...
// REWRITES-DAG: let {{__v[0-9]+}}: *mut i8 = second.data;
// REWRITES-DAG: let {{__v[0-9]+}}: *mut i8 = unsafe { {{__v[0-9]+}}.add(0) };
// REWRITES-DAG: let {{__v[0-9]+}}: i8 = unsafe { *{{__v[0-9]+}} };
// REWRITES-DAG: let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} as i32;
