...
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}}.wrapping_abs();
...
// COMMON-REWRITES-NEXT:             c"%c%c %d\n".as_ptr(),
// COMMON-REWRITES-NEXT:             unsafe { toupper(97 as i32) },
// COMMON-REWRITES-NEXT:             unsafe { tolower(90 as i32) },
// COMMON-REWRITES-NEXT:             (-42 as i32).wrapping_abs(),
// COMMON-REWRITES-NEXT:         )
// COMMON-REWRITES-NEXT:     };
