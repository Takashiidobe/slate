...
// COMMON-LOWERING-NEXT:     let mut a: u8 = 0;
// COMMON-LOWERING-NEXT:     let mut b: u8 = 0;
// COMMON-LOWERING-NEXT:     let mut c: u8 = 0;
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: u8 = 200;
// COMMON-LOWERING-NEXT:     a = {{__v[0-9]+}};
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: u8 = 100;
...
// COMMON-LOWERING-NEXT:             }
// COMMON-LOWERING-NEXT:             {
// COMMON-LOWERING-NEXT:                 let {{__v[0-9]+}}: u8 = a;
// COMMON-LOWERING-NEXT:                 let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} as i32;
// COMMON-LOWERING-NEXT:                 let {{__v[0-9]+}}: u8 = b;
// COMMON-LOWERING-NEXT:                 let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} as i32;
...
// COMMON-LOWERING-NEXT:         }
// COMMON-LOWERING-NEXT:     }
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: u8 = c;
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} as i32;
...
// COMMON-REWRITES-NEXT:     let mut a: u8 = 200;
// COMMON-REWRITES-NEXT:     let mut b: u8 = 100;
// COMMON-REWRITES-NEXT:     let mut c: u8 = 0;
// COMMON-REWRITES-NEXT:     for i in 0..1 {
// COMMON-REWRITES-NEXT:         c = ((a as i32) + (b as i32)) as u8;
// COMMON-REWRITES-NEXT:     }
