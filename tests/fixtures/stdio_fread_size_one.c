...
// LOWERING-NEXT:     let {{_v[0-9]+}}: *mut i8 = b"slate_stdio_fread_size_one.tmp\0".as_ptr() as *mut i8;
...
// REWRITES-NEXT: let {{_v[0-9]+}}: *mut i8 = b"slate_stdio_fread_size_one.tmp\0".as_ptr() as *mut i8;
