...
// LOWERING-NEXT:     let _v1: *mut i8 = b"%d %d %d %d %d %d %d\n\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let _v2: i32 = std::mem::size_of::<IgnoredBadAlign>() as i32;
// LOWERING-NEXT:     let _v3: i32 = std::mem::size_of::<NamedPushed>() as i32;
// LOWERING-NEXT:     let _v4: i32 = std::mem::size_of::<AfterNamedPop>() as i32;
// LOWERING-NEXT:     let _v5: i32 = std::mem::size_of::<AfterExtraPop>() as i32;
// LOWERING-NEXT:     let _v6: i32 = std::mem::size_of::<PackedButAligned>() as i32;
// LOWERING-NEXT:     let _v7: i32 = std::mem::align_of::<PackedButAligned>() as i32;
// LOWERING-NEXT:     let _v8: i32 = 1;
// LOWERING-NEXT:     let _v9: i32 = unsafe { printf(_v1 as *const i8, _v2, _v3, _v4, _v5, _v6, _v7, _v8) };
...
// REWRITES-NEXT: let _v1: *mut i8 = b"%d %d %d %d %d %d %d\n\0".as_ptr() as *mut i8;
// REWRITES-NEXT: let _v2: i32 = std::mem::size_of::<IgnoredBadAlign>() as i32;
// REWRITES-NEXT: let _v3: i32 = std::mem::size_of::<NamedPushed>() as i32;
// REWRITES-NEXT: let _v4: i32 = std::mem::size_of::<AfterNamedPop>() as i32;
// REWRITES-NEXT: let _v5: i32 = std::mem::size_of::<AfterExtraPop>() as i32;
// REWRITES-NEXT: let _v6: i32 = std::mem::size_of::<PackedButAligned>() as i32;
// REWRITES-NEXT: let _v7: i32 = std::mem::align_of::<PackedButAligned>() as i32;
// REWRITES-NEXT: let _v8: i32 = 1;
// REWRITES-NEXT: let _v9: i32 = unsafe { printf(_v1 as *const i8, _v2, _v3, _v4, _v5, _v6, _v7, _v8) };
// REWRITES-NEXT: __retval = 0;
