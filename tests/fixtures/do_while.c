...
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: fn sum_do_while(mut n: i32) -> i32 {
// REWRITES-NEXT:     let mut total: i32 = 0;
// REWRITES-NEXT:     let mut i: i32 = 1;
// REWRITES-NEXT:     loop {
...
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: fn runs_once_when_false() -> i32 {
// REWRITES-NEXT:     let mut total: i32 = 0;
// REWRITES-NEXT:     loop {
// REWRITES-NEXT:         total += 7;
...
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: fn continue_checks_condition(mut n: i32) -> i32 {
// REWRITES-NEXT:     let mut total: i32 = 0;
