...
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"slate_stdio_fread_multi_byte.tmp\0".as_ptr() as *mut i8;
...
// LOWERING-NEXT:         }
// LOWERING-NEXT:     }
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"abcdefghijkl\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut libc::FILE = f;
