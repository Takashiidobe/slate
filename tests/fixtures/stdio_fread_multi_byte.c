...
// LOWERING-NEXT:     let _v1: *mut i8 = b"slate_stdio_fread_multi_byte.tmp\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let _v2: i32 = unsafe { remove(_v1 as *const i8) };
// LOWERING-NEXT:     let _v3: *mut i8 = b"slate_stdio_fread_multi_byte.tmp\0".as_ptr() as *mut i8;
...
// LOWERING-NEXT:         }
// LOWERING-NEXT:     }
// LOWERING-NEXT:     let _v13: *mut i8 = b"abcdefghijkl\0".as_ptr() as *mut i8;
...
// LOWERING-NEXT:     let _v18: *mut i8 = b"slate_stdio_fread_multi_byte.tmp\0".as_ptr() as *mut i8;
...
// LOWERING-NEXT:     let _v40: *mut i8 = b"slate_stdio_fread_multi_byte.tmp\0".as_ptr() as *mut i8;
...
// REWRITES-NEXT: let _v1: *mut i8 = b"slate_stdio_fread_multi_byte.tmp\0".as_ptr() as *mut i8;
// REWRITES-NEXT: let _v2: i32 = unsafe { remove(_v1 as *const i8) };
// REWRITES-NEXT: let _v3: *mut i8 = b"slate_stdio_fread_multi_byte.tmp\0".as_ptr() as *mut i8;
...
// REWRITES-NEXT:         }
// REWRITES-NEXT: }
// REWRITES-NEXT: let _v13: *mut i8 = b"abcdefghijkl\0".as_ptr() as *mut i8;
...
// REWRITES-NEXT: let _v18: *mut i8 = b"slate_stdio_fread_multi_byte.tmp\0".as_ptr() as *mut i8;
...
// REWRITES-NEXT: let _v40: *mut i8 = b"slate_stdio_fread_multi_byte.tmp\0".as_ptr() as *mut i8;
