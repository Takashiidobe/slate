...
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = address_probe();
...
// REWRITES-NEXT:     println!("{}", address_probe());
// REWRITES-NEXT:     let _ = std::io::Write::flush(&mut std::io::stdout());
// REWRITES-NEXT:     return std::process::ExitCode::SUCCESS;
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: fn address_probe() -> i32 {
// REWRITES-NEXT:     let {{__v[0-9]+}}: *mut core::ffi::c_void = 1usize as *mut core::ffi::c_void;
