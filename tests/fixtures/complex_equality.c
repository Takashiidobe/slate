...
// LOWERING-NEXT:     let _v1: num_complex::Complex<f32> = num_complex::Complex { re: 1.0, im: 2.0 };
// LOWERING-NEXT:     f = _v1;
// LOWERING-NEXT:     let _v2: num_complex::Complex<f64> = num_complex::Complex { re: 3.0, im: 4.0 };
// LOWERING-NEXT:     d = _v2;
// LOWERING-NEXT:     let _v3: num_complex::Complex<LongDouble> = num_complex::Complex { re: LongDouble([0, 0, 0, 0, 0, 0, 0, 160, 1, 64]), im: LongDouble([0, 0, 0, 0, 0, 0, 0, 192, 1, 64]) };
// LOWERING-NEXT:     l = _v3;
// LOWERING-NEXT:     let _v4: *mut i8 = b"%d %d\n\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let _v5: num_complex::Complex<f32> = f;
// LOWERING-NEXT:     let _v6: num_complex::Complex<f32> = num_complex::Complex { re: 1.0, im: 2.0 };
// LOWERING-NEXT:     let _v7: bool = _v5 == _v6;
// LOWERING-NEXT:     let _v8: i32 = _v7 as i32;
// LOWERING-NEXT:     let _v9: num_complex::Complex<f32> = f;
// LOWERING-NEXT:     let _v10: num_complex::Complex<f32> = num_complex::Complex { re: 1.0, im: 3.0 };
// LOWERING-NEXT:     let _v11: bool = _v9 != _v10;
// LOWERING-NEXT:     let _v12: i32 = _v11 as i32;
// LOWERING-NEXT:     let _v13: i32 = unsafe { printf(_v4 as *const i8, _v8, _v12) };
// LOWERING-NEXT:     let _v14: *mut i8 = b"%d %d\n\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let _v15: num_complex::Complex<f64> = d;
// LOWERING-NEXT:     let _v16: num_complex::Complex<f64> = num_complex::Complex { re: 3.0, im: 4.0 };
// LOWERING-NEXT:     let _v17: bool = _v15 == _v16;
// LOWERING-NEXT:     let _v18: i32 = _v17 as i32;
// LOWERING-NEXT:     let _v19: num_complex::Complex<f64> = d;
// LOWERING-NEXT:     let _v20: num_complex::Complex<f64> = num_complex::Complex { re: 3.0, im: 5.0 };
// LOWERING-NEXT:     let _v21: bool = _v19 != _v20;
// LOWERING-NEXT:     let _v22: i32 = _v21 as i32;
// LOWERING-NEXT:     let _v23: i32 = unsafe { printf(_v14 as *const i8, _v18, _v22) };
// LOWERING-NEXT:     let _v24: *mut i8 = b"%d %d\n\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let _v25: num_complex::Complex<LongDouble> = l;
// LOWERING-NEXT:     let _v26: num_complex::Complex<LongDouble> = num_complex::Complex { re: LongDouble([0, 0, 0, 0, 0, 0, 0, 160, 1, 64]), im: LongDouble([0, 0, 0, 0, 0, 0, 0, 192, 1, 64]) };
// LOWERING-NEXT:     let _v27: bool = _v25 == _v26;
// LOWERING-NEXT:     let _v28: i32 = _v27 as i32;
// LOWERING-NEXT:     let _v29: num_complex::Complex<LongDouble> = l;
// LOWERING-NEXT:     let _v30: num_complex::Complex<LongDouble> = num_complex::Complex { re: LongDouble([0, 0, 0, 0, 0, 0, 0, 160, 1, 64]), im: LongDouble([0, 0, 0, 0, 0, 0, 0, 224, 1, 64]) };
// LOWERING-NEXT:     let _v31: bool = _v29 != _v30;
// LOWERING-NEXT:     let _v32: i32 = _v31 as i32;
// LOWERING-NEXT:     let _v33: i32 = unsafe { printf(_v24 as *const i8, _v28, _v32) };
...
// REWRITES-NEXT: let _v4: *mut i8 = b"%d %d\n\0".as_ptr() as *mut i8;
// REWRITES-NEXT: let _v13: i32 = unsafe { printf(_v4 as *const i8, (f == num_complex::Complex { re: 1.0, im: 2.0 }) as i32, (f != num_complex::Complex { re: 1.0, im: 3.0 }) as i32) };
// REWRITES-NEXT: let _v14: *mut i8 = b"%d %d\n\0".as_ptr() as *mut i8;
// REWRITES-NEXT: let _v23: i32 = unsafe { printf(_v14 as *const i8, (d == num_complex::Complex { re: 3.0, im: 4.0 }) as i32, (d != num_complex::Complex { re: 3.0, im: 5.0 }) as i32) };
// REWRITES-NEXT: let _v24: *mut i8 = b"%d %d\n\0".as_ptr() as *mut i8;
// REWRITES-NEXT: let _v33: i32 = unsafe { printf(_v24 as *const i8, (l == num_complex::Complex { re: LongDouble([0, 0, 0, 0, 0, 0, 0, 160, 1, 64]), im: LongDouble([0, 0, 0, 0, 0, 0, 0, 192, 1, 64]) }) as i32, (l != num_complex::Complex { re: LongDouble([0, 0, 0, 0, 0, 0, 0, 160, 1, 64]), im: LongDouble([0, 0, 0, 0, 0, 0, 0, 224, 1, 64]) }) as i32) };
// REWRITES-NEXT: __retval = 0;
