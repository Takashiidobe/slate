...
// LOWERING-X86_64-GNU-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"slate_stdio_fread_unsupported_buffer.tmp\0".as_ptr() as *mut i8;
// LOWERING-X86_64-GNU-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"slate_stdio_fread_unsupported_buffer.tmp\0".as_ptr() as *mut i8;
...
// LOWERING-X86_64-GNU-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"heap-owned\0".as_ptr() as *mut i8;
// LOWERING-X86_64-GNU-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"slate_stdio_fread_unsupported_buffer.tmp\0".as_ptr() as *mut i8;
...
// LOWERING-AARCH64-GNU-NEXT:     let {{__v[0-9]+}}: *mut u8 = b"slate_stdio_fread_unsupported_buffer.tmp\0".as_ptr() as *mut u8;
// LOWERING-AARCH64-GNU-NEXT:     let {{__v[0-9]+}}: *mut u8 = b"slate_stdio_fread_unsupported_buffer.tmp\0".as_ptr() as *mut u8;
...
// LOWERING-AARCH64-GNU-NEXT:     let {{__v[0-9]+}}: *mut u8 = b"heap-owned\0".as_ptr() as *mut u8;
// LOWERING-AARCH64-GNU-NEXT:     let {{__v[0-9]+}}: *mut u8 = b"slate_stdio_fread_unsupported_buffer.tmp\0".as_ptr() as *mut u8;
...
// COMMON-REWRITES-NEXT:     unsafe { remove(c"slate_stdio_fread_unsupported_buffer.tmp".as_ptr()) };
// COMMON-REWRITES-NEXT:     f = unsafe {
// COMMON-REWRITES-NEXT:         fopen(
// COMMON-REWRITES-NEXT:             c"slate_stdio_fread_unsupported_buffer.tmp".as_ptr(),
...
// COMMON-REWRITES-NEXT:     }
// COMMON-REWRITES-NEXT:     unsafe { fputs(c"heap-owned".as_ptr(), f as *mut libc::FILE) };
...
// COMMON-REWRITES-NEXT:             (10 as u64) as usize,
...
// COMMON-REWRITES-NEXT:         *{{__v[0-9]+}} = {{__v[0-9]+}};
// COMMON-REWRITES-NEXT:     }
// COMMON-REWRITES-NEXT:     unsafe { printf(c"%zu %s\n".as_ptr(), {{__v[0-9]+}}, {{__v[0-9]+}}) };
