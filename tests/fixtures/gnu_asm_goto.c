...
// LOWERING-NEXT: }
// LOWERING-EMPTY:
// LOWERING-NEXT: fn gnu_asm_goto({{arg[0-9]+}}: i32) -> i32 {
...
// LOWERING-NEXT: }
// LOWERING-EMPTY:
// LOWERING-NEXT: fn gnu_asm_goto_output({{arg[0-9]+}}: i32) -> i32 {
// LOWERING-NEXT:     let mut value: i32 = 0;
// LOWERING-NEXT:     let mut __retval: i32 = 0;
...
// LOWERING-NEXT:                 unsafe {
// LOWERING-NEXT:                     core::arch::asm!("testl {0:e}, {0:e}\n\tjz {1}", inlateout(reg) {{_v[0-9]+}} => output, label {
// LOWERING-NEXT:                         {{__state[0-9]+}} = 1;
// LOWERING-NEXT:                         continue '{{__dispatch[0-9]+}};
// LOWERING-NEXT:                     }, options(att_syntax));
// LOWERING-NEXT:                 }
...
// LOWERING-NEXT:     let {{_v[0-9]+}}: i32 = 0;
// LOWERING-NEXT:     let {{_v[0-9]+}}: i32 = gnu_asm_goto({{_v[0-9]+}});
// LOWERING-NEXT:     let {{_v[0-9]+}}: i32 = 5;
// LOWERING-NEXT:     let {{_v[0-9]+}}: i32 = gnu_asm_goto_output({{_v[0-9]+}});
// LOWERING-NEXT:     let {{_v[0-9]+}}: i32 = 0;
// LOWERING-NEXT:     let {{_v[0-9]+}}: i32 = gnu_asm_goto_output({{_v[0-9]+}});
...
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: fn gnu_asm_goto({{arg[0-9]+}}: i32) -> i32 {
...
// REWRITES-NEXT:                         let {{_v[0-9]+}}: i32 = value;
...
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: fn gnu_asm_goto_output({{arg[0-9]+}}: i32) -> i32 {
// REWRITES-NEXT: let mut value: i32 = 0;
// REWRITES-NEXT: let mut __retval: i32 = 0;
...
// REWRITES-NEXT:                         __retval = output + {{_v[0-9]+}};
// REWRITES-NEXT:                         return __retval;
// REWRITES-NEXT:             }
// REWRITES-NEXT:             1 => {
...
// REWRITES-NEXT: let {{_v[0-9]+}}: i32 = gnu_asm_goto({{_v[0-9]+}});
// REWRITES-NEXT: let {{_v[0-9]+}}: i32 = 5;
// REWRITES-NEXT: let {{_v[0-9]+}}: i32 = gnu_asm_goto_output({{_v[0-9]+}});
// REWRITES-NEXT: let {{_v[0-9]+}}: i32 = 0;
// REWRITES-NEXT: let {{_v[0-9]+}}: i32 = gnu_asm_goto_output({{_v[0-9]+}});
