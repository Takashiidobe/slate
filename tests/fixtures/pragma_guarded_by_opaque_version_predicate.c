...
// LOWERING-NEXT: }
// LOWERING-EMPTY:
// LOWERING-NEXT: fn msvc_arm_guarded_pragma(arg0: i32) -> i32 {
...
// LOWERING-NEXT:     let _v3: i32 = msvc_arm_guarded_pragma(_v2);
...
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: fn msvc_arm_guarded_pragma(arg0: i32) -> i32 {
// REWRITES-NEXT: let mut x: i32 = arg0;
// REWRITES-NEXT: let mut __retval: i32 = 0;
// REWRITES-NEXT: let _v1: i32 = 41;
...
// REWRITES-NEXT: let _v3: i32 = msvc_arm_guarded_pragma(_v2);
