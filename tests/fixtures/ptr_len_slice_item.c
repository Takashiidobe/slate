...
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = sum_items({{__v[0-9]+}}, {{__v[0-9]+}});
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { printf({{__v[0-9]+}} as *const core::ffi::c_char, {{__v[0-9]+}}) };
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// COMMON-LOWERING-NEXT:     std::process::exit({{__v[0-9]+}} as i32);
// COMMON-LOWERING-NEXT: }
// COMMON-LOWERING-EMPTY:
// COMMON-LOWERING-NEXT: fn sum_items({{arg[0-9]+}}: *mut i32, {{arg[0-9]+}}: i32) -> i32 {
...
// COMMON-REWRITES-NEXT:             sum_items(unsafe {
// COMMON-REWRITES-NEXT:                 std::slice::from_raw_parts({{__v[0-9]+}} as *const i32, (4 as i32) as usize)
// COMMON-REWRITES-NEXT:             }),
// COMMON-REWRITES-NEXT:         )
// COMMON-REWRITES-NEXT:     };
...
// COMMON-REWRITES-NEXT: }
// COMMON-REWRITES-EMPTY:
// COMMON-REWRITES-NEXT: fn sum_items({{arg[0-9]+}}: &[i32]) -> i32 {
