...
// COMMON-LOWERING-NEXT: }
// COMMON-LOWERING-EMPTY:
// COMMON-LOWERING-NEXT: fn classify({{arg[0-9]+}}: i32, {{arg[0-9]+}}: i32) -> i32 {
...
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 1;
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = classify({{__v[0-9]+}}, {{__v[0-9]+}});
...
// COMMON-REWRITES-NEXT: }
// COMMON-REWRITES-EMPTY:
// COMMON-REWRITES-NEXT: fn classify(mut {{__v[0-9]+}}: i32, mut extra: i32) -> i32 {
// COMMON-REWRITES-NEXT:     let mut result: i32 = -1;
// COMMON-REWRITES-NEXT:     match {{__v[0-9]+}} {
// COMMON-REWRITES-NEXT:         0 => {
// COMMON-REWRITES-NEXT:             if extra != 0 {
// COMMON-REWRITES-NEXT:                 result = 10;
// COMMON-REWRITES-NEXT:             } else {
// COMMON-REWRITES-NEXT:                 result = 11;
// COMMON-REWRITES-NEXT:             }
// COMMON-REWRITES-NEXT:         }
