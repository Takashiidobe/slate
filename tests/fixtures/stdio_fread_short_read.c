...
// LOWERING-NEXT:     let {{_v[0-9]+}}: *mut i8 = b"slate_stdio_fread_short_read.tmp\0".as_ptr() as *mut i8;
...
// LOWERING-NEXT:         }
// LOWERING-NEXT:     }
// LOWERING-NEXT:     let {{_v[0-9]+}}: *mut i8 = b"abcdefghi\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let {{_v[0-9]+}}: *mut libc::FILE = f;
...
// REWRITES-NEXT: let {{_v[0-9]+}}: *mut i8 = b"slate_stdio_fread_short_read.tmp\0".as_ptr() as *mut i8;
...
// REWRITES-NEXT:         }
// REWRITES-NEXT: }
// REWRITES-NEXT: let {{_v[0-9]+}}: *mut i8 = b"abcdefghi\0".as_ptr() as *mut i8;
...
// REWRITES-NEXT: let {{_v[0-9]+}}: u64 = 4;
// REWRITES-NEXT: n = (unsafe { fread(({{_v[0-9]+}} as *mut core::ffi::c_void) as *mut core::ffi::c_void, {{_v[0-9]+}} as usize, {{_v[0-9]+}} as usize, g as *mut libc::FILE) }) as u64;
// REWRITES-NEXT: let {{_v[0-9]+}}: *mut i8 = b"%zu %s\n\0".as_ptr() as *mut i8;
// REWRITES-NEXT: let {{_v[0-9]+}}: u64 = n;
// REWRITES-NEXT: let {{_v[0-9]+}}: *mut i8 = buf.as_mut_ptr() as *mut i8;
