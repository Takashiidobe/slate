...
// COMMON-LOWERING-NEXT: struct GNUEmpty {
...
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: GNUEmpty = GNUEmpty { __slate_empty: [] };
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = std::mem::size_of::<GNUEmpty>() as i32;
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: u64 = 0;
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: u64 = empty_size({{__v[0-9]+}});
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { printf({{__v[0-9]+}} as *const core::ffi::c_char, {{__v[0-9]+}}, {{__v[0-9]+}}) };
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// COMMON-LOWERING-NEXT:     std::process::exit({{__v[0-9]+}} as i32);
// COMMON-LOWERING-NEXT: }
// COMMON-LOWERING-EMPTY:
// COMMON-LOWERING-NEXT: fn empty_size({{arg[0-9]+}}: GNUEmpty) -> u64 {
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: u64 = 0;
...
// COMMON-REWRITES-NEXT: struct GNUEmpty {
...
// COMMON-REWRITES-NEXT:     let {{__v[0-9]+}}: GNUEmpty = GNUEmpty { __slate_empty: [] };
// COMMON-REWRITES-NEXT:     std::mem::size_of::<GNUEmpty>() as i32;
// COMMON-REWRITES-NEXT:     unsafe { printf(c"%zu %zu\n".as_ptr(), 0 as u64, empty_size({{__v[0-9]+}})) };
// COMMON-REWRITES-NEXT:     std::process::exit(0 as i32);
// COMMON-REWRITES-NEXT: }
// COMMON-REWRITES-EMPTY:
// COMMON-REWRITES-NEXT: fn empty_size({{arg[0-9]+}}: GNUEmpty) -> u64 {
