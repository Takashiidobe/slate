...
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"%s|%s|%d|%d\n\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"source_probe\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 =
// LOWERING-NEXT:         b"{{.*}}tests/fixtures/gnu_builtin_source.c\0".as_ptr() as *mut i8;
