...
// COMMON-LOWERING-NEXT:     source_probe();
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// COMMON-LOWERING-NEXT:     std::process::exit({{__v[0-9]+}} as i32);
// COMMON-LOWERING-NEXT: }
// COMMON-LOWERING-EMPTY:
// COMMON-LOWERING-NEXT: fn source_probe() {
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: u32 = 5;
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: u32 = 28;
...
// COMMON-REWRITES-NEXT:     source_probe();
// COMMON-REWRITES-NEXT:     std::process::exit(0 as i32);
// COMMON-REWRITES-NEXT: }
// COMMON-REWRITES-EMPTY:
// COMMON-REWRITES-NEXT: fn source_probe() {
// COMMON-REWRITES-NEXT:     unsafe {
// COMMON-REWRITES-NEXT:         printf(
// COMMON-REWRITES-NEXT:             c"%s|%s|%d|%d\n".as_ptr(),
// COMMON-REWRITES-NEXT:             5 as u32,
// COMMON-REWRITES-NEXT:             28 as u32,
// COMMON-REWRITES-NEXT:         )
// COMMON-REWRITES-NEXT:     };
