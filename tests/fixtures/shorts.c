...
// LOWERING-NEXT:     let {{__v[0-9]+}}: i16 = 30000;
// LOWERING-NEXT:     let {{__v[0-9]+}}: u16 = 60000;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i16 = -12345;
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"%d\n\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i16 = -30000;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i16 = sadd({{__v[0-9]+}}, {{__v[0-9]+}});
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: i16 = {{__v[0-9]+}} as i16;
