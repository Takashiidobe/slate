...
// LOWERING-NEXT: }
// LOWERING-EMPTY:
// LOWERING-NEXT: fn ishr({{arg[0-9]+}}: i32, {{arg[0-9]+}}: i32) -> i32 {
...
// LOWERING-NEXT:     let {{_v[0-9]+}}: i32 = 256;
// LOWERING-NEXT:     let {{_v[0-9]+}}: i32 = 3;
// LOWERING-NEXT:     let {{_v[0-9]+}}: i32 = ishr({{_v[0-9]+}}, {{_v[0-9]+}});
...
// LOWERING-NEXT:     let {{_v[0-9]+}}: i32 = ishr({{_v[0-9]+}}, {{_v[0-9]+}});
// LOWERING-NEXT:     let {{_v[0-9]+}}: i32 = unsafe { printf({{_v[0-9]+}} as *const i8, {{_v[0-9]+}}) };
// LOWERING-NEXT:     let {{_v[0-9]+}}: u32 = 2147483648u32;
...
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: fn ishr({{arg[0-9]+}}: i32, {{arg[0-9]+}}: i32) -> i32 {
...
// REWRITES-NEXT: let {{_v[0-9]+}}: i32 = 256;
// REWRITES-NEXT: let {{_v[0-9]+}}: i32 = 3;
// REWRITES-NEXT: let {{_v[0-9]+}}: i32 = ishr({{_v[0-9]+}}, {{_v[0-9]+}});
...
// REWRITES-NEXT: let {{_v[0-9]+}}: i32 = unsafe { printf({{_v[0-9]+}} as *const i8, u >> {{_v[0-9]+}}) };
// REWRITES-NEXT: __retval = 0;
