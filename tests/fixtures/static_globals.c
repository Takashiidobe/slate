...
// LOWERING-NEXT: )]
// LOWERING-EMPTY:
// LOWERING-NEXT: static mut counter: i32 = 2;
// LOWERING-EMPTY:
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = bump_counter();
...
// LOWERING-NEXT: }
// LOWERING-EMPTY:
// LOWERING-NEXT: fn bump_counter() -> i32 {
...
// REWRITES-NEXT: )]
// REWRITES-EMPTY:
// REWRITES-NEXT: static mut counter: i32 = 2;
// REWRITES-EMPTY:
...
// REWRITES-NEXT:     println!("{}", bump_counter());
...
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: fn bump_counter() -> i32 {
