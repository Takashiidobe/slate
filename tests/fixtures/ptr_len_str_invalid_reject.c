...
// REWRITES-NEXT:     let __arg0_view = unsafe { std::slice::from_raw_parts({{arg[0-9]+}} as *const u8, {{arg[0-9]+}} as usize) };
// REWRITES-NEXT:     let mut bytes: *mut u8 = {{arg[0-9]+}};
// REWRITES-NEXT:     let mut len: i32 = {{arg[0-9]+}};
// REWRITES-NEXT:     let mut value: i32 = 0;
// REWRITES-NEXT:     (unsafe { strlen(bytes as *const core::ffi::c_char) }) as u64;
...
// REWRITES-NEXT:         value += (unsafe { __arg0_view[(i as usize)] }) as i32;
// REWRITES-NEXT:         i += 1;
// REWRITES-NEXT:     }
// REWRITES-NEXT:     value
// REWRITES-NEXT: }
