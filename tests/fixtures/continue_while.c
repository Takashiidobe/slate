...
// LOWERING-NEXT: }
// LOWERING-EMPTY:
// LOWERING-NEXT: fn sum_skipping_threes(arg0: i32) -> i32 {
...
// LOWERING-NEXT:                     let _v6: i32 = _v5 + 1;
// LOWERING-NEXT:                     i = _v6;
// LOWERING-NEXT:                     {
...
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: fn sum_skipping_threes(arg0: i32) -> i32 {
