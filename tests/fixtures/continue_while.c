...
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = sum_skipping_threes({{__v[0-9]+}});
...
// COMMON-LOWERING-NEXT: }
// COMMON-LOWERING-EMPTY:
// COMMON-LOWERING-NEXT: fn sum_skipping_threes({{arg[0-9]+}}: i32) -> i32 {
...
// COMMON-REWRITES-NEXT: }
// COMMON-REWRITES-EMPTY:
// COMMON-REWRITES-NEXT: fn sum_skipping_threes(mut n: i32) -> i32 {
