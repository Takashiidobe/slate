...
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = ixor({{__v[0-9]+}}, {{__v[0-9]+}});
...
// REWRITES-NEXT:     println!("{}", ixor(12, 10));
// REWRITES-NEXT:     let _ = std::io::Write::flush(&mut std::io::stdout());
// REWRITES-NEXT:     println!("{}", ixor(-1, 6));
// REWRITES-NEXT:     let _ = std::io::Write::flush(&mut std::io::stdout());
// REWRITES-NEXT:     let {{__v[0-9]+}}: u32 = 15;
// REWRITES-NEXT:     let {{__v[0-9]+}}: u32 = 255 ^ {{__v[0-9]+}};
// REWRITES-NEXT:     let _ = std::io::Write::flush(&mut std::io::stdout());
