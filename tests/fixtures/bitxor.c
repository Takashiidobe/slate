...
// LOWERING-NEXT: }
// LOWERING-EMPTY:
// LOWERING-NEXT: fn ixor({{arg[0-9]+}}: i32, {{arg[0-9]+}}: i32) -> i32 {
...
// LOWERING-NEXT:     let {{_v[0-9]+}}: i32 = ixor({{_v[0-9]+}}, {{_v[0-9]+}});
...
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: fn ixor({{arg[0-9]+}}: i32, {{arg[0-9]+}}: i32) -> i32 {
...
// REWRITES-NEXT: let {{_v[0-9]+}}: i32 = ixor({{_v[0-9]+}}, {{_v[0-9]+}});
