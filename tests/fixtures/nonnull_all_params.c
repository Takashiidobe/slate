...
// LOWERING-NEXT:     let {{_v[0-9]+}}: i32 = unsafe { use_all(std::ptr::addr_of_mut!(x), std::ptr::addr_of_mut!(y)) };
...
// REWRITES-NEXT: let {{_v[0-9]+}}: i32 = unsafe { use_all(std::ptr::addr_of_mut!(x), std::ptr::addr_of_mut!(y)) };
