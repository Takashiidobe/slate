...
// COMMON-LOWERING-NEXT: union Pair {
...
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = pick_left({{__v[0-9]+}});
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { printf({{__v[0-9]+}} as *const core::ffi::c_char, {{__v[0-9]+}}) };
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 3;
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 9;
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = overwrite({{__v[0-9]+}}, {{__v[0-9]+}});
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { printf({{__v[0-9]+}} as *const core::ffi::c_char, {{__v[0-9]+}}) };
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// COMMON-LOWERING-NEXT:     std::process::exit({{__v[0-9]+}} as i32);
// COMMON-LOWERING-NEXT: }
// COMMON-LOWERING-EMPTY:
// COMMON-LOWERING-NEXT: fn pick_left({{arg[0-9]+}}: i32) -> i32 {
// COMMON-LOWERING-NEXT:     let mut p: Pair = unsafe { std::mem::zeroed::<Pair>() };
...
// COMMON-LOWERING-NEXT: }
// COMMON-LOWERING-EMPTY:
// COMMON-LOWERING-NEXT: fn overwrite({{arg[0-9]+}}: i32, {{arg[0-9]+}}: i32) -> i32 {
// COMMON-LOWERING-NEXT:     let mut p: Pair = unsafe { std::mem::zeroed::<Pair>() };
// COMMON-LOWERING-NEXT:     unsafe {
// COMMON-LOWERING-NEXT:         p.left = {{arg[0-9]+}};
// COMMON-LOWERING-NEXT:     }
...
// COMMON-REWRITES-NEXT: union Pair {
...
// COMMON-REWRITES-NEXT: }
// COMMON-REWRITES-EMPTY:
// COMMON-REWRITES-NEXT: fn pick_left({{arg[0-9]+}}: i32) -> i32 {
// COMMON-REWRITES-NEXT:     let mut p: Pair = unsafe { std::mem::zeroed::<Pair>() };
...
// COMMON-REWRITES-NEXT: }
// COMMON-REWRITES-EMPTY:
// COMMON-REWRITES-NEXT: fn overwrite({{arg[0-9]+}}: i32, {{arg[0-9]+}}: i32) -> i32 {
// COMMON-REWRITES-NEXT:     let mut p: Pair = unsafe { std::mem::zeroed::<Pair>() };
// COMMON-REWRITES-NEXT:     unsafe {
// COMMON-REWRITES-NEXT:         p.left = {{arg[0-9]+}};
// COMMON-REWRITES-NEXT:     }
