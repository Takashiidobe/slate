...
// REWRITES-NEXT:         (({{__v[0-9]+}} == 1) as i32) + (({{__v[0-9]+}} == 1) as i32) + (((output[0] as i32) == 65) as i32);
...
// REWRITES-NEXT:     let {{__v[0-9]+}}: bool = if {{__v[0-9]+}} {
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 =
// REWRITES-NEXT:             unsafe { strcmp(second_copy as *const core::ffi::c_char, c"lib".as_ptr()) };
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} == 0;
// REWRITES-NEXT:         {{__v[0-9]+}}
// REWRITES-NEXT:     } else {
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = false;
