...
typedef int yaml_read_handler_t(void *, yaml_char_t *, unsigned long, unsigned long *);
...
static int read_bytes(void *data, yaml_char_t *buffer, unsigned long size, unsigned long *size_read) {
