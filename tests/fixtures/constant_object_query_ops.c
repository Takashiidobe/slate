...
// LOWERING-NEXT:     let _v1: *mut i32 = local.as_mut_ptr() as *mut i32;
// LOWERING-NEXT:     p = _v1;
// LOWERING-NEXT:     let _v2: i32 = 3;
// LOWERING-NEXT:     unsafe { std::ptr::write_volatile(std::ptr::addr_of_mut!(v), _v2) };
// LOWERING-NEXT:     let _v3: i32 = 1;
// LOWERING-NEXT:     c_literal = _v3;
// LOWERING-NEXT:     let _v4: i32 = 1;
// LOWERING-NEXT:     c_expr = _v4;
// LOWERING-NEXT:     let _v5: i32 = 0;
// LOWERING-NEXT:     c_volatile = _v5;
// LOWERING-NEXT:     let _v6: u64 = 24;
// LOWERING-NEXT:     local_whole = _v6;
// LOWERING-NEXT:     let _v7: u64 = 16;
// LOWERING-NEXT:     local_remaining = _v7;
// LOWERING-NEXT:     let _v8: u64 = 16;
// LOWERING-NEXT:     global_whole = _v8;
// LOWERING-NEXT:     let _v9: *mut i32 = p;
// LOWERING-NEXT:     let _v10: *mut core::ffi::c_void = _v9 as *mut core::ffi::c_void;
// LOWERING-NEXT:     let _v11: u64 = u64::MAX;
// LOWERING-NEXT:     unknown = _v11;
// LOWERING-NEXT:     let _v12: *mut i32 = p;
// LOWERING-NEXT:     let _v13: *mut core::ffi::c_void = _v12 as *mut core::ffi::c_void;
// LOWERING-NEXT:     let _v14: u64 = 0;
// LOWERING-NEXT:     unknown_upper = _v14;
// LOWERING-NEXT:     let _v15: *mut i8 = b"%d %d %d %lu %lu %lu %lu %lu\n\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let _v16: i32 = c_literal;
// LOWERING-NEXT:     let _v17: i32 = c_expr;
// LOWERING-NEXT:     let _v18: i32 = c_volatile;
// LOWERING-NEXT:     let _v19: u64 = local_whole;
// LOWERING-NEXT:     let _v20: u64 = local_remaining;
// LOWERING-NEXT:     let _v21: u64 = global_whole;
// LOWERING-NEXT:     let _v22: u64 = unknown;
// LOWERING-NEXT:     let _v23: u64 = unknown_upper;
// LOWERING-NEXT:     let _v24: i32 = unsafe { printf(_v15 as *const i8, _v16, _v17, _v18, _v19, _v20, _v21, _v22, _v23) };
...
// REWRITES-NEXT: unsafe { std::ptr::write_volatile(std::ptr::addr_of_mut!(v), _v2) };
...
// REWRITES-NEXT: let _v10: *mut core::ffi::c_void = p as *mut core::ffi::c_void;
// REWRITES-NEXT: let _v11: u64 = u64::MAX;
// REWRITES-NEXT: unknown = _v11;
// REWRITES-NEXT: let _v13: *mut core::ffi::c_void = p as *mut core::ffi::c_void;
// REWRITES-NEXT: unknown_upper = 0;
// REWRITES-NEXT: let _v15: *mut i8 = b"%d %d %d %lu %lu %lu %lu %lu\n\0".as_ptr() as *mut i8;
// REWRITES-NEXT: let _v24: i32 = unsafe { printf(_v15 as *const i8, c_literal, c_expr, c_volatile, local_whole, local_remaining, global_whole, unknown, unknown_upper) };
// REWRITES-NEXT: __retval = 0;
