...
// REWRITES-DAG: let {{_v[0-9]+}}: i32 = 1;
// REWRITES-DAG: let {{_v[0-9]+}}: bool = if ({{_v[0-9]+}}.re as i32) != {{_v[0-9]+}} {
// REWRITES-DAG: let {{_v[0-9]+}}: bool = true;
// REWRITES-DAG: {{_v[0-9]+}}
// REWRITES-DAG: } else {
// REWRITES-DAG: let {{_v[0-9]+}}: num_complex::Complex<i8> = fields.c8;
// REWRITES-DAG: let {{_v[0-9]+}}: i32 = 2;
// REWRITES-DAG: let {{_v[0-9]+}}: bool = ({{_v[0-9]+}}.im as i32) != {{_v[0-9]+}};
// REWRITES-DAG: {{_v[0-9]+}}
// REWRITES-DAG: };
...
// REWRITES-DAG: let {{_v[0-9]+}}: i32 = 3;
// REWRITES-DAG: let {{_v[0-9]+}}: bool = ({{_v[0-9]+}}.re as i32) != {{_v[0-9]+}};
// REWRITES-DAG: {{_v[0-9]+}}
// REWRITES-DAG: };
// REWRITES-DAG: let {{_v[0-9]+}}: bool = if {{_v[0-9]+}} {
// REWRITES-DAG: let {{_v[0-9]+}}: bool = true;
...
// REWRITES-DAG: let {{_v[0-9]+}}: f32 = 5.0;
// REWRITES-DAG: let {{_v[0-9]+}}: bool = {{_v[0-9]+}}.re != {{_v[0-9]+}};
// REWRITES-DAG: {{_v[0-9]+}}
// REWRITES-DAG: };
// REWRITES-DAG: let {{_v[0-9]+}}: bool = if {{_v[0-9]+}} {
// REWRITES-DAG: let {{_v[0-9]+}}: bool = true;
