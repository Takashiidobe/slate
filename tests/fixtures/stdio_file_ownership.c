...
// REWRITES-X86_64-GNU-NEXT:     let mut f: *mut libc::FILE = std::ptr::null_mut();
// REWRITES-X86_64-GNU-NEXT:     let mut g: *mut libc::FILE = std::ptr::null_mut();
...
// REWRITES-NEXT:     ];
// REWRITES-AARCH64-GNU-NEXT:     let mut f: *mut libc::FILE = std::ptr::null_mut();
// REWRITES-AARCH64-GNU-NEXT:     let mut g: *mut libc::FILE = std::ptr::null_mut();
