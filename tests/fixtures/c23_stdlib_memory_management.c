...
// LOWERING-NEXT:     let {{__v[0-9]+}}: u64 = 16;
// LOWERING-NEXT:     unsafe { free_sized({{__v[0-9]+}} as *mut core::ffi::c_void, {{__v[0-9]+}} as usize) };
// LOWERING-NEXT:     let {{__v[0-9]+}}: u64 = 16;
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: u64 = 16;
// LOWERING-NEXT:     let {{__v[0-9]+}}: u64 = 32;
// LOWERING-NEXT:     unsafe { free_aligned_sized({{__v[0-9]+}} as *mut core::ffi::c_void, {{__v[0-9]+}} as usize, {{__v[0-9]+}} as usize) };
...
// LOWERING-NEXT:         unsafe { realloc({{__v[0-9]+}} as *mut core::ffi::c_void, {{__v[0-9]+}} as usize) };
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: u64 = memalignment({{__v[0-9]+}} as *mut core::ffi::c_void);
// LOWERING-NEXT:     let {{__v[0-9]+}}: u64 = 64;
...
// LOWERING-NEXT:     v = {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: u64 = 0;
// LOWERING-NEXT:     align = {{__v[0-9]+}};
// LOWERING-NEXT:     {
// LOWERING-NEXT:         loop {
// LOWERING-NEXT:             let {{__v[0-9]+}}: u64 = v;
// LOWERING-NEXT:             let {{__v[0-9]+}}: u64 = 0;
// LOWERING-NEXT:             let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
...
// LOWERING-NEXT:                 let {{__v[0-9]+}}: u64 = {{__v[0-9]+}} >> {{__v[0-9]+}};
// LOWERING-NEXT:                 v = {{__v[0-9]+}};
// LOWERING-NEXT:                 let {{__v[0-9]+}}: u64 = align;
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: u64 = 0;
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} == {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: u64 = if {{__v[0-9]+}} {
// LOWERING-NEXT:         let {{__v[0-9]+}}: u64 = 0;
// LOWERING-NEXT:         {{__v[0-9]+}}
// LOWERING-NEXT:     } else {
// LOWERING-NEXT:         let {{__v[0-9]+}}: u64 = 1;
...
// REWRITES-NEXT:     unsafe {
// REWRITES-NEXT:         free(
// REWRITES-NEXT:             (unsafe { realloc({{__v[0-9]+}} as *mut core::ffi::c_void, (0 as u64) as usize) })
// REWRITES-NEXT:                 as *mut core::ffi::c_void,
// REWRITES-NEXT:         )
// REWRITES-NEXT:     };
...
// REWRITES-NEXT:     let {{__v[0-9]+}}: u64 = memalignment({{__v[0-9]+}} as *mut core::ffi::c_void);
// REWRITES-NEXT:     unsafe { printf({{__v[0-9]+}} as *const core::ffi::c_char, ({{__v[0-9]+}} % 64 == 0) as i32) };
...
// REWRITES-NEXT:     }
// REWRITES-NEXT:     let {{__v[0-9]+}}: u64 = if v == 0 {
// REWRITES-NEXT:         let {{__v[0-9]+}}: u64 = 0;
// REWRITES-NEXT:         {{__v[0-9]+}}
// REWRITES-NEXT:     } else {
// REWRITES-NEXT:         let {{__v[0-9]+}}: u64 = 1;
// REWRITES-NEXT:         let {{__v[0-9]+}}: u64 = {{__v[0-9]+}} << align;
// REWRITES-NEXT:         {{__v[0-9]+}}
// REWRITES-NEXT:     };
// REWRITES-NEXT:     {{__v[0-9]+}}
// REWRITES-NEXT: }
