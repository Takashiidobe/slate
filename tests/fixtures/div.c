...
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = idiv({{__v[0-9]+}}, {{__v[0-9]+}});
...
// LOWERING-NEXT: }
// LOWERING-EMPTY:
// LOWERING-NEXT: fn idiv({{arg[0-9]+}}: i32, {{arg[0-9]+}}: i32) -> i32 {
...
// REWRITES-NEXT:     println!("{}", idiv(-7, 2));
...
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: fn idiv({{arg[0-9]+}}: i32, {{arg[0-9]+}}: i32) -> i32 {
