...
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = first_multiple({{__v[0-9]+}}, {{__v[0-9]+}});
...
// COMMON-LOWERING-NEXT: }
// COMMON-LOWERING-EMPTY:
// COMMON-LOWERING-NEXT: fn first_multiple({{arg[0-9]+}}: i32, {{arg[0-9]+}}: i32) -> i32 {
// COMMON-LOWERING-NEXT:     let mut n: i32 = 0;
// COMMON-LOWERING-NEXT:     let mut m: i32 = 0;
// COMMON-LOWERING-NEXT:     let mut __retval: i32 = 0;
// COMMON-LOWERING-NEXT:     n = {{arg[0-9]+}};
// COMMON-LOWERING-NEXT:     m = {{arg[0-9]+}};
// COMMON-LOWERING-NEXT:     {
...
// COMMON-LOWERING-NEXT:                 {
// COMMON-LOWERING-NEXT:                     let {{__v[0-9]+}}: i32 = i;
// COMMON-LOWERING-NEXT:                     let {{__v[0-9]+}}: i32 = m;
...
// COMMON-REWRITES-NEXT: }
// COMMON-REWRITES-EMPTY:
// COMMON-REWRITES-NEXT: fn first_multiple(mut n: i32, mut m: i32) -> i32 {
// COMMON-REWRITES-NEXT:     let mut i: i32 = 0;
// COMMON-REWRITES-NEXT:     i = 1;
// COMMON-REWRITES-NEXT:     while i <= n {
// COMMON-REWRITES-NEXT:         if i % m == 0 {
// COMMON-REWRITES-NEXT:             return i;
// COMMON-REWRITES-NEXT:         }
// COMMON-REWRITES-NEXT:         if i > 100 {
