...
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"slate_stdio_gets_loop_truncation.tmp\0".as_ptr() as *mut i8;
...
// REWRITES-NEXT:         fopen(
// REWRITES-NEXT:             c"slate_stdio_gets_loop_truncation.tmp".as_ptr(),
