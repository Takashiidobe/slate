...
// COMMON-LOWERING-NEXT: union FnBox {
// COMMON-LOWERING-NEXT:     r#fn: Option<unsafe extern "C-unwind" fn(i32) -> i32>,
// COMMON-LOWERING-NEXT:     ptr: *mut core::ffi::c_void,
// COMMON-LOWERING-NEXT: }
// COMMON-LOWERING-EMPTY:
...
// COMMON-LOWERING-NEXT:     let mut r#box: FnBox = unsafe { std::mem::zeroed::<FnBox>() };
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// COMMON-LOWERING-NEXT:     unsafe {
// COMMON-LOWERING-NEXT:         r#box.r#fn = unsafe {
...
// COMMON-LOWERING-NEXT:         };
// COMMON-LOWERING-NEXT:     }
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: *mut core::ffi::c_void = unsafe { r#box.ptr };
...
// COMMON-REWRITES-NEXT: union FnBox {
// COMMON-REWRITES-NEXT:     r#fn: Option<unsafe extern "C-unwind" fn(i32) -> i32>,
// COMMON-REWRITES-NEXT:     ptr: *mut core::ffi::c_void,
// COMMON-REWRITES-NEXT: }
// COMMON-REWRITES-EMPTY:
...
// COMMON-REWRITES-NEXT:     let mut r#box: FnBox = unsafe { std::mem::zeroed::<FnBox>() };
// COMMON-REWRITES-NEXT:     unsafe {
// COMMON-REWRITES-NEXT:         r#box.r#fn = unsafe {
...
// COMMON-REWRITES-NEXT:         std::mem::transmute::<usize, Option<unsafe extern "C-unwind" fn(i32) -> i32>>(
// COMMON-REWRITES-NEXT:             (unsafe { r#box.ptr }) as usize,
// COMMON-REWRITES-NEXT:         )
// COMMON-REWRITES-NEXT:     };
// COMMON-REWRITES-NEXT:     let {{__v[0-9]+}}: Option<unsafe extern "C-unwind" fn(i32) -> i32> = None;
// COMMON-REWRITES-NEXT:     unsafe {
// COMMON-REWRITES-NEXT:         printf(
// COMMON-REWRITES-NEXT:             c"%d %d\n".as_ptr(),
// COMMON-REWRITES-NEXT:             unsafe { {{__v[0-9]+}}.unwrap()(41 as i32) },
// COMMON-REWRITES-NEXT:             ({{__v[0-9]+}} != None) as i32,
// COMMON-REWRITES-NEXT:         )
// COMMON-REWRITES-NEXT:     };
