...
// REWRITES-NEXT:     let mut b: Buf = Buf {
// REWRITES-NEXT:         data: [0; 3],
// REWRITES-NEXT:         len: 0,
// REWRITES-NEXT:     };
// REWRITES-NEXT:     let mut init: Buf = Buf {
// REWRITES-NEXT:         data: [0; 3],
// REWRITES-NEXT:         len: 0,
// REWRITES-NEXT:     };
// REWRITES-NEXT:     let mut sum: i32 = 0;
// REWRITES-NEXT:     let {{__v[0-9]+}}: i64 = 0;
// REWRITES-NEXT:     b.data[({{__v[0-9]+}} as usize)] = 10;
// REWRITES-NEXT:     let {{__v[0-9]+}}: i64 = 1;
// REWRITES-NEXT:     b.data[({{__v[0-9]+}} as usize)] = 20;
