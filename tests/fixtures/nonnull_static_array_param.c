...
// LOWERING-NEXT:     let _v3: i32 = unsafe { sum4(_v2) };
...
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: unsafe fn sum4(arg0: *mut i32) -> i32 {
// REWRITES-NEXT: let mut arr: *mut i32 = arg0;
...
// REWRITES-NEXT: let _v3: i32 = unsafe { sum4(_v2) };
