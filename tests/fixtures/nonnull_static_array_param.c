...
// COMMON-LOWERING-NEXT: }
// COMMON-LOWERING-EMPTY:
// COMMON-LOWERING-NEXT: unsafe fn sum4({{arg[0-9]+}}: *mut i32) -> i32 {
// COMMON-LOWERING-NEXT:     let mut arr: *mut i32 = std::ptr::null_mut();
// COMMON-LOWERING-NEXT:     let mut s: i32 = 0;
// COMMON-LOWERING-NEXT:     arr = {{arg[0-9]+}};
...
// COMMON-LOWERING-NEXT:                 let {{__v[0-9]+}}: *mut i32 = arr;
...
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { sum4({{__v[0-9]+}}) };
...
// COMMON-REWRITES-NEXT: }
// COMMON-REWRITES-EMPTY:
// COMMON-REWRITES-NEXT: unsafe fn sum4(mut arr: *mut i32) -> i32 {
// COMMON-REWRITES-NEXT:     let mut s: i32 = 0;
// COMMON-REWRITES-NEXT:     for i in 0..4 {
// COMMON-REWRITES-NEXT:         let {{__v[0-9]+}}: *mut i32 = arr;
...
// COMMON-REWRITES-NEXT:     unsafe { printf({{__v[0-9]+}} as *const core::ffi::c_char, unsafe { sum4({{__v[0-9]+}}) }) };
