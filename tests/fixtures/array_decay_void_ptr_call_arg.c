...
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: *mut core::ffi::c_void = text.as_mut_ptr() as *mut core::ffi::c_void;
// COMMON-LOWERING-NEXT:     set_data({{__v[0-9]+}} as *mut core::ffi::c_void);
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// COMMON-LOWERING-NEXT:     std::process::exit({{__v[0-9]+}} as i32);
// COMMON-LOWERING-NEXT: }
// COMMON-LOWERING-EMPTY:
// COMMON-LOWERING-NEXT: fn set_data({{arg[0-9]+}}: *mut core::ffi::c_void) {
...
// COMMON-REWRITES-NEXT:     set_data(text.as_mut_ptr() as *mut core::ffi::c_void);
// COMMON-REWRITES-NEXT:     std::process::exit(0 as i32);
// COMMON-REWRITES-NEXT: }
// COMMON-REWRITES-EMPTY:
// COMMON-REWRITES-NEXT: fn set_data({{arg[0-9]+}}: *mut core::ffi::c_void) {
