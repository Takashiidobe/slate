...
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = sum_odds({{__v[0-9]+}});
...
// LOWERING-NEXT: }
// LOWERING-EMPTY:
// LOWERING-NEXT: fn sum_odds({{arg[0-9]+}}: i32) -> i32 {
...
// REWRITES-NEXT:     println!("{}", sum_odds(10));
// REWRITES-NEXT:     let _ = std::io::Write::flush(&mut std::io::stdout());
// REWRITES-NEXT:     println!("{}", sum_odds(1));
// REWRITES-NEXT:     let _ = std::io::Write::flush(&mut std::io::stdout());
// REWRITES-NEXT:     println!("{}", sum_odds(0));
// REWRITES-NEXT:     let _ = std::io::Write::flush(&mut std::io::stdout());
// REWRITES-NEXT:     return std::process::ExitCode::SUCCESS;
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: fn sum_odds(mut n: i32) -> i32 {
