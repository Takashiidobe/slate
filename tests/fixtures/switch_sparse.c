...
// COMMON-LOWERING-NEXT: }
// COMMON-LOWERING-EMPTY:
// COMMON-LOWERING-NEXT: fn map({{arg[0-9]+}}: i32) -> i32 {
...
// COMMON-LOWERING-NEXT:                 -3 => 0,
// COMMON-LOWERING-NEXT:                 100 => 1,
...
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = map({{__v[0-9]+}});
...
// COMMON-REWRITES-NEXT: }
// COMMON-REWRITES-EMPTY:
// COMMON-REWRITES-NEXT: fn map(mut {{__v[0-9]+}}: i32) -> i32 {
// COMMON-REWRITES-NEXT:     let mut out: i32 = 0;
// COMMON-REWRITES-NEXT:     match {{__v[0-9]+}} {
// COMMON-REWRITES-NEXT:         -3 => {
// COMMON-REWRITES-NEXT:             out = 13;
// COMMON-REWRITES-NEXT:         }
// COMMON-REWRITES-NEXT:         100 => {
// COMMON-REWRITES-NEXT:             out = 1000;
// COMMON-REWRITES-NEXT:         }
