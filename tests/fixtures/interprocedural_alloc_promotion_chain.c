...
// COMMON-LOWERING-NEXT: }
// COMMON-LOWERING-EMPTY:
// COMMON-LOWERING-NEXT: fn indirect() -> *mut i32 {
...
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i32 = indirect();
...
// COMMON-REWRITES-NEXT: }
// COMMON-REWRITES-EMPTY:
// COMMON-REWRITES-NEXT: fn indirect() -> *mut i32 {
// COMMON-REWRITES-NEXT:     Box::into_raw(alloc()).cast::<i32>()
// COMMON-REWRITES-NEXT: }
// COMMON-REWRITES-EMPTY:
// COMMON-REWRITES-NEXT: fn main() {
// COMMON-REWRITES-NEXT:     let {{__v[0-9]+}}: *mut i32 = indirect();
