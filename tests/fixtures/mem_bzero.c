...
// LOWERING-NEXT:     let {{__v[0-9]+}}: u64 = 20;
// LOWERING-NEXT:     let {{__v[0-9]+}}: u8 = 0;
// LOWERING-NEXT:     unsafe { std::ptr::write_bytes({{__v[0-9]+}} as *mut u8, {{__v[0-9]+}} as u8, {{__v[0-9]+}} as usize) };
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
...
// REWRITES-NEXT:     let {{__v[0-9]+}}: u64 = 20;
// REWRITES-NEXT:     let {{__v[0-9]+}}: u8 = 0;
// REWRITES-NEXT:     unsafe { std::ptr::write_bytes({{__v[0-9]+}} as *mut u8, {{__v[0-9]+}} as u8, {{__v[0-9]+}} as usize) };
