...
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: u64 = 20;
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: u8 = 0;
// COMMON-LOWERING-NEXT:     unsafe { std::ptr::write_bytes({{__v[0-9]+}} as *mut u8, {{__v[0-9]+}} as u8, {{__v[0-9]+}} as usize) };
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
...
// COMMON-REWRITES-NEXT:     let {{__v[0-9]+}}: u64 = 20;
// COMMON-REWRITES-NEXT:     let {{__v[0-9]+}}: u8 = 0;
// COMMON-REWRITES-NEXT:     unsafe { std::ptr::write_bytes({{__v[0-9]+}} as *mut u8, {{__v[0-9]+}} as u8, {{__v[0-9]+}} as usize) };
