...
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = imul({{__v[0-9]+}}, {{__v[0-9]+}});
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { printf({{__v[0-9]+}} as *const core::ffi::c_char, {{__v[0-9]+}}) };
// LOWERING-NEXT:     let {{__v[0-9]+}}: u32 = 100000;
...
// REWRITES-NEXT:     println!("{}", imul(-4, 7));
// REWRITES-NEXT:     let _ = std::io::Write::flush(&mut std::io::stdout());
// REWRITES-NEXT:     let {{__v[0-9]+}}: u32 = 100000;
// REWRITES-NEXT:     let _ = std::io::Write::flush(&mut std::io::stdout());
