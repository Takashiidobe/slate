...
// LOWERING-NEXT: }
// LOWERING-EMPTY:
// LOWERING-NEXT: fn imul({{arg[0-9]+}}: i32, {{arg[0-9]+}}: i32) -> i32 {
...
// LOWERING-NEXT:     let {{_v[0-9]+}}: i32 = imul({{_v[0-9]+}}, {{_v[0-9]+}});
// LOWERING-NEXT:     let {{_v[0-9]+}}: i32 = unsafe { printf({{_v[0-9]+}} as *const i8, {{_v[0-9]+}}) };
// LOWERING-NEXT:     let {{_v[0-9]+}}: u32 = 100000;
...
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: fn imul({{arg[0-9]+}}: i32, {{arg[0-9]+}}: i32) -> i32 {
...
// REWRITES-NEXT: let {{_v[0-9]+}}: i32 = imul({{_v[0-9]+}}, {{_v[0-9]+}});
...
// REWRITES-NEXT: let {{_v[0-9]+}}: i32 = unsafe { printf({{_v[0-9]+}} as *const i8, u * u) };
// REWRITES-NEXT: __retval = 0;
