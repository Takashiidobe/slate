...
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = imul({{__v[0-9]+}}, {{__v[0-9]+}});
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { printf({{__v[0-9]+}} as *const core::ffi::c_char, {{__v[0-9]+}}) };
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: u32 = 100000;
...
// COMMON-LOWERING-NEXT: }
// COMMON-LOWERING-EMPTY:
// COMMON-LOWERING-NEXT: fn imul({{arg[0-9]+}}: i32, {{arg[0-9]+}}: i32) -> i32 {
...
// COMMON-REWRITES-NEXT:     let {{__v[0-9]+}}: u32 = 100000;
// COMMON-REWRITES-NEXT:     unsafe { printf(c"%u\n".as_ptr(), {{__v[0-9]+}} * {{__v[0-9]+}}) };
// COMMON-REWRITES-NEXT:     std::process::exit(0 as i32);
// COMMON-REWRITES-NEXT: }
// COMMON-REWRITES-EMPTY:
// COMMON-REWRITES-NEXT: fn imul({{arg[0-9]+}}: i32, {{arg[0-9]+}}: i32) -> i32 {
