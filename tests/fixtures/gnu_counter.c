...
// COMMON-LOWERING-NEXT: static mut direct_zero: i32 = 0;
// COMMON-LOWERING-EMPTY:
// COMMON-LOWERING-NEXT: static mut macro_one: i32 = 1;
// COMMON-LOWERING-EMPTY:
// COMMON-LOWERING-NEXT: static mut pair: i32 = 23;
// COMMON-LOWERING-EMPTY:
...
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { direct_zero };
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { macro_one };
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { pair };
...
// COMMON-REWRITES-NEXT: static mut direct_zero: i32 = 0;
// COMMON-REWRITES-EMPTY:
// COMMON-REWRITES-NEXT: static mut macro_one: i32 = 1;
// COMMON-REWRITES-EMPTY:
// COMMON-REWRITES-NEXT: static mut pair: i32 = 23;
// COMMON-REWRITES-EMPTY:
...
// COMMON-REWRITES-NEXT:             unsafe { direct_zero },
// COMMON-REWRITES-NEXT:             unsafe { macro_one },
// COMMON-REWRITES-NEXT:             unsafe { pair },
