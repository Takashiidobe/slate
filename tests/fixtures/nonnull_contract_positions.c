...
// REWRITES-NEXT: let mut scale: i32 = {{arg[0-9]+}};
// REWRITES-NEXT: let mut optional: *mut i32 = {{arg[0-9]+}};
// REWRITES-NEXT: let mut __retval: i32 = 0;
// REWRITES-NEXT: let {{_v[0-9]+}}: i32 = (unsafe { *(({{arg[0-9]+}} as *const i32) as *mut i32) }) + scale * unsafe { *(({{arg[0-9]+}} as *const i32) as *mut i32) };
...
// REWRITES-NEXT: let mut scale: i32 = {{arg[0-9]+}};
// REWRITES-NEXT: let mut __retval: i32 = 0;
// REWRITES-NEXT: __retval = (unsafe { *(({{arg[0-9]+}} as *const i32) as *mut i32) }) - scale * unsafe { *(({{arg[0-9]+}} as *const i32) as *mut i32) };
// REWRITES-NEXT: return __retval;
// REWRITES-NEXT: }
// REWRITES-EMPTY:
