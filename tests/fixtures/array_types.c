...
// LOWERING-NEXT:     values[({{__v[0-9]+}} as usize)] = {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: i64 = 0;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i8 = values[({{__v[0-9]+}} as usize)];
...
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = sum_char_array();
...
// REWRITES-NEXT:     let {{__v[0-9]+}}: f64 = pick_double_array({{__v[0-9]+}});
// REWRITES-NEXT:     unsafe { printf({{__v[0-9]+}} as *const core::ffi::c_char, {{__v[0-9]+}}) };
...
// REWRITES-NEXT:     let {{__v[0-9]+}}: f64 = 1.25;
// REWRITES-NEXT:     let {{__v[0-9]+}}: i64 = 0;
// REWRITES-NEXT:     values[({{__v[0-9]+}} as usize)] = {{__v[0-9]+}};
// REWRITES-NEXT:     let {{__v[0-9]+}}: f64 = 2.5;
// REWRITES-NEXT:     let {{__v[0-9]+}}: i64 = 1;
// REWRITES-NEXT:     values[({{__v[0-9]+}} as usize)] = {{__v[0-9]+}};
// REWRITES-NEXT:     let {{__v[0-9]+}}: i64 = 0;
// REWRITES-NEXT:     let {{__v[0-9]+}}: f64 = values[({{__v[0-9]+}} as usize)];
// REWRITES-NEXT:     let {{__v[0-9]+}}: i64 = 1;
// REWRITES-NEXT:     let {{__v[0-9]+}}: f64 = values[({{__v[0-9]+}} as usize)];
