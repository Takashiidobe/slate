...
// LOWERING-DAG:     let {{__v[0-9]+}}: *mut i8 = buf;
...
// LOWERING-DAG:             let {{__v[0-9]+}}: u8 = {{__v[0-9]+}} as u8;
...
// REWRITES-DAG:         let {{__v[0-9]+}}: *mut i8 = buf;
// REWRITES-DAG:         let {{__v[0-9]+}}: *mut i8 = unsafe { {{__v[0-9]+}}.offset((i as i64) as isize) };
// REWRITES-DAG:         score += ((unsafe { *{{__v[0-9]+}} }) as u8) as i32;
// REWRITES-DAG:     }
