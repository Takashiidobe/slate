...
// LOWERING-NEXT: }
// LOWERING-EMPTY:
// LOWERING-NEXT: static mut frame: aligned::Aligned<aligned::A16, [__slate_jmp_buf_tag; 1]> = aligned::Aligned(
...
// LOWERING-NEXT:         }
// LOWERING-NEXT:     }
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"returned\n\0".as_ptr() as *mut i8;
...
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: static mut frame: aligned::Aligned<aligned::A16, [__slate_jmp_buf_tag; 1]> = aligned::Aligned(
...
// REWRITES-NEXT:     let {{__v[0-9]+}}: *mut __slate_jmp_buf_tag = std::ptr::addr_of_mut!(frame).cast::<__slate_jmp_buf_tag>();
