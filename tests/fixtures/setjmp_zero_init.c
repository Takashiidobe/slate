...
// LOWERING-NEXT: }
// LOWERING-EMPTY:
// LOWERING-X86_64-GNU-NEXT: static mut frame: aligned::Aligned<aligned::A16, [__slate_jmp_buf_tag; 1]> =
// LOWERING-X86_64-GNU-NEXT:     aligned::Aligned([__slate_jmp_buf_tag { __storage: [0; 25] }; 1]);
// LOWERING-AARCH64-GNU-NEXT: static mut frame: aligned::Aligned<aligned::A8, [__slate_jmp_buf_tag; 1]> =
...
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-X86_64-GNU-NEXT: static mut frame: aligned::Aligned<aligned::A16, [__slate_jmp_buf_tag; 1]> =
// REWRITES-X86_64-GNU-NEXT:     aligned::Aligned([__slate_jmp_buf_tag { __storage: [0; 25] }; 1]);
// REWRITES-AARCH64-GNU-NEXT: static mut frame: aligned::Aligned<aligned::A8, [__slate_jmp_buf_tag; 1]> =
