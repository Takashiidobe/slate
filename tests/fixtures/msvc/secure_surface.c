...
TYPE_IS(&_get_invalid_parameter_handler,
...
TYPE_IS(&_invoke_watson,
        void (*)(const wchar_t *, const wchar_t *, const wchar_t *,
...
TYPE_IS(&strncat_s,
        errno_t (*)(char *, rsize_t, const char *, rsize_t));
...
TYPE_IS(&_wfopen_s,
        errno_t (*)(FILE **, const wchar_t *, const wchar_t *));
...
TYPE_IS(&_wgetenv_s,
        errno_t (*)(size_t *, wchar_t *, size_t, const wchar_t *));

TYPE_IS(&wcscpy_s, errno_t (*)(wchar_t *, rsize_t, const wchar_t *));
TYPE_IS(&wcsncpy_s,
        errno_t (*)(wchar_t *, rsize_t, const wchar_t *, rsize_t));
TYPE_IS(&wmemcpy_s,
        errno_t (*)(wchar_t *, rsize_t, const wchar_t *, rsize_t));
TYPE_IS(&mbsrtowcs_s,
        errno_t (*)(size_t *, wchar_t *, size_t, const char **, size_t,
...
TYPE_IS(&_ctime32_s,
        errno_t (*)(char *, size_t, const __time32_t *));
TYPE_IS(&_wctime64_s,
        errno_t (*)(wchar_t *, size_t, const __time64_t *));
