...
// LOWERING-MSVC-DAG:     let {{_v[0-9]+}}: i32 = unsafe { g_counter };
// LOWERING-MSVC-DAG:     let {{_v[0-9]+}}: i32 = 3;
// LOWERING-MSVC-DAG:     let {{_v[0-9]+}}: i32 = unsafe { actual_symbol({{_v[0-9]+}} as i32) };
// LOWERING-MSVC-DAG:     let {{_v[0-9]+}}: i32 = {{_v[0-9]+}} + {{_v[0-9]+}};
...
// REWRITES-MSVC-DAG:     let {{_v[0-9]+}}: i32 = unsafe { g_counter };
// REWRITES-MSVC-DAG:     let {{_v[0-9]+}}: i32 = unsafe { actual_symbol(3 as i32) };
