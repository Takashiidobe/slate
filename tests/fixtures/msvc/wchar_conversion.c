...
TYPE_IS(&mbrtowc, size_t (*)(wchar_t *, const char *, size_t, mbstate_t *));
TYPE_IS(&mbsrtowcs, size_t (*)(wchar_t *, const char **, size_t, mbstate_t *));
TYPE_IS(&wcrtomb, size_t (*)(char *, wchar_t, mbstate_t *));
TYPE_IS(&wcsrtombs, size_t (*)(char *, const wchar_t **, size_t, mbstate_t *));
...
TYPE_IS(&_wcstold_l, long double (*)(const wchar_t *, wchar_t **, _locale_t));
TYPE_IS(&wcstol, long (*)(const wchar_t *, wchar_t **, int));
TYPE_IS(&_wcstol_l, long (*)(const wchar_t *, wchar_t **, int, _locale_t));
...
TYPE_IS(&wcstoull, unsigned long long (*)(const wchar_t *, wchar_t **, int));
TYPE_IS(&_wcstoull_l,
...
TYPE_IS(&_wcstoi64_l,
        long long (*)(const wchar_t *, wchar_t **, int, _locale_t));
TYPE_IS(&_wcstoui64, unsigned long long (*)(const wchar_t *, wchar_t **, int));
