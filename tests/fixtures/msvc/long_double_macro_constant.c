...
// LOWERING-MSVC-NEXT:     let {{__v[0-9]+}}: f64 = 0.;
...
// REWRITES-MSVC-NEXT:     let {{__v[0-9]+}}: f64 = 0.;
// REWRITES-MSVC-NEXT:     {{__v[0-9]+}}
// REWRITES-MSVC-NEXT: }
// REWRITES-MSVC-EMPTY:
// REWRITES-MSVC-NEXT: fn main() {
// REWRITES-MSVC-NEXT:     let {{__v[0-9]+}}: f64 = f();
// REWRITES-MSVC-NEXT:     let {{__v[0-9]+}}: f64 = 0.0;
