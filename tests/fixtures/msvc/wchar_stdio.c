...
TYPE_IS(&_wfreopen, FILE *(*)(const wchar_t *, const wchar_t *, FILE *));
TYPE_IS(&_wfsopen, FILE *(*)(const wchar_t *, const wchar_t *, int));
...
TYPE_IS(&_vfwprintf_l, int (*)(FILE *, const wchar_t *, _locale_t, va_list));
TYPE_IS(&_vfwprintf_p, int (*)(FILE *, const wchar_t *, va_list));
TYPE_IS(&_vfwprintf_p_l, int (*)(FILE *, const wchar_t *, _locale_t, va_list));
TYPE_IS(&_vwprintf_l, int (*)(const wchar_t *, _locale_t, va_list));
TYPE_IS(&_vwprintf_p, int (*)(const wchar_t *, va_list));
TYPE_IS(&_vwprintf_p_l, int (*)(const wchar_t *, _locale_t, va_list));
TYPE_IS(&fwprintf, int (*)(FILE *, const wchar_t *, ...));
TYPE_IS(&wprintf, int (*)(const wchar_t *, ...));
TYPE_IS(&_fwprintf_l, int (*)(FILE *, const wchar_t *, _locale_t, ...));
TYPE_IS(&_fwprintf_p, int (*)(FILE *, const wchar_t *, ...));
TYPE_IS(&_fwprintf_p_l, int (*)(FILE *, const wchar_t *, _locale_t, ...));
...
TYPE_IS(&_vfwscanf_l, int (*)(FILE *, const wchar_t *, _locale_t, va_list));
...
TYPE_IS(&_fwscanf_l, int (*)(FILE *, const wchar_t *, _locale_t, ...));
TYPE_IS(&_wscanf_l, int (*)(const wchar_t *, _locale_t, ...));

TYPE_IS(&vswprintf, int (*)(wchar_t *, size_t, const wchar_t *, va_list));
TYPE_IS(&swprintf, int (*)(wchar_t *, size_t, const wchar_t *, ...));
TYPE_IS(&_vsnwprintf, int (*)(wchar_t *, size_t, const wchar_t *, va_list));
