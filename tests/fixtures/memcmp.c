...
// LOWERING-DAG:     let {{_v[0-9]+}}: [u8; 4] = [1, 2, 3, 4];
// LOWERING-DAG:     equal_a = {{_v[0-9]+}};
// LOWERING-DAG:     let {{_v[0-9]+}}: [u8; 4] = [1, 2, 3, 4];
// LOWERING-DAG:     equal_b = {{_v[0-9]+}};
// LOWERING-DAG:     let {{_v[0-9]+}}: *mut u8 = equal_a.as_mut_ptr() as *mut u8;
// LOWERING-DAG:     let {{_v[0-9]+}}: *mut core::ffi::c_void = {{_v[0-9]+}} as *mut core::ffi::c_void;
// LOWERING-DAG:     let {{_v[0-9]+}}: *mut u8 = equal_b.as_mut_ptr() as *mut u8;
// LOWERING-DAG:     let {{_v[0-9]+}}: *mut core::ffi::c_void = {{_v[0-9]+}} as *mut core::ffi::c_void;
...
// LOWERING-DAG:     let {{_v[0-9]+}}: [u8; 4] = [1, 2, 3, 4];
// LOWERING-DAG:     unequal_a = {{_v[0-9]+}};
// LOWERING-DAG:     let {{_v[0-9]+}}: [u8; 4] = [1, 2, 3, 9];
// LOWERING-DAG:     unequal_b = {{_v[0-9]+}};
// LOWERING-DAG:     let {{_v[0-9]+}}: *mut u8 = unequal_a.as_mut_ptr() as *mut u8;
// LOWERING-DAG:     let {{_v[0-9]+}}: *mut core::ffi::c_void = {{_v[0-9]+}} as *mut core::ffi::c_void;
// LOWERING-DAG:     let {{_v[0-9]+}}: *mut u8 = unequal_b.as_mut_ptr() as *mut u8;
// LOWERING-DAG:     let {{_v[0-9]+}}: *mut core::ffi::c_void = {{_v[0-9]+}} as *mut core::ffi::c_void;
// LOWERING-DAG:     let {{_v[0-9]+}}: u64 = 4;
// LOWERING-DAG:     let {{_v[0-9]+}}: i32 = unsafe {
// LOWERING-DAG:         memcmp(
...
// LOWERING-DAG:     let {{_v[0-9]+}}: bool = {{_v[0-9]+}} == {{_v[0-9]+}};
// LOWERING-DAG:     let {{_v[0-9]+}}: i32 = {{_v[0-9]+}} as i32;
// LOWERING-DAG:     let {{_v[0-9]+}}: [u8; 8] = [1, 2, 3, 4, 9, 9, 9, 9];
// LOWERING-DAG:     partial_a = {{_v[0-9]+}};
// LOWERING-DAG:     let {{_v[0-9]+}}: [u8; 8] = [1, 2, 3, 4, 0, 0, 0, 0];
// LOWERING-DAG:     partial_b = {{_v[0-9]+}};
// LOWERING-DAG:     let {{_v[0-9]+}}: *mut u8 = partial_a.as_mut_ptr() as *mut u8;
// LOWERING-DAG:     let {{_v[0-9]+}}: *mut core::ffi::c_void = {{_v[0-9]+}} as *mut core::ffi::c_void;
// LOWERING-DAG:     let {{_v[0-9]+}}: *mut u8 = partial_b.as_mut_ptr() as *mut u8;
// LOWERING-DAG:     let {{_v[0-9]+}}: *mut core::ffi::c_void = {{_v[0-9]+}} as *mut core::ffi::c_void;
// LOWERING-DAG:     let {{_v[0-9]+}}: u64 = 4;
// LOWERING-DAG:     let {{_v[0-9]+}}: i32 = unsafe {
// LOWERING-DAG:         memcmp(
...
// LOWERING-DAG:     dyn_a = {{_v[0-9]+}};
// LOWERING-DAG:     let {{_v[0-9]+}}: [u8; 8] = [1, 2, 3, 4, 5, 6, 7, 8];
// LOWERING-DAG:     dyn_b = {{_v[0-9]+}};
// LOWERING-DAG:     let {{_v[0-9]+}}: i32 = get_count();
// LOWERING-DAG:     let {{_v[0-9]+}}: *mut u8 = dyn_a.as_mut_ptr() as *mut u8;
// LOWERING-DAG:     let {{_v[0-9]+}}: *mut core::ffi::c_void = {{_v[0-9]+}} as *mut core::ffi::c_void;
// LOWERING-DAG:     let {{_v[0-9]+}}: *mut u8 = dyn_b.as_mut_ptr() as *mut u8;
// LOWERING-DAG:     let {{_v[0-9]+}}: *mut core::ffi::c_void = {{_v[0-9]+}} as *mut core::ffi::c_void;
