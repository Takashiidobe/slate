...
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = weighted_sum({{__v[0-9]+}}, {{__v[0-9]+}});
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { printf({{__v[0-9]+}} as *const core::ffi::c_char, {{__v[0-9]+}}) };
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// COMMON-LOWERING-NEXT:     std::process::exit({{__v[0-9]+}} as i32);
// COMMON-LOWERING-NEXT: }
// COMMON-LOWERING-EMPTY:
// COMMON-LOWERING-NEXT: fn weighted_sum({{arg[0-9]+}}: *mut i32, {{arg[0-9]+}}: i32) -> i32 {
...
// COMMON-REWRITES-NEXT:             weighted_sum(unsafe {
...
// COMMON-REWRITES-NEXT: }
// COMMON-REWRITES-EMPTY:
// COMMON-REWRITES-NEXT: fn weighted_sum({{arg[0-9]+}}: &[i32]) -> i32 {
...
// COMMON-REWRITES-NEXT:         total += (unsafe { *{{__v[0-9]+}} }) * i;
// COMMON-REWRITES-NEXT:     }
