...
// REWRITES-NEXT:     println!("{}", sum_array());
// REWRITES-NEXT:     let _ = std::io::Write::flush(&mut std::io::stdout());
// REWRITES-NEXT:     println!("{}", pick_index(1));
// REWRITES-NEXT:     let _ = std::io::Write::flush(&mut std::io::stdout());
...
// REWRITES-NEXT:     let mut values: [i32; 3] = [0; 3];
// REWRITES-NEXT:     let {{__v[0-9]+}}: i64 = 0;
// REWRITES-NEXT:     values[({{__v[0-9]+}} as usize)] = 10;
// REWRITES-NEXT:     let {{__v[0-9]+}}: i64 = 1;
// REWRITES-NEXT:     values[({{__v[0-9]+}} as usize)] = 20;
// REWRITES-NEXT:     let {{__v[0-9]+}}: i64 = 2;
// REWRITES-NEXT:     values[({{__v[0-9]+}} as usize)] = 30;
