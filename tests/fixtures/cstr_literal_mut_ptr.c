...
// LOWERING-DAG:             let {{__v[0-9]+}}: *mut i8 = b"mut\0".as_ptr() as *mut i8;
// LOWERING-DAG:             __retval = {{__v[0-9]+}};
// LOWERING-DAG:             let {{__v[0-9]+}}: *mut i8 = __retval;
// LOWERING-DAG:             return {{__v[0-9]+}};
// LOWERING-DAG:         }
// LOWERING-DAG:     }
// LOWERING-DAG:     let {{__v[0-9]+}}: *mut i8 = b"other\0".as_ptr() as *mut i8;
// LOWERING-DAG:     __retval = {{__v[0-9]+}};
// LOWERING-DAG:     let {{__v[0-9]+}}: *mut i8 = __retval;
// LOWERING-DAG:     return {{__v[0-9]+}};
// LOWERING-DAG: }
...
// LOWERING-DAG:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} == {{__v[0-9]+}};
// LOWERING-DAG:         if {{__v[0-9]+}} {
// LOWERING-DAG:             let {{__v[0-9]+}}: *mut i8 = b"const\0".as_ptr() as *mut i8;
// LOWERING-DAG:             __retval = {{__v[0-9]+}};
// LOWERING-DAG:             let {{__v[0-9]+}}: *mut i8 = __retval;
// LOWERING-DAG:             return {{__v[0-9]+}};
// LOWERING-DAG:         }
...
// LOWERING-DAG:     let {{__v[0-9]+}}: *mut i8 = b"bytes\0".as_ptr() as *mut i8;
// LOWERING-DAG:     let {{__v[0-9]+}}: *mut u8 = {{__v[0-9]+}} as *mut u8;
// LOWERING-DAG:     return {{__v[0-9]+}};
// LOWERING-DAG: }
// LOWERING-DAG: let {{__v[0-9]+}}: *mut i8 = b"%s %s %s\n\0".as_ptr() as *mut i8;
// LOWERING-DAG: let {{__v[0-9]+}}: i32 = 0;
// LOWERING-DAG: let {{__v[0-9]+}}: *mut i8 = mutable_pick({{__v[0-9]+}});
// LOWERING-DAG: let {{__v[0-9]+}}: i32 = 0;
// LOWERING-DAG: let {{__v[0-9]+}}: *mut i8 = const_pick({{__v[0-9]+}});
// LOWERING-DAG: let {{__v[0-9]+}}: *mut u8 = bytes_pick();
