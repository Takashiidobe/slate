...
// LOWERING-NEXT: }
// LOWERING-EMPTY:
// LOWERING-NEXT: fn ishl(arg0: i32, arg1: i32) -> i32 {
...
// LOWERING-NEXT:     let _v4: i32 = ishl(_v2, _v3);
...
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: fn ishl(arg0: i32, arg1: i32) -> i32 {
...
// REWRITES-NEXT: let _v4: i32 = ishl(_v2, _v3);
