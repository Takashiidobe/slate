...
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = ishl({{__v[0-9]+}}, {{__v[0-9]+}});
...
// COMMON-LOWERING-NEXT: }
// COMMON-LOWERING-EMPTY:
// COMMON-LOWERING-NEXT: fn ishl({{arg[0-9]+}}: i32, {{arg[0-9]+}}: i32) -> i32 {
...
// COMMON-REWRITES-NEXT: }
// COMMON-REWRITES-EMPTY:
// COMMON-REWRITES-NEXT: fn ishl({{arg[0-9]+}}: i32, {{arg[0-9]+}}: i32) -> i32 {
