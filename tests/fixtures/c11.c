...
// LOWERING-NEXT:     let mut anonymous: C11Anonymous = C11Anonymous { __slate_anon_0: {{anon_[0-9]+}} { integer: 0 }, __slate_anon_1: {{anon_[0-9]+}} { x: 0, y: 0 } };
// LOWERING-NEXT:     let mut aligned_object: aligned::Aligned<aligned::A32, C11OverAligned> = aligned::Aligned(C11OverAligned { value: 0 });
// LOWERING-NEXT:     let mut utf16_state: __mbstate_t = __mbstate_t { __count: 0, __value: {{anon_[0-9]+}} { __wch: 0 } };
// LOWERING-NEXT:     let mut utf32_state: __mbstate_t = __mbstate_t { __count: 0, __value: {{anon_[0-9]+}} { __wch: 0 } };
...
// LOWERING-NEXT:     anonymous = C11Anonymous { __slate_anon_0: {{anon_[0-9]+}} { integer: 0 }, __slate_anon_1: {{anon_[0-9]+}} { x: 0, y: 0 } };
// LOWERING-NEXT:     *aligned_object = C11OverAligned { value: 0 };
// LOWERING-NEXT:     utf16_state = __mbstate_t { __count: 0, __value: {{anon_[0-9]+}} { __wch: 0 } };
// LOWERING-NEXT:     utf32_state = __mbstate_t { __count: 0, __value: {{anon_[0-9]+}} { __wch: 0 } };
...
// REWRITES-NEXT: let {{_v[0-9]+}}: i32 = unsafe { std::sync::atomic::AtomicI32::from_ptr(std::ptr::addr_of_mut!(c11_atomic_total)).fetch_add({{_v[0-9]+}}, std::sync::atomic::Ordering::Relaxed) };
// REWRITES-NEXT: return;
// REWRITES-NEXT: }
// REWRITES-EMPTY:
...
// REWRITES-NEXT: let mut anonymous: C11Anonymous = C11Anonymous { __slate_anon_0: {{anon_[0-9]+}} { integer: 0 }, __slate_anon_1: {{anon_[0-9]+}} { x: 0, y: 0 } };
// REWRITES-NEXT: let mut aligned_object: aligned::Aligned<aligned::A32, C11OverAligned> = aligned::Aligned(C11OverAligned { value: 0 });
// REWRITES-NEXT: let mut utf16_state: __mbstate_t = __mbstate_t { __count: 0, __value: {{anon_[0-9]+}} { __wch: 0 } };
// REWRITES-NEXT: let mut utf32_state: __mbstate_t = __mbstate_t { __count: 0, __value: {{anon_[0-9]+}} { __wch: 0 } };
...
// REWRITES-NEXT: anonymous = C11Anonymous { __slate_anon_0: {{anon_[0-9]+}} { integer: 0 }, __slate_anon_1: {{anon_[0-9]+}} { x: 0, y: 0 } };
// REWRITES-NEXT: *aligned_object = C11OverAligned { value: 0 };
// REWRITES-NEXT: utf16_state = __mbstate_t { __count: 0, __value: {{anon_[0-9]+}} { __wch: 0 } };
// REWRITES-NEXT: utf32_state = __mbstate_t { __count: 0, __value: {{anon_[0-9]+}} { __wch: 0 } };
...
// REWRITES-NEXT:         if {{_v[0-9]+}} {
// REWRITES-NEXT:                     let {{_v[0-9]+}}: i32 = unsafe { fclose(exclusive_first as *mut libc::FILE) };
// REWRITES-NEXT:         }
// REWRITES-NEXT: }
// REWRITES-NEXT: {
// REWRITES-NEXT:         let {{_v[0-9]+}}: *mut libc::FILE = std::ptr::null_mut();
// REWRITES-NEXT:         let {{_v[0-9]+}}: bool = exclusive_second != {{_v[0-9]+}};
// REWRITES-NEXT:         if {{_v[0-9]+}} {
// REWRITES-NEXT:                     let {{_v[0-9]+}}: i32 = unsafe { fclose(exclusive_second as *mut libc::FILE) };
// REWRITES-NEXT:         }
// REWRITES-NEXT: }
// REWRITES-NEXT: let {{_v[0-9]+}}: *mut i8 = b"slate-c11-exclusive.tmp\0".as_ptr() as *mut i8;
// REWRITES-NEXT: let {{_v[0-9]+}}: i32 = unsafe { remove({{_v[0-9]+}} as *const i8) };
