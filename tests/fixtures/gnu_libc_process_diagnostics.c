...
// COMMON-LOWERING-NEXT: enum mcheck_status {
// COMMON-LOWERING-NEXT:     MCHECK_DISABLED = -1,
// COMMON-LOWERING-NEXT:     MCHECK_OK = 0,
// COMMON-LOWERING-NEXT:     MCHECK_HEAD = 1,
// COMMON-LOWERING-NEXT:     MCHECK_TAIL = 2,
// COMMON-LOWERING-NEXT:     MCHECK_FREE = 3,
// COMMON-LOWERING-NEXT: }
// COMMON-LOWERING-EMPTY:
// COMMON-LOWERING-NEXT: unsafe extern "C" {
// COMMON-LOWERING-NEXT:     static mut error_message_count: u32;
// COMMON-LOWERING-NEXT:     static mut error_one_per_line: i32;
// COMMON-LOWERING-NEXT:     fn on_exit(
// COMMON-LOWERING-NEXT:         _0: Option<unsafe extern "C-unwind" fn(i32, *mut core::ffi::c_void)>,
// COMMON-LOWERING-NEXT:         _1: *mut core::ffi::c_void,
// COMMON-LOWERING-NEXT:     ) -> i32;
// COMMON-LOWERING-NEXT:     fn mcheck(_0: Option<unsafe extern "C-unwind" fn(i32)>) -> i32;
// COMMON-LOWERING-NEXT:     fn malloc(_0: usize) -> *mut core::ffi::c_void;
// COMMON-LOWERING-NEXT:     fn mprobe(_0: *mut core::ffi::c_void) -> i32;
// COMMON-LOWERING-NEXT:     fn printf(_0: *const core::ffi::c_char, ...) -> i32;
// COMMON-LOWERING-NEXT:     fn free(_0: *mut core::ffi::c_void);
// COMMON-LOWERING-NEXT:     fn error(_0: i32, _1: i32, _2: *const core::ffi::c_char, ...);
// COMMON-LOWERING-NEXT:     fn error_at_line(
...
// COMMON-LOWERING-NEXT:         _4: *const core::ffi::c_char,
// COMMON-LOWERING-NEXT:         ...
// COMMON-LOWERING-NEXT:     );
// COMMON-LOWERING-NEXT: }
// COMMON-LOWERING-EMPTY:
// COMMON-LOWERING-NEXT: fn main() {
// COMMON-LOWERING-NEXT:     let mut captured: i32 = 0;
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = -1;
// COMMON-LOWERING-NEXT:     captured = {{__v[0-9]+}};
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: *mut core::ffi::c_void = std::ptr::addr_of_mut!(captured) as *mut core::ffi::c_void;
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { on_exit(Some(handle_exit), {{__v[0-9]+}} as *mut core::ffi::c_void) };
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: Option<unsafe extern "C-unwind" fn(i32)> = None;
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { mcheck({{__v[0-9]+}}) };
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
...
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { mprobe({{__v[0-9]+}} as *mut core::ffi::c_void) };
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = mcheck_status::MCHECK_OK as i32;
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} == {{__v[0-9]+}};
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} as i32;
...
// COMMON-LOWERING-NEXT:         error_one_per_line = {{__v[0-9]+}};
// COMMON-LOWERING-NEXT:     }
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// COMMON-LOWERING-NEXT:     unsafe {
// COMMON-LOWERING-NEXT:         error(
...
// COMMON-LOWERING-NEXT:         )
// COMMON-LOWERING-NEXT:     };
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: u32 = unsafe { error_message_count };
...
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: u32 = 42;
// COMMON-LOWERING-NEXT:     unsafe {
// COMMON-LOWERING-NEXT:         error_at_line(
// COMMON-LOWERING-NEXT:             {{__v[0-9]+}} as i32,
// COMMON-LOWERING-NEXT:             {{__v[0-9]+}} as i32,
// COMMON-LOWERING-NEXT:             {{__v[0-9]+}} as *const core::ffi::c_char,
...
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: u32 = 43;
// COMMON-LOWERING-NEXT:     unsafe {
// COMMON-LOWERING-NEXT:         error_at_line(
// COMMON-LOWERING-NEXT:             {{__v[0-9]+}} as i32,
// COMMON-LOWERING-NEXT:             {{__v[0-9]+}} as i32,
...
// COMMON-LOWERING-NEXT: }
// COMMON-LOWERING-EMPTY:
// COMMON-LOWERING-NEXT: extern "C-unwind" fn handle_exit({{arg[0-9]+}}: i32, {{arg[0-9]+}}: *mut core::ffi::c_void) {
...
// COMMON-REWRITES-NEXT: enum mcheck_status {
// COMMON-REWRITES-NEXT:     MCHECK_DISABLED = -1,
// COMMON-REWRITES-NEXT:     MCHECK_OK = 0,
// COMMON-REWRITES-NEXT:     MCHECK_HEAD = 1,
// COMMON-REWRITES-NEXT:     MCHECK_TAIL = 2,
// COMMON-REWRITES-NEXT:     MCHECK_FREE = 3,
// COMMON-REWRITES-NEXT: }
// COMMON-REWRITES-EMPTY:
// COMMON-REWRITES-NEXT: unsafe extern "C" {
// COMMON-REWRITES-NEXT:     static mut error_message_count: u32;
// COMMON-REWRITES-NEXT:     static mut error_one_per_line: i32;
// COMMON-REWRITES-NEXT:     fn on_exit(
// COMMON-REWRITES-NEXT:         _0: Option<unsafe extern "C-unwind" fn(i32, *mut core::ffi::c_void)>,
// COMMON-REWRITES-NEXT:         _1: *mut core::ffi::c_void,
// COMMON-REWRITES-NEXT:     ) -> i32;
// COMMON-REWRITES-NEXT:     fn mcheck(_0: Option<unsafe extern "C-unwind" fn(i32)>) -> i32;
// COMMON-REWRITES-NEXT:     fn malloc(_0: usize) -> *mut core::ffi::c_void;
// COMMON-REWRITES-NEXT:     fn mprobe(_0: *mut core::ffi::c_void) -> i32;
// COMMON-REWRITES-NEXT:     fn printf(_0: *const core::ffi::c_char, ...) -> i32;
// COMMON-REWRITES-NEXT:     fn free(_0: *mut core::ffi::c_void);
// COMMON-REWRITES-NEXT:     fn error(_0: i32, _1: i32, _2: *const core::ffi::c_char, ...);
// COMMON-REWRITES-NEXT:     fn error_at_line(
...
// COMMON-REWRITES-NEXT:         _4: *const core::ffi::c_char,
// COMMON-REWRITES-NEXT:         ...
// COMMON-REWRITES-NEXT:     );
// COMMON-REWRITES-NEXT: }
// COMMON-REWRITES-EMPTY:
// COMMON-REWRITES-NEXT: fn main() {
// COMMON-REWRITES-NEXT:     let mut captured: i32 = 0;
// COMMON-REWRITES-NEXT:     captured = -1;
// COMMON-REWRITES-NEXT:     let {{__v[0-9]+}}: *mut core::ffi::c_void = std::ptr::addr_of_mut!(captured) as *mut core::ffi::c_void;
// COMMON-REWRITES-NEXT:     unsafe { on_exit(Some(handle_exit), {{__v[0-9]+}} as *mut core::ffi::c_void) };
// COMMON-REWRITES-NEXT:     let {{__v[0-9]+}}: Option<unsafe extern "C-unwind" fn(i32)> = None;
// COMMON-REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { mcheck({{__v[0-9]+}}) };
// COMMON-REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = ({{__v[0-9]+}} == 0) as i32;
// COMMON-REWRITES-NEXT:     let {{__v[0-9]+}}: *mut core::ffi::c_void = unsafe { malloc((16 as u64) as usize) };
// COMMON-REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { mprobe({{__v[0-9]+}} as *mut core::ffi::c_void) };
// COMMON-REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = mcheck_status::MCHECK_OK as i32;
...
// COMMON-REWRITES-NEXT:     unsafe {
// COMMON-REWRITES-NEXT:         error_one_per_line = 0;
// COMMON-REWRITES-NEXT:     }
// COMMON-REWRITES-NEXT:     unsafe { error(0 as i32, 0 as i32, c"first message".as_ptr()) };
// COMMON-REWRITES-NEXT:     unsafe { error(0 as i32, 0 as i32, c"second message".as_ptr()) };
// COMMON-REWRITES-NEXT:     unsafe {
// COMMON-REWRITES-NEXT:         printf(c"count_after_two:%u\n".as_ptr(), unsafe {
// COMMON-REWRITES-NEXT:             error_message_count
// COMMON-REWRITES-NEXT:         })
// COMMON-REWRITES-NEXT:     };
// COMMON-REWRITES-NEXT:     unsafe {
// COMMON-REWRITES-NEXT:         error_one_per_line = 1;
// COMMON-REWRITES-NEXT:     }
// COMMON-REWRITES-NEXT:     unsafe {
// COMMON-REWRITES-NEXT:         error_at_line(
// COMMON-REWRITES-NEXT:             0 as i32,
// COMMON-REWRITES-NEXT:             0 as i32,
// COMMON-REWRITES-NEXT:             c"sample.c".as_ptr(),
// COMMON-REWRITES-NEXT:             42 as u32,
// COMMON-REWRITES-NEXT:             c"deduped message".as_ptr(),
// COMMON-REWRITES-NEXT:         )
// COMMON-REWRITES-NEXT:     };
// COMMON-REWRITES-NEXT:     unsafe {
// COMMON-REWRITES-NEXT:         error_at_line(
...
// COMMON-REWRITES-NEXT:     };
// COMMON-REWRITES-NEXT:     unsafe {
// COMMON-REWRITES-NEXT:         printf(c"count_after_dedup:%u\n".as_ptr(), unsafe {
// COMMON-REWRITES-NEXT:             error_message_count
// COMMON-REWRITES-NEXT:         })
// COMMON-REWRITES-NEXT:     };
// COMMON-REWRITES-NEXT:     unsafe {
...
// COMMON-REWRITES-NEXT:             0 as i32,
// COMMON-REWRITES-NEXT:             c"sample.c".as_ptr(),
// COMMON-REWRITES-NEXT:             43 as u32,
// COMMON-REWRITES-NEXT:             c"different line".as_ptr(),
// COMMON-REWRITES-NEXT:         )
// COMMON-REWRITES-NEXT:     };
// COMMON-REWRITES-NEXT:     unsafe {
// COMMON-REWRITES-NEXT:         printf(c"count_after_new_line:%u\n".as_ptr(), unsafe {
// COMMON-REWRITES-NEXT:             error_message_count
// COMMON-REWRITES-NEXT:         })
// COMMON-REWRITES-NEXT:     };
// COMMON-REWRITES-NEXT:     unsafe { error(5 as i32, 0 as i32, c"fatal message".as_ptr()) };
// COMMON-REWRITES-NEXT:     unsafe { printf(c"unreachable\n".as_ptr()) };
// COMMON-REWRITES-NEXT:     std::process::exit(0 as i32);
// COMMON-REWRITES-NEXT: }
// COMMON-REWRITES-EMPTY:
// COMMON-REWRITES-NEXT: extern "C-unwind" fn handle_exit({{arg[0-9]+}}: i32, {{arg[0-9]+}}: *mut core::ffi::c_void) {
// COMMON-REWRITES-NEXT:     unsafe {
// COMMON-REWRITES-NEXT:         *({{arg[0-9]+}} as *mut i32) = {{arg[0-9]+}};
// COMMON-REWRITES-NEXT:     }
// COMMON-REWRITES-NEXT:     unsafe { printf(c"on_exit:%d\n".as_ptr(), {{arg[0-9]+}}) };
