...
// COMMON-REWRITES-NEXT:             c"%f %.2f %.0f\n".as_ptr(),
// COMMON-REWRITES-NEXT:             (1.5 + (0.5 as f32)) as f64,
// COMMON-REWRITES-NEXT:             2.25 * (2.0 as f64),
// COMMON-REWRITES-NEXT:             3.0 as f64,
// COMMON-REWRITES-NEXT:         )
// COMMON-REWRITES-NEXT:     };
// COMMON-REWRITES-NEXT:     unsafe { printf(c"tail %.3f".as_ptr(), 1.25 as f64) };
