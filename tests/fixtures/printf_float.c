...
// LOWERING-X86_64-GNU-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"%f %.2f %.0f\n\0".as_ptr() as *mut i8;
// LOWERING-AARCH64-GNU-NEXT:     let {{__v[0-9]+}}: *mut u8 = b"%f %.2f %.0f\n\0".as_ptr() as *mut u8;
...
// LOWERING-X86_64-GNU-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"tail %.3f\0".as_ptr() as *mut i8;
// LOWERING-AARCH64-GNU-NEXT:     let {{__v[0-9]+}}: *mut u8 = b"tail %.3f\0".as_ptr() as *mut u8;
...
// REWRITES-NEXT:             (1.5 + (0.5 as f32)) as f64,
// REWRITES-NEXT:             2.25 * (2.0 as f64),
