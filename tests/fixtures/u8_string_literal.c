...
// LOWERING-NEXT:     let mut alignment: i32 = 0;
// LOWERING-NEXT:     let mut repeated: i32 = 0;
// LOWERING-NEXT:     let {{_v[0-9]+}}: i32 = 0;
// LOWERING-NEXT:     __retval = {{_v[0-9]+}};
// LOWERING-NEXT:     let {{_v[0-9]+}}: i32 = 4;
// LOWERING-NEXT:     alignment = {{_v[0-9]+}};
...
// LOWERING-NEXT:     let {{_v[0-9]+}}: i32 = alignment;
// LOWERING-NEXT:     let {{_v[0-9]+}}: i32 = repeated;
