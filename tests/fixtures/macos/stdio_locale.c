...
// LOWERING-MACOS-NEXT:     _close: Option<unsafe extern "C" fn(*mut core::ffi::c_void) -> i32>,
// LOWERING-MACOS-NEXT:     _read: Option<unsafe extern "C" fn(*mut core::ffi::c_void, *mut i8, i32) -> i32>,
// LOWERING-MACOS-NEXT:     _seek: Option<unsafe extern "C" fn(*mut core::ffi::c_void, i64, i32) -> i64>,
// LOWERING-MACOS-NEXT:     _write: Option<unsafe extern "C" fn(*mut core::ffi::c_void, *mut i8, i32) -> i32>,
