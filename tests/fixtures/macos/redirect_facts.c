...
// LOWERING-MACOS-DAG: let {{_v[0-9]+}}: *mut __sFILE = unsafe { __fopen_DARWIN_EXTSN({{arg[0-9]+}} as *mut i8, {{_v[0-9]+}} as *mut i8) };
// LOWERING-MACOS-DAG: return {{_v[0-9]+}};
// LOWERING-MACOS-DAG: }
// LOWERING-MACOS-DAG: fn darwin_errno() -> i32 {
// LOWERING-MACOS-DAG: let {{_v[0-9]+}}: *mut i32 = unsafe { __error() };
// LOWERING-MACOS-DAG: let {{_v[0-9]+}}: i32 = unsafe { *{{_v[0-9]+}} };
// LOWERING-MACOS-DAG: return {{_v[0-9]+}};
// LOWERING-MACOS-DAG: }
// LOWERING-MACOS-DAG: fn darwin_stdin() -> *mut __sFILE {
// LOWERING-MACOS-DAG: let {{_v[0-9]+}}: *mut __sFILE = unsafe { __stdinp };
// LOWERING-MACOS-DAG: return {{_v[0-9]+}};
// LOWERING-MACOS-DAG: }
