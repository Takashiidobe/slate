...
// LOWERING-NEXT:         let {{_v[0-9]+}}: *mut i8 = b"{{.*}}tests/fixtures/assert_runtime_true.c\0"
...
// REWRITES-NEXT:                 c"argc == 1".as_ptr(),
// REWRITES-NEXT:                 c"{{.*}}tests/fixtures/assert_runtime_true.c".as_ptr(),
