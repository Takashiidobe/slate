...
// LOWERING-X86_64-GNU-NEXT: }
// LOWERING-X86_64-GNU-EMPTY:
// LOWERING-X86_64-GNU-NEXT: static mut global_pi: LongDouble = LongDouble([53, 194, 104, 33, 162, 218, 15, 201, 0, 64]);
// LOWERING-AARCH64-GNU-NEXT: static mut global_pi: f128 = 3.14159265358979323846264338327900013f128;
// LOWERING-EMPTY:
...
// LOWERING-AARCH64-GNU-NEXT:     let {{__v[0-9]+}}: f128 = 3.14159265358979323846264338327900013f128;
// LOWERING-AARCH64-GNU-NEXT:     let {{__v[0-9]+}}: *mut u8 = b"local\0".as_ptr() as *mut u8;
// LOWERING-NEXT:     dump80({{__v[0-9]+}}, {{__v[0-9]+}});
// LOWERING-X86_64-GNU-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"global\0".as_ptr() as *mut i8;
// LOWERING-X86_64-GNU-NEXT:     let {{__v[0-9]+}}: LongDouble = unsafe { global_pi };
// LOWERING-AARCH64-GNU-NEXT:     let {{__v[0-9]+}}: *mut u8 = b"global\0".as_ptr() as *mut u8;
// LOWERING-AARCH64-GNU-NEXT:     let {{__v[0-9]+}}: f128 = unsafe { global_pi };
// LOWERING-NEXT:     dump80({{__v[0-9]+}}, {{__v[0-9]+}});
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
...
// REWRITES-X86_64-GNU-NEXT: }
// REWRITES-X86_64-GNU-EMPTY:
// REWRITES-X86_64-GNU-NEXT: static mut global_pi: LongDouble = LongDouble([53, 194, 104, 33, 162, 218, 15, 201, 0, 64]);
// REWRITES-AARCH64-GNU-NEXT: static mut global_pi: f128 = 3.14159265358979323846264338327900013f128;
// REWRITES-EMPTY:
...
// REWRITES-X86_64-GNU-NEXT:     dump80(c"global".as_ptr() as *mut i8, unsafe { global_pi });
// REWRITES-AARCH64-GNU-NEXT:     let {{__v[0-9]+}}: f128 = 3.14159265358979323846264338327900013f128;
// REWRITES-AARCH64-GNU-NEXT:     dump80(c"local".as_ptr() as *mut u8, {{__v[0-9]+}});
// REWRITES-AARCH64-GNU-NEXT:     dump80(c"global".as_ptr() as *mut u8, unsafe { global_pi });
