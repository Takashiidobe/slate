...
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i64 = 9000000000000i64;
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: u64 = 18000000000000u64;
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i64 = 1;
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i64 = lladd({{__v[0-9]+}}, {{__v[0-9]+}});
...
// COMMON-LOWERING-NEXT: }
// COMMON-LOWERING-EMPTY:
// COMMON-LOWERING-NEXT: fn lladd({{arg[0-9]+}}: i64, {{arg[0-9]+}}: i64) -> i64 {
...
// COMMON-REWRITES-NEXT:     let {{__v[0-9]+}}: i64 = 9000000000000i64;
// COMMON-REWRITES-NEXT:     let {{__v[0-9]+}}: u64 = 18000000000000u64;
// COMMON-REWRITES-NEXT:     unsafe { printf(c"%lld\n".as_ptr(), lladd({{__v[0-9]+}}, 1)) };
// COMMON-REWRITES-NEXT:     unsafe { printf(c"%llu\n".as_ptr(), {{__v[0-9]+}}) };
// COMMON-REWRITES-NEXT:     std::process::exit(0 as i32);
// COMMON-REWRITES-NEXT: }
// COMMON-REWRITES-EMPTY:
// COMMON-REWRITES-NEXT: fn lladd({{arg[0-9]+}}: i64, {{arg[0-9]+}}: i64) -> i64 {
