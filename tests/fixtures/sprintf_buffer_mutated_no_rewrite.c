...
// LOWERING-NEXT:     let _v6: i8 = 88;
// LOWERING-NEXT:     let _v7: i64 = 0;
// LOWERING-NEXT:     buf[(_v7 as usize)] = _v6;
// LOWERING-NEXT:     let _v8: *mut i8 = buf.as_mut_ptr() as *mut i8;
// LOWERING-NEXT:     let _v9: i32 = unsafe { puts(_v8 as *const i8) };
...
// REWRITES-NEXT: buf[(_v7 as usize)] = 88;
// REWRITES-NEXT: let _v8: *mut i8 = buf.as_mut_ptr() as *mut i8;
// REWRITES-NEXT: let _v9: i32 = unsafe { puts(_v8 as *const i8) };
// REWRITES-NEXT: __retval = 0;
