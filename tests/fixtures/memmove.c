...
// REWRITES-DAG:         print!("{} ", forward_buf[((i as i64) as usize)] as i32);
// REWRITES-DAG:         let _ = std::io::Write::flush(&mut std::io::stdout());
// REWRITES-DAG:         i += 1;
// REWRITES-DAG:     }
// REWRITES-DAG:     let mut i2: i32 = 0;
// REWRITES-DAG:     while i2 < 8 {
// REWRITES-DAG:         print!("{} ", backward_buf[((i2 as i64) as usize)] as i32);
// REWRITES-DAG:         let _ = std::io::Write::flush(&mut std::io::stdout());
// REWRITES-DAG:         i2 += 1;
// REWRITES-DAG:     }
// REWRITES-DAG:     let mut i3: i32 = 0;
// REWRITES-DAG:     while i3 < 8 {
// REWRITES-DAG:         print!("{} ", dyn_buf[((i3 as i64) as usize)] as i32);
// REWRITES-DAG:         let _ = std::io::Write::flush(&mut std::io::stdout());
// REWRITES-DAG:         i3 += 1;
// REWRITES-DAG:     }
