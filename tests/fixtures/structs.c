...
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = sum_pair({{__v[0-9]+}}, {{__v[0-9]+}});
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { printf({{__v[0-9]+}} as *const core::ffi::c_char, {{__v[0-9]+}}) };
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 3;
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 8;
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = overwrite_left({{__v[0-9]+}}, {{__v[0-9]+}});
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { printf({{__v[0-9]+}} as *const core::ffi::c_char, {{__v[0-9]+}}) };
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// COMMON-LOWERING-NEXT:     std::process::exit({{__v[0-9]+}} as i32);
// COMMON-LOWERING-NEXT: }
// COMMON-LOWERING-EMPTY:
// COMMON-LOWERING-NEXT: fn sum_pair({{arg[0-9]+}}: i32, {{arg[0-9]+}}: i32) -> i32 {
...
// COMMON-LOWERING-NEXT: }
// COMMON-LOWERING-EMPTY:
// COMMON-LOWERING-NEXT: fn overwrite_left({{arg[0-9]+}}: i32, {{arg[0-9]+}}: i32) -> i32 {
// COMMON-LOWERING-NEXT:     let mut p: Pair = Pair { left: 0, right: 0 };
// COMMON-LOWERING-NEXT:     p.left = {{arg[0-9]+}};
// COMMON-LOWERING-NEXT:     p.right = {{arg[0-9]+}};
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = p.right;
...
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} + {{__v[0-9]+}};
// COMMON-LOWERING-NEXT:     p.left = {{__v[0-9]+}};
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = p.left;
// COMMON-LOWERING-NEXT:     return {{__v[0-9]+}};
// COMMON-LOWERING-NEXT: }
...
// COMMON-REWRITES-NEXT: }
// COMMON-REWRITES-EMPTY:
// COMMON-REWRITES-NEXT: fn sum_pair({{arg[0-9]+}}: i32, {{arg[0-9]+}}: i32) -> i32 {
// COMMON-REWRITES-NEXT:     let mut p: Pair = Pair { left: 0, right: 0 };
// COMMON-REWRITES-NEXT:     p.left = {{arg[0-9]+}};
// COMMON-REWRITES-NEXT:     p.right = {{arg[0-9]+}};
// COMMON-REWRITES-NEXT:     p.left + p.right
// COMMON-REWRITES-NEXT: }
// COMMON-REWRITES-EMPTY:
// COMMON-REWRITES-NEXT: fn overwrite_left({{arg[0-9]+}}: i32, {{arg[0-9]+}}: i32) -> i32 {
// COMMON-REWRITES-NEXT:     let mut p: Pair = Pair { left: 0, right: 0 };
// COMMON-REWRITES-NEXT:     p.left = {{arg[0-9]+}};
// COMMON-REWRITES-NEXT:     p.right = {{arg[0-9]+}};
// COMMON-REWRITES-NEXT:     p.left = p.right + 2;
// COMMON-REWRITES-NEXT:     p.left
// COMMON-REWRITES-NEXT: }
