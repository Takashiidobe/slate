...
// LOWERING-NEXT:     end = {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: u64 = 1;
// LOWERING-NEXT:     unsafe { std::ptr::write_volatile(std::ptr::addr_of_mut!(count), {{__v[0-9]+}}) };
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 1;
// LOWERING-NEXT:     unsafe { std::ptr::write_volatile(std::ptr::addr_of_mut!(number), {{__v[0-9]+}}) };
// LOWERING-NEXT:     let {{__v[0-9]+}}: f64 = 1.0;
// LOWERING-NEXT:     unsafe { std::ptr::write_volatile(std::ptr::addr_of_mut!(real), {{__v[0-9]+}}) };
// LOWERING-NEXT:     let {{__v[0-9]+}}: u64 = 1;
// LOWERING-NEXT:     thread = {{__v[0-9]+}};
...
// LOWERING-NEXT:         )
// LOWERING-NEXT:     };
// LOWERING-NEXT:     let {{__v[0-9]+}}: u64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(count)) };
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut core::ffi::c_void = malloc({{__v[0-9]+}});
// LOWERING-NEXT:     ptr = {{__v[0-9]+}};
// LOWERING-NEXT:     {
// LOWERING-NEXT:         loop {
// LOWERING-NEXT:             {
// LOWERING-NEXT:                 {
// LOWERING-NEXT:                     let {{__v[0-9]+}}: *mut core::ffi::c_void = ptr;
...
// LOWERING-NEXT:                     let {{__v[0-9]+}}: u64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(count)) };
// LOWERING-NEXT:                     let {{__v[0-9]+}}: u64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(count)) };
// LOWERING-NEXT:                     let {{__v[0-9]+}}: *mut core::ffi::c_void = calloc({{__v[0-9]+}}, {{__v[0-9]+}});
// LOWERING-NEXT:                     let {{__v[0-9]+}}: u64 = 16;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: *mut core::ffi::c_void = {{__v[0-9]+}} as *mut core::ffi::c_void;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
...
// LOWERING-NEXT:                         realloc({{__v[0-9]+}} as *mut core::ffi::c_void, {{__v[0-9]+}});
// LOWERING-NEXT:                     let {{__v[0-9]+}}: u64 = 16;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: *mut core::ffi::c_void = {{__v[0-9]+}} as *mut core::ffi::c_void;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
...
// LOWERING-NEXT:     }
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut core::ffi::c_void = ptr;
// LOWERING-NEXT:     free({{__v[0-9]+}} as *mut core::ffi::c_void);
// LOWERING-NEXT:     {
// LOWERING-NEXT:         loop {
// LOWERING-NEXT:             {
// LOWERING-NEXT:                 {
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i32 = unsafe { project_state };
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i32 = 77;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
...
// LOWERING-NEXT:                     let {{__v[0-9]+}}: *mut core::ffi::c_void = {{__v[0-9]+}} as *mut core::ffi::c_void;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: u64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(count)) };
// LOWERING-NEXT:                     let {{__v[0-9]+}}: *mut core::ffi::c_void = memcpy(
...
// LOWERING-NEXT:                     let {{__v[0-9]+}}: *mut core::ffi::c_void = {{__v[0-9]+}} as *mut core::ffi::c_void;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: u64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(count)) };
// LOWERING-NEXT:                     let {{__v[0-9]+}}: *mut core::ffi::c_void = memmove(
// LOWERING-NEXT:                         {{__v[0-9]+}} as *mut core::ffi::c_void,
// LOWERING-NEXT:                         {{__v[0-9]+}} as *mut core::ffi::c_void,
// LOWERING-NEXT:                         {{__v[0-9]+}},
// LOWERING-NEXT:                     );
...
// LOWERING-AARCH64-GNU-NEXT:                     let {{__v[0-9]+}}: *mut u8 = a.as_mut_ptr() as *mut u8;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: *mut core::ffi::c_void = {{__v[0-9]+}} as *mut core::ffi::c_void;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i32 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(number)) };
// LOWERING-NEXT:                     let {{__v[0-9]+}}: u64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(count)) };
// LOWERING-NEXT:                     let {{__v[0-9]+}}: *mut core::ffi::c_void =
// LOWERING-NEXT:                         memset({{__v[0-9]+}} as *mut core::ffi::c_void, {{__v[0-9]+}}, {{__v[0-9]+}});
// LOWERING-X86_64-GNU-NEXT:                     let {{__v[0-9]+}}: *mut i8 = a.as_mut_ptr() as *mut i8;
// LOWERING-AARCH64-GNU-NEXT:                     let {{__v[0-9]+}}: *mut u8 = a.as_mut_ptr() as *mut u8;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: *mut core::ffi::c_void = {{__v[0-9]+}} as *mut core::ffi::c_void;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
...
// LOWERING-NEXT:                     let {{__v[0-9]+}}: u64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(count)) };
// LOWERING-NEXT:                     let {{__v[0-9]+}}: *mut core::ffi::c_void =
// LOWERING-NEXT:                         memchr({{__v[0-9]+}} as *mut core::ffi::c_void, {{__v[0-9]+}}, {{__v[0-9]+}});
...
// LOWERING-X86_64-GNU-NEXT:                     let {{__v[0-9]+}}: *mut i8 = a.as_mut_ptr() as *mut i8;
// LOWERING-AARCH64-GNU-NEXT:                     let {{__v[0-9]+}}: *mut u8 = a.as_mut_ptr() as *mut u8;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: u64 = strlen({{__v[0-9]+}});
...
// LOWERING-AARCH64-GNU-NEXT:                     let {{__v[0-9]+}}: *mut u8 = a.as_mut_ptr() as *mut u8;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: u64 = unsafe { {{__v[0-9]+}}.unwrap()({{__v[0-9]+}}) };
// LOWERING-NEXT:                     let {{__v[0-9]+}}: u64 = 5;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = 10;
...
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = 14;
// LOWERING-NEXT:                         __retval = {{__v[0-9]+}};
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = __retval;
// LOWERING-NEXT:                         std::process::exit({{__v[0-9]+}} as i32);
// LOWERING-NEXT:                     }
...
// LOWERING-AARCH64-GNU-NEXT:                     let {{__v[0-9]+}}: *mut u8 = a.as_mut_ptr() as *mut u8;
// LOWERING-AARCH64-GNU-NEXT:                     let {{__v[0-9]+}}: *mut u8 = b.as_mut_ptr() as *mut u8;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i32 = strcmp({{__v[0-9]+}}, {{__v[0-9]+}});
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i32 = 11;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
...
// LOWERING-AARCH64-GNU-NEXT:                     let {{__v[0-9]+}}: *mut u8 = b.as_mut_ptr() as *mut u8;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: u64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(count)) };
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i32 = strncmp({{__v[0-9]+}}, {{__v[0-9]+}}, {{__v[0-9]+}});
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i32 = 12;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
...
// LOWERING-NEXT:                     let {{__v[0-9]+}}: *mut core::ffi::c_void = {{__v[0-9]+}} as *mut core::ffi::c_void;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: u64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(count)) };
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i32 = memcmp(
// LOWERING-NEXT:                         {{__v[0-9]+}} as *mut core::ffi::c_void,
// LOWERING-NEXT:                         {{__v[0-9]+}} as *mut core::ffi::c_void,
// LOWERING-NEXT:                         {{__v[0-9]+}},
// LOWERING-NEXT:                     );
...
// LOWERING-NEXT:                         unsafe { std::ptr::read_volatile(std::ptr::addr_of!(number)) };
...
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = 21;
// LOWERING-NEXT:                         __retval = {{__v[0-9]+}};
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = __retval;
// LOWERING-NEXT:                         std::process::exit({{__v[0-9]+}} as i32);
// LOWERING-NEXT:                     }
...
// LOWERING-AARCH64-GNU-NEXT:                     let {{__v[0-9]+}}: *mut u8 = a.as_mut_ptr() as *mut u8;
// LOWERING-AARCH64-GNU-NEXT:                     let {{__v[0-9]+}}: *mut u8 = b.as_mut_ptr() as *mut u8;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: u64 = strspn({{__v[0-9]+}}, {{__v[0-9]+}});
// LOWERING-NEXT:                     let {{__v[0-9]+}}: u64 = 31;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = 22;
// LOWERING-NEXT:                         __retval = {{__v[0-9]+}};
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = __retval;
// LOWERING-NEXT:                         std::process::exit({{__v[0-9]+}} as i32);
// LOWERING-NEXT:                     }
...
// LOWERING-AARCH64-GNU-NEXT:                     let {{__v[0-9]+}}: *mut u8 = a.as_mut_ptr() as *mut u8;
// LOWERING-AARCH64-GNU-NEXT:                     let {{__v[0-9]+}}: *mut u8 = b.as_mut_ptr() as *mut u8;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: u64 = strcspn({{__v[0-9]+}}, {{__v[0-9]+}});
// LOWERING-NEXT:                     let {{__v[0-9]+}}: u64 = 32;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
...
// LOWERING-X86_64-GNU-NEXT:                     let {{__v[0-9]+}}: *mut i8 = a.as_mut_ptr() as *mut i8;
// LOWERING-AARCH64-GNU-NEXT:                     let {{__v[0-9]+}}: *mut u8 = a.as_mut_ptr() as *mut u8;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i32 = atoi({{__v[0-9]+}});
...
// LOWERING-X86_64-GNU-NEXT:                     let {{__v[0-9]+}}: *mut i8 = a.as_mut_ptr() as *mut i8;
// LOWERING-AARCH64-GNU-NEXT:                     let {{__v[0-9]+}}: *mut u8 = a.as_mut_ptr() as *mut u8;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i64 = atol({{__v[0-9]+}});
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i64 = 42;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = 25;
// LOWERING-NEXT:                         __retval = {{__v[0-9]+}};
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = __retval;
// LOWERING-NEXT:                         std::process::exit({{__v[0-9]+}} as i32);
// LOWERING-NEXT:                     }
...
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i32 =
// LOWERING-NEXT:                         unsafe { std::ptr::read_volatile(std::ptr::addr_of!(number)) };
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i64 = strtol({{__v[0-9]+}}, std::ptr::addr_of_mut!(end), {{__v[0-9]+}});
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i64 = 43;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = 26;
// LOWERING-NEXT:                         __retval = {{__v[0-9]+}};
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = __retval;
// LOWERING-NEXT:                         std::process::exit({{__v[0-9]+}} as i32);
// LOWERING-NEXT:                     }
...
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i32 =
// LOWERING-NEXT:                         unsafe { std::ptr::read_volatile(std::ptr::addr_of!(number)) };
// LOWERING-NEXT:                     let {{__v[0-9]+}}: u64 = strtoul({{__v[0-9]+}}, std::ptr::addr_of_mut!(end), {{__v[0-9]+}});
// LOWERING-NEXT:                     let {{__v[0-9]+}}: u64 = 44;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = 27;
// LOWERING-NEXT:                         __retval = {{__v[0-9]+}};
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = __retval;
// LOWERING-NEXT:                         std::process::exit({{__v[0-9]+}} as i32);
// LOWERING-NEXT:                     }
...
// LOWERING-X86_64-GNU-NEXT:                     let {{__v[0-9]+}}: *mut i8 = a.as_mut_ptr() as *mut i8;
// LOWERING-AARCH64-GNU-NEXT:                     let {{__v[0-9]+}}: *mut u8 = a.as_mut_ptr() as *mut u8;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: f64 = strtod({{__v[0-9]+}}, std::ptr::addr_of_mut!(end));
// LOWERING-NEXT:                     let {{__v[0-9]+}}: f64 = 45.0;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = 28;
// LOWERING-NEXT:                         __retval = {{__v[0-9]+}};
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = __retval;
// LOWERING-NEXT:                         std::process::exit({{__v[0-9]+}} as i32);
// LOWERING-NEXT:                     }
...
// LOWERING-X86_64-GNU-NEXT:                     let {{__v[0-9]+}}: *mut i8 = a.as_mut_ptr() as *mut i8;
// LOWERING-AARCH64-GNU-NEXT:                     let {{__v[0-9]+}}: *mut u8 = a.as_mut_ptr() as *mut u8;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i32 = printf({{__v[0-9]+}});
...
// LOWERING-X86_64-GNU-NEXT:                     let {{__v[0-9]+}}: *mut i8 = a.as_mut_ptr() as *mut i8;
// LOWERING-AARCH64-GNU-NEXT:                     let {{__v[0-9]+}}: *mut u8 = a.as_mut_ptr() as *mut u8;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i32 = puts({{__v[0-9]+}});
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i32 = 52;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
...
// LOWERING-AARCH64-GNU-NEXT:     let {{__v[0-9]+}}: *mut u8 = a.as_mut_ptr() as *mut u8;
// LOWERING-AARCH64-GNU-NEXT:     let {{__v[0-9]+}}: *mut u8 = b.as_mut_ptr() as *mut u8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut core::ffi::c_void = fopen({{__v[0-9]+}}, {{__v[0-9]+}});
// LOWERING-NEXT:     stream = {{__v[0-9]+}};
// LOWERING-NEXT:     {
// LOWERING-NEXT:         loop {
// LOWERING-NEXT:             {
// LOWERING-NEXT:                 {
// LOWERING-NEXT:                     let {{__v[0-9]+}}: *mut core::ffi::c_void = stream;
...
// LOWERING-AARCH64-GNU-NEXT:                     let {{__v[0-9]+}}: *mut u8 = a.as_mut_ptr() as *mut u8;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: *mut core::ffi::c_void = stream;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i32 = fputs({{__v[0-9]+}}, {{__v[0-9]+}} as *mut core::ffi::c_void);
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i32 = 54;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
...
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = 33;
// LOWERING-NEXT:                         __retval = {{__v[0-9]+}};
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = __retval;
// LOWERING-NEXT:                         std::process::exit({{__v[0-9]+}} as i32);
// LOWERING-NEXT:                     }
...
// LOWERING-NEXT:                     let {{__v[0-9]+}}: u64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(count)) };
// LOWERING-NEXT:                     let {{__v[0-9]+}}: *mut core::ffi::c_void = stream;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: u64 = fread(
// LOWERING-NEXT:                         {{__v[0-9]+}} as *mut core::ffi::c_void,
// LOWERING-NEXT:                         {{__v[0-9]+}},
// LOWERING-NEXT:                         {{__v[0-9]+}},
// LOWERING-NEXT:                         {{__v[0-9]+}} as *mut core::ffi::c_void,
// LOWERING-NEXT:                     );
// LOWERING-NEXT:                     let {{__v[0-9]+}}: u64 = 56;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = 34;
// LOWERING-NEXT:                         __retval = {{__v[0-9]+}};
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = __retval;
// LOWERING-NEXT:                         std::process::exit({{__v[0-9]+}} as i32);
// LOWERING-NEXT:                     }
...
// LOWERING-NEXT:                     let {{__v[0-9]+}}: u64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(count)) };
// LOWERING-NEXT:                     let {{__v[0-9]+}}: *mut core::ffi::c_void = stream;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: u64 = fwrite(
// LOWERING-NEXT:                         {{__v[0-9]+}} as *mut core::ffi::c_void,
// LOWERING-NEXT:                         {{__v[0-9]+}},
// LOWERING-NEXT:                         {{__v[0-9]+}},
// LOWERING-NEXT:                         {{__v[0-9]+}} as *mut core::ffi::c_void,
// LOWERING-NEXT:                     );
// LOWERING-NEXT:                     let {{__v[0-9]+}}: u64 = 57;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
...
// LOWERING-NEXT:                 {
// LOWERING-NEXT:                     let {{__v[0-9]+}}: *mut core::ffi::c_void = stream;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i32 = fclose({{__v[0-9]+}} as *mut core::ffi::c_void);
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i32 = 58;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = 36;
// LOWERING-NEXT:                         __retval = {{__v[0-9]+}};
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = __retval;
// LOWERING-NEXT:                         std::process::exit({{__v[0-9]+}} as i32);
// LOWERING-NEXT:                     }
...
// LOWERING-NEXT:                 {
// LOWERING-NEXT:                     let {{__v[0-9]+}}: *mut core::ffi::c_void = stream;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i32 = fflush({{__v[0-9]+}} as *mut core::ffi::c_void);
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i32 = 59;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
...
// LOWERING-X86_64-GNU-NEXT:                     let {{__v[0-9]+}}: *mut i8 = a.as_mut_ptr() as *mut i8;
// LOWERING-AARCH64-GNU-NEXT:                     let {{__v[0-9]+}}: *mut u8 = a.as_mut_ptr() as *mut u8;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i32 = remove({{__v[0-9]+}});
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i32 = 60;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = 38;
// LOWERING-NEXT:                         __retval = {{__v[0-9]+}};
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = __retval;
// LOWERING-NEXT:                         std::process::exit({{__v[0-9]+}} as i32);
// LOWERING-NEXT:                     }
...
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i32 =
// LOWERING-NEXT:                         unsafe { std::ptr::read_volatile(std::ptr::addr_of!(number)) };
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i32 = toupper({{__v[0-9]+}});
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i32 = 61;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = 39;
// LOWERING-NEXT:                         __retval = {{__v[0-9]+}};
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = __retval;
// LOWERING-NEXT:                         std::process::exit({{__v[0-9]+}} as i32);
// LOWERING-NEXT:                     }
...
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i32 =
// LOWERING-NEXT:                         unsafe { std::ptr::read_volatile(std::ptr::addr_of!(number)) };
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i32 = tolower({{__v[0-9]+}});
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i32 = 62;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
...
// LOWERING-NEXT:                     let {{__v[0-9]+}}: f64 = sin({{__v[0-9]+}});
// LOWERING-NEXT:                     let {{__v[0-9]+}}: f64 = 63.0;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = 41;
// LOWERING-NEXT:                         __retval = {{__v[0-9]+}};
...
// LOWERING-NEXT:                 {
// LOWERING-NEXT:                     let {{__v[0-9]+}}: f64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(real)) };
// LOWERING-NEXT:                     let {{__v[0-9]+}}: f64 = cos({{__v[0-9]+}});
// LOWERING-NEXT:                     let {{__v[0-9]+}}: f64 = 64.0;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
...
// LOWERING-NEXT:                 {
// LOWERING-NEXT:                     let {{__v[0-9]+}}: f64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(real)) };
// LOWERING-NEXT:                     let {{__v[0-9]+}}: f64 = tan({{__v[0-9]+}});
// LOWERING-NEXT:                     let {{__v[0-9]+}}: f64 = 65.0;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = 43;
// LOWERING-NEXT:                         __retval = {{__v[0-9]+}};
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = __retval;
// LOWERING-NEXT:                         std::process::exit({{__v[0-9]+}} as i32);
// LOWERING-NEXT:                     }
...
// LOWERING-NEXT:                 {
// LOWERING-NEXT:                     let {{__v[0-9]+}}: f64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(real)) };
// LOWERING-NEXT:                     let {{__v[0-9]+}}: f64 = log({{__v[0-9]+}});
// LOWERING-NEXT:                     let {{__v[0-9]+}}: f64 = 66.0;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = 44;
// LOWERING-NEXT:                         __retval = {{__v[0-9]+}};
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = __retval;
// LOWERING-NEXT:                         std::process::exit({{__v[0-9]+}} as i32);
// LOWERING-NEXT:                     }
...
// LOWERING-NEXT:                 {
// LOWERING-NEXT:                     let {{__v[0-9]+}}: f64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(real)) };
// LOWERING-NEXT:                     let {{__v[0-9]+}}: f64 = log10({{__v[0-9]+}});
// LOWERING-NEXT:                     let {{__v[0-9]+}}: f64 = 67.0;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = 45;
// LOWERING-NEXT:                         __retval = {{__v[0-9]+}};
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = __retval;
// LOWERING-NEXT:                         std::process::exit({{__v[0-9]+}} as i32);
// LOWERING-NEXT:                     }
...
// LOWERING-NEXT:                 {
// LOWERING-NEXT:                     let {{__v[0-9]+}}: f64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(real)) };
// LOWERING-NEXT:                     let {{__v[0-9]+}}: f64 = log2({{__v[0-9]+}});
// LOWERING-NEXT:                     let {{__v[0-9]+}}: f64 = 68.0;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = 46;
// LOWERING-NEXT:                         __retval = {{__v[0-9]+}};
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = __retval;
// LOWERING-NEXT:                         std::process::exit({{__v[0-9]+}} as i32);
// LOWERING-NEXT:                     }
...
// LOWERING-NEXT:                     let {{__v[0-9]+}}: f64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(real)) };
// LOWERING-NEXT:                     let {{__v[0-9]+}}: f64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(real)) };
// LOWERING-NEXT:                     let {{__v[0-9]+}}: f64 = pow({{__v[0-9]+}}, {{__v[0-9]+}});
// LOWERING-NEXT:                     let {{__v[0-9]+}}: f64 = 69.0;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
...
// LOWERING-NEXT:                 {
// LOWERING-NEXT:                     let {{__v[0-9]+}}: f64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(real)) };
// LOWERING-NEXT:                     let {{__v[0-9]+}}: f64 = sqrt({{__v[0-9]+}});
// LOWERING-NEXT:                     let {{__v[0-9]+}}: f64 = 70.0;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = 48;
// LOWERING-NEXT:                         __retval = {{__v[0-9]+}};
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = __retval;
// LOWERING-NEXT:                         std::process::exit({{__v[0-9]+}} as i32);
// LOWERING-NEXT:                     }
...
// LOWERING-NEXT:                 {
// LOWERING-NEXT:                     let {{__v[0-9]+}}: f64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(real)) };
// LOWERING-NEXT:                     let {{__v[0-9]+}}: f64 = exp({{__v[0-9]+}});
// LOWERING-NEXT:                     let {{__v[0-9]+}}: f64 = 71.0;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = 49;
// LOWERING-NEXT:                         __retval = {{__v[0-9]+}};
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = __retval;
// LOWERING-NEXT:                         std::process::exit({{__v[0-9]+}} as i32);
// LOWERING-NEXT:                     }
...
// LOWERING-NEXT:                 {
// LOWERING-NEXT:                     let {{__v[0-9]+}}: f64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(real)) };
// LOWERING-NEXT:                     let {{__v[0-9]+}}: f64 = exp2({{__v[0-9]+}});
// LOWERING-NEXT:                     let {{__v[0-9]+}}: f64 = 72.0;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
...
// LOWERING-NEXT:                     let {{__v[0-9]+}}: f64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(real)) };
// LOWERING-NEXT:                     let {{__v[0-9]+}}: f64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(real)) };
// LOWERING-NEXT:                     let {{__v[0-9]+}}: f64 = fmod({{__v[0-9]+}}, {{__v[0-9]+}});
// LOWERING-NEXT:                     let {{__v[0-9]+}}: f64 = 73.0;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = 51;
// LOWERING-NEXT:                         __retval = {{__v[0-9]+}};
...
// LOWERING-NEXT:                 {
// LOWERING-NEXT:                     let {{__v[0-9]+}}: f64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(real)) };
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i64 = lround({{__v[0-9]+}});
...
// LOWERING-NEXT:                 {
// LOWERING-NEXT:                     let {{__v[0-9]+}}: f64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(real)) };
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i64 = llround({{__v[0-9]+}});
...
// LOWERING-NEXT:                     let {{__v[0-9]+}}: *mut core::ffi::c_void = ptr;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i32 = pthread_create(
// LOWERING-NEXT:                         std::ptr::addr_of_mut!(thread),
// LOWERING-NEXT:                         {{__v[0-9]+}} as *mut core::ffi::c_void,
// LOWERING-NEXT:                         Some(start),
// LOWERING-NEXT:                         {{__v[0-9]+}} as *mut core::ffi::c_void,
// LOWERING-NEXT:                     );
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i32 = 78;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = 54;
// LOWERING-NEXT:                         __retval = {{__v[0-9]+}};
...
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i32 = pthread_join({{__v[0-9]+}}, std::ptr::addr_of_mut!(ptr));
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i32 = 79;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = 55;
// LOWERING-NEXT:                         __retval = {{__v[0-9]+}};
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = __retval;
// LOWERING-NEXT:                         std::process::exit({{__v[0-9]+}} as i32);
// LOWERING-NEXT:                     }
...
// LOWERING-NEXT:                 {
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i32 = unsafe { project_state };
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i32 = 76;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = 56;
// LOWERING-NEXT:                         __retval = {{__v[0-9]+}};
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = __retval;
// LOWERING-NEXT:                         std::process::exit({{__v[0-9]+}} as i32);
// LOWERING-NEXT:                     }
...
// LOWERING-NEXT:                     let {{__v[0-9]+}}: u64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(count)) };
// LOWERING-NEXT:                     let {{__v[0-9]+}}: u64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(count)) };
// LOWERING-NEXT:                     let {{__v[0-9]+}}: *mut core::ffi::c_void = bsearch(
// LOWERING-NEXT:                         {{__v[0-9]+}} as *mut core::ffi::c_void,
// LOWERING-NEXT:                         {{__v[0-9]+}} as *mut core::ffi::c_void,
// LOWERING-NEXT:                         {{__v[0-9]+}},
// LOWERING-NEXT:                         {{__v[0-9]+}},
...
// LOWERING-NEXT:                     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:                     if {{__v[0-9]+}} {
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = 57;
// LOWERING-NEXT:                         __retval = {{__v[0-9]+}};
// LOWERING-NEXT:                         let {{__v[0-9]+}}: i32 = __retval;
// LOWERING-NEXT:                         std::process::exit({{__v[0-9]+}} as i32);
// LOWERING-NEXT:                     }
...
// LOWERING-NEXT:     }
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// LOWERING-NEXT:     exit({{__v[0-9]+}});
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { project_state };
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 80;
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} == {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 1;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 58;
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = {{arg[0-9]+}} != std::ptr::null_mut();
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 5;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = if {{__v[0-9]+}} { {{__v[0-9]+}} } else { {{__v[0-9]+}} };
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut core::ffi::c_void = {{__v[0-9]+}} as *mut core::ffi::c_void;
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut core::ffi::c_void = std::ptr::null_mut();
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut core::ffi::c_void = if {{__v[0-9]+}} { {{__v[0-9]+}} } else { {{__v[0-9]+}} };
// LOWERING-NEXT:     return {{__v[0-9]+}};
// LOWERING-NEXT: }
// LOWERING-EMPTY:
...
// LOWERING-NEXT:         let {{__v[0-9]+}}: u64 = size;
// LOWERING-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 0;
// LOWERING-NEXT:         {{__v[0-9]+}}
// LOWERING-NEXT:     } else {
...
// LOWERING-NEXT:         project_state = {{__v[0-9]+}};
// LOWERING-NEXT:     }
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = {{arg[0-9]+}} != 0;
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = if {{__v[0-9]+}} {
// LOWERING-NEXT:         let {{__v[0-9]+}}: *mut core::ffi::c_void = src;
...
// LOWERING-NEXT:         {{__v[0-9]+}}
// LOWERING-NEXT:     };
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut core::ffi::c_void = if {{__v[0-9]+}} {
// LOWERING-NEXT:         let {{__v[0-9]+}}: *mut core::ffi::c_void = dst;
// LOWERING-NEXT:         {{__v[0-9]+}}
// LOWERING-NEXT:     } else {
// LOWERING-NEXT:         let {{__v[0-9]+}}: *mut core::ffi::c_void = std::ptr::null_mut();
// LOWERING-NEXT:         {{__v[0-9]+}}
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = {{arg[0-9]+}} != 0;
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = if {{__v[0-9]+}} {
// LOWERING-NEXT:         let {{__v[0-9]+}}: u64 = count;
// LOWERING-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 0;
// LOWERING-NEXT:         {{__v[0-9]+}}
// LOWERING-NEXT:     } else {
// LOWERING-NEXT:         let {{__v[0-9]+}}: bool = false;
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = {{arg[0-9]+}} != std::ptr::null_mut();
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = if {{__v[0-9]+}} {
// LOWERING-NEXT:         let {{__v[0-9]+}}: *mut core::ffi::c_void = rhs;
// LOWERING-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != std::ptr::null_mut();
// LOWERING-NEXT:         {{__v[0-9]+}}
// LOWERING-NEXT:     } else {
// LOWERING-NEXT:         let {{__v[0-9]+}}: bool = false;
...
// LOWERING-NEXT:     };
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = if {{__v[0-9]+}} {
// LOWERING-NEXT:         let {{__v[0-9]+}}: i32 = base;
// LOWERING-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 0;
// LOWERING-NEXT:         {{__v[0-9]+}}
// LOWERING-NEXT:     } else {
// LOWERING-NEXT:         let {{__v[0-9]+}}: bool = false;
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: f64 = if {{__v[0-9]+}} { {{__v[0-9]+}} } else { {{__v[0-9]+}} };
// LOWERING-NEXT:     return {{__v[0-9]+}};
// LOWERING-NEXT: }
// LOWERING-EMPTY:
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = {{arg[0-9]+}} != 0.0;
// LOWERING-NEXT:     let {{__v[0-9]+}}: f64 = 63.0;
// LOWERING-NEXT:     let {{__v[0-9]+}}: f64 = 0.0;
// LOWERING-NEXT:     let {{__v[0-9]+}}: f64 = if {{__v[0-9]+}} { {{__v[0-9]+}} } else { {{__v[0-9]+}} };
// LOWERING-NEXT:     return {{__v[0-9]+}};
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = {{arg[0-9]+}} != 0.0;
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = if {{__v[0-9]+}} {
// LOWERING-NEXT:         let {{__v[0-9]+}}: f64 = rhs;
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = {{arg[0-9]+}} != 0.0;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 74;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = if {{__v[0-9]+}} { {{__v[0-9]+}} } else { {{__v[0-9]+}} };
// LOWERING-NEXT:     let {{__v[0-9]+}}: i64 = {{__v[0-9]+}} as i64;
// LOWERING-NEXT:     return {{__v[0-9]+}};
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = {{arg[0-9]+}} != 0.0;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 75;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = if {{__v[0-9]+}} { {{__v[0-9]+}} } else { {{__v[0-9]+}} };
// LOWERING-NEXT:     let {{__v[0-9]+}}: i64 = {{__v[0-9]+}} as i64;
// LOWERING-NEXT:     return {{__v[0-9]+}};
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = {{arg[0-9]+}} != std::ptr::null_mut();
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = if {{__v[0-9]+}} {
// LOWERING-NEXT:         let {{__v[0-9]+}}: *mut core::ffi::c_void = attr;
// LOWERING-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != std::ptr::null_mut();
...
// LOWERING-NEXT:             unsafe extern "C-unwind" fn(*mut core::ffi::c_void) -> *mut core::ffi::c_void,
// LOWERING-NEXT:         > = start;
// LOWERING-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}}.is_some();
// LOWERING-NEXT:         {{__v[0-9]+}}
// LOWERING-NEXT:     } else {
// LOWERING-NEXT:         let {{__v[0-9]+}}: bool = false;
// LOWERING-NEXT:         {{__v[0-9]+}}
// LOWERING-NEXT:     };
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = if {{__v[0-9]+}} {
// LOWERING-NEXT:         let {{__v[0-9]+}}: *mut core::ffi::c_void = arg;
// LOWERING-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != std::ptr::null_mut();
// LOWERING-NEXT:         {{__v[0-9]+}}
// LOWERING-NEXT:     } else {
// LOWERING-NEXT:         let {{__v[0-9]+}}: bool = false;
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = {{arg[0-9]+}} != 0;
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = if {{__v[0-9]+}} {
// LOWERING-NEXT:         let {{__v[0-9]+}}: *mut *mut core::ffi::c_void = result;
// LOWERING-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != std::ptr::null_mut();
// LOWERING-NEXT:         {{__v[0-9]+}}
// LOWERING-NEXT:     } else {
// LOWERING-NEXT:         let {{__v[0-9]+}}: bool = false;
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = {{arg[0-9]+}} != std::ptr::null_mut();
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = if {{__v[0-9]+}} {
// LOWERING-NEXT:         let {{__v[0-9]+}}: *mut core::ffi::c_void = base;
// LOWERING-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != std::ptr::null_mut();
// LOWERING-NEXT:         {{__v[0-9]+}}
// LOWERING-NEXT:     } else {
// LOWERING-NEXT:         let {{__v[0-9]+}}: bool = false;
...
// REWRITES-NEXT: )]
// REWRITES-EMPTY:
// REWRITES-NEXT: static mut project_state: i32 = 0;
// REWRITES-EMPTY:
...
// REWRITES-NEXT:     let mut count: u64 = 0;
// REWRITES-NEXT:     let mut number: i32 = 0;
// REWRITES-NEXT:     let mut real: f64 = 0.0;
// REWRITES-NEXT:     let mut stream: *mut core::ffi::c_void = std::ptr::null_mut();
// REWRITES-NEXT:     let mut ptr: *mut core::ffi::c_void = std::ptr::null_mut();
// REWRITES-NEXT:     let mut thread: u64 = 1;
...
// REWRITES-NEXT:     unsafe { std::ptr::write_volatile(std::ptr::addr_of_mut!(count), 1 as u64) };
// REWRITES-NEXT:     unsafe { std::ptr::write_volatile(std::ptr::addr_of_mut!(number), 1 as i32) };
// REWRITES-NEXT:     unsafe { std::ptr::write_volatile(std::ptr::addr_of_mut!(real), 1.0 as f64) };
// REWRITES-NEXT:     strlen_call = unsafe {
...
// REWRITES-NEXT:             strlen as *const (),
// REWRITES-NEXT:         )
// REWRITES-NEXT:     };
// REWRITES-NEXT:     let {{__v[0-9]+}}: u64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(count)) };
// REWRITES-NEXT:     ptr = malloc({{__v[0-9]+}});
// REWRITES-NEXT:     loop {
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = ptr != ((16 as u64) as *mut core::ffi::c_void);
...
// REWRITES-NEXT:         let {{__v[0-9]+}}: u64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(count)) };
// REWRITES-NEXT:         let {{__v[0-9]+}}: u64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(count)) };
// REWRITES-NEXT:         let {{__v[0-9]+}}: *mut core::ffi::c_void = calloc({{__v[0-9]+}}, {{__v[0-9]+}});
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != ((16 as u64) as *mut core::ffi::c_void);
// REWRITES-NEXT:         if {{__v[0-9]+}} {
...
// REWRITES-NEXT:     }
// REWRITES-NEXT:     loop {
// REWRITES-NEXT:         let {{__v[0-9]+}}: *mut core::ffi::c_void = ptr;
// REWRITES-NEXT:         let {{__v[0-9]+}}: u64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(count)) };
// REWRITES-NEXT:         let {{__v[0-9]+}}: *mut core::ffi::c_void = realloc({{__v[0-9]+}} as *mut core::ffi::c_void, {{__v[0-9]+}});
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != ((16 as u64) as *mut core::ffi::c_void);
// REWRITES-NEXT:         if {{__v[0-9]+}} {
...
// REWRITES-NEXT:         }
// REWRITES-NEXT:     }
// REWRITES-NEXT:     free(ptr as *mut core::ffi::c_void);
// REWRITES-NEXT:     loop {
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = (unsafe { project_state }) != 77;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
...
// REWRITES-NEXT:         let {{__v[0-9]+}}: *mut core::ffi::c_void = {{__v[0-9]+}} as *mut core::ffi::c_void;
// REWRITES-NEXT:         let {{__v[0-9]+}}: u64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(count)) };
// REWRITES-NEXT:         let {{__v[0-9]+}}: *mut core::ffi::c_void = memcpy(
...
// REWRITES-X86_64-GNU-NEXT:         let {{__v[0-9]+}}: *mut i8 = a.as_mut_ptr() as *mut i8;
// REWRITES-AARCH64-GNU-NEXT:         let {{__v[0-9]+}}: *mut u8 = a.as_mut_ptr() as *mut u8;
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != ({{__v[0-9]+}} as *mut core::ffi::c_void);
// REWRITES-NEXT:         if {{__v[0-9]+}} {
...
// REWRITES-NEXT:         let {{__v[0-9]+}}: *mut core::ffi::c_void = {{__v[0-9]+}} as *mut core::ffi::c_void;
// REWRITES-NEXT:         let {{__v[0-9]+}}: u64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(count)) };
// REWRITES-NEXT:         let {{__v[0-9]+}}: *mut core::ffi::c_void = memmove(
// REWRITES-NEXT:             {{__v[0-9]+}} as *mut core::ffi::c_void,
// REWRITES-NEXT:             {{__v[0-9]+}} as *mut core::ffi::c_void,
// REWRITES-NEXT:             {{__v[0-9]+}},
// REWRITES-NEXT:         );
...
// REWRITES-AARCH64-GNU-NEXT:         let {{__v[0-9]+}}: *mut u8 = a.as_mut_ptr() as *mut u8;
// REWRITES-NEXT:         let {{__v[0-9]+}}: *mut core::ffi::c_void = {{__v[0-9]+}} as *mut core::ffi::c_void;
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(number)) };
// REWRITES-NEXT:         let {{__v[0-9]+}}: u64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(count)) };
// REWRITES-NEXT:         let {{__v[0-9]+}}: *mut core::ffi::c_void = memset({{__v[0-9]+}} as *mut core::ffi::c_void, {{__v[0-9]+}}, {{__v[0-9]+}});
// REWRITES-X86_64-GNU-NEXT:         let {{__v[0-9]+}}: *mut i8 = a.as_mut_ptr() as *mut i8;
// REWRITES-AARCH64-GNU-NEXT:         let {{__v[0-9]+}}: *mut u8 = a.as_mut_ptr() as *mut u8;
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != ({{__v[0-9]+}} as *mut core::ffi::c_void);
// REWRITES-NEXT:         if {{__v[0-9]+}} {
// REWRITES-NEXT:             __retval = 8;
// REWRITES-NEXT:             std::process::exit(__retval as i32);
// REWRITES-NEXT:         }
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:         if !({{__v[0-9]+}} != 0) {
...
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(number)) };
// REWRITES-NEXT:         let {{__v[0-9]+}}: u64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(count)) };
// REWRITES-NEXT:         let {{__v[0-9]+}}: *mut core::ffi::c_void = memchr({{__v[0-9]+}} as *mut core::ffi::c_void, {{__v[0-9]+}}, {{__v[0-9]+}});
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != ((24 as u64) as *mut core::ffi::c_void);
// REWRITES-NEXT:         if {{__v[0-9]+}} {
...
// REWRITES-X86_64-GNU-NEXT:         let {{__v[0-9]+}}: *mut i8 = a.as_mut_ptr() as *mut i8;
// REWRITES-AARCH64-GNU-NEXT:         let {{__v[0-9]+}}: *mut u8 = a.as_mut_ptr() as *mut u8;
// REWRITES-NEXT:         let {{__v[0-9]+}}: u64 = strlen({{__v[0-9]+}});
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 5;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
...
// REWRITES-AARCH64-GNU-NEXT:         let {{__v[0-9]+}}: *mut u8 = a.as_mut_ptr() as *mut u8;
// REWRITES-NEXT:         let {{__v[0-9]+}}: u64 = unsafe { {{__v[0-9]+}}.unwrap()({{__v[0-9]+}}) };
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 5;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
// REWRITES-NEXT:             __retval = 10;
// REWRITES-NEXT:             std::process::exit(__retval as i32);
...
// REWRITES-AARCH64-GNU-NEXT:         let {{__v[0-9]+}}: *mut u8 = a.as_mut_ptr() as *mut u8;
// REWRITES-AARCH64-GNU-NEXT:         let {{__v[0-9]+}}: *mut u8 = b.as_mut_ptr() as *mut u8;
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = strcmp({{__v[0-9]+}}, {{__v[0-9]+}});
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 11;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
// REWRITES-NEXT:             __retval = 15;
// REWRITES-NEXT:             std::process::exit(__retval as i32);
// REWRITES-NEXT:         }
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:         if !({{__v[0-9]+}} != 0) {
...
// REWRITES-AARCH64-GNU-NEXT:         let {{__v[0-9]+}}: *mut u8 = b.as_mut_ptr() as *mut u8;
// REWRITES-NEXT:         let {{__v[0-9]+}}: u64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(count)) };
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = strncmp({{__v[0-9]+}}, {{__v[0-9]+}}, {{__v[0-9]+}});
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 12;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
// REWRITES-NEXT:             __retval = 16;
// REWRITES-NEXT:             std::process::exit(__retval as i32);
// REWRITES-NEXT:         }
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:         if !({{__v[0-9]+}} != 0) {
...
// REWRITES-NEXT:         let {{__v[0-9]+}}: *mut core::ffi::c_void = {{__v[0-9]+}} as *mut core::ffi::c_void;
// REWRITES-NEXT:         let {{__v[0-9]+}}: u64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(count)) };
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = memcmp(
// REWRITES-NEXT:             {{__v[0-9]+}} as *mut core::ffi::c_void,
// REWRITES-NEXT:             {{__v[0-9]+}} as *mut core::ffi::c_void,
// REWRITES-NEXT:             {{__v[0-9]+}},
// REWRITES-NEXT:         );
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 13;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
...
// REWRITES-AARCH64-GNU-NEXT:         let {{__v[0-9]+}}: *mut u8 = a.as_mut_ptr() as *mut u8;
// REWRITES-AARCH64-GNU-NEXT:         let {{__v[0-9]+}}: *mut u8 = b.as_mut_ptr() as *mut u8;
// REWRITES-NEXT:         let {{__v[0-9]+}}: u64 = strspn({{__v[0-9]+}}, {{__v[0-9]+}});
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 31;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
// REWRITES-NEXT:             __retval = 22;
// REWRITES-NEXT:             std::process::exit(__retval as i32);
// REWRITES-NEXT:         }
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:         if !({{__v[0-9]+}} != 0) {
...
// REWRITES-AARCH64-GNU-NEXT:         let {{__v[0-9]+}}: *mut u8 = a.as_mut_ptr() as *mut u8;
// REWRITES-AARCH64-GNU-NEXT:         let {{__v[0-9]+}}: *mut u8 = b.as_mut_ptr() as *mut u8;
// REWRITES-NEXT:         let {{__v[0-9]+}}: u64 = strcspn({{__v[0-9]+}}, {{__v[0-9]+}});
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 32;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
...
// REWRITES-X86_64-GNU-NEXT:         let {{__v[0-9]+}}: *mut i8 = a.as_mut_ptr() as *mut i8;
// REWRITES-AARCH64-GNU-NEXT:         let {{__v[0-9]+}}: *mut u8 = a.as_mut_ptr() as *mut u8;
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = atoi({{__v[0-9]+}});
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 41;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
// REWRITES-NEXT:             __retval = 24;
// REWRITES-NEXT:             std::process::exit(__retval as i32);
// REWRITES-NEXT:         }
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:         if !({{__v[0-9]+}} != 0) {
...
// REWRITES-X86_64-GNU-NEXT:         let {{__v[0-9]+}}: *mut i8 = a.as_mut_ptr() as *mut i8;
// REWRITES-AARCH64-GNU-NEXT:         let {{__v[0-9]+}}: *mut u8 = a.as_mut_ptr() as *mut u8;
// REWRITES-NEXT:         let {{__v[0-9]+}}: i64 = atol({{__v[0-9]+}});
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 42;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
// REWRITES-NEXT:             __retval = 25;
// REWRITES-NEXT:             std::process::exit(__retval as i32);
// REWRITES-NEXT:         }
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:         if !({{__v[0-9]+}} != 0) {
...
// REWRITES-AARCH64-GNU-NEXT:         let {{__v[0-9]+}}: *mut u8 = a.as_mut_ptr() as *mut u8;
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(number)) };
// REWRITES-NEXT:         let {{__v[0-9]+}}: i64 = strtol({{__v[0-9]+}}, std::ptr::addr_of_mut!(end), {{__v[0-9]+}});
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 43;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
// REWRITES-NEXT:             __retval = 26;
// REWRITES-NEXT:             std::process::exit(__retval as i32);
// REWRITES-NEXT:         }
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:         if !({{__v[0-9]+}} != 0) {
...
// REWRITES-AARCH64-GNU-NEXT:         let {{__v[0-9]+}}: *mut u8 = a.as_mut_ptr() as *mut u8;
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(number)) };
// REWRITES-NEXT:         let {{__v[0-9]+}}: u64 = strtoul({{__v[0-9]+}}, std::ptr::addr_of_mut!(end), {{__v[0-9]+}});
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 44;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
// REWRITES-NEXT:             __retval = 27;
// REWRITES-NEXT:             std::process::exit(__retval as i32);
// REWRITES-NEXT:         }
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:         if !({{__v[0-9]+}} != 0) {
...
// REWRITES-X86_64-GNU-NEXT:         let {{__v[0-9]+}}: *mut i8 = a.as_mut_ptr() as *mut i8;
// REWRITES-AARCH64-GNU-NEXT:         let {{__v[0-9]+}}: *mut u8 = a.as_mut_ptr() as *mut u8;
// REWRITES-NEXT:         let {{__v[0-9]+}}: f64 = strtod({{__v[0-9]+}}, std::ptr::addr_of_mut!(end));
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 45.0;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
// REWRITES-NEXT:             __retval = 28;
// REWRITES-NEXT:             std::process::exit(__retval as i32);
// REWRITES-NEXT:         }
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:         if !({{__v[0-9]+}} != 0) {
...
// REWRITES-X86_64-GNU-NEXT:         let {{__v[0-9]+}}: *mut i8 = a.as_mut_ptr() as *mut i8;
// REWRITES-AARCH64-GNU-NEXT:         let {{__v[0-9]+}}: *mut u8 = a.as_mut_ptr() as *mut u8;
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = printf({{__v[0-9]+}});
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 51;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
// REWRITES-NEXT:             __retval = 29;
// REWRITES-NEXT:             std::process::exit(__retval as i32);
// REWRITES-NEXT:         }
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:         if !({{__v[0-9]+}} != 0) {
...
// REWRITES-X86_64-GNU-NEXT:         let {{__v[0-9]+}}: *mut i8 = a.as_mut_ptr() as *mut i8;
// REWRITES-AARCH64-GNU-NEXT:         let {{__v[0-9]+}}: *mut u8 = a.as_mut_ptr() as *mut u8;
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = puts({{__v[0-9]+}});
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 52;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
...
// REWRITES-AARCH64-GNU-NEXT:     let {{__v[0-9]+}}: *mut u8 = a.as_mut_ptr() as *mut u8;
// REWRITES-AARCH64-GNU-NEXT:     let {{__v[0-9]+}}: *mut u8 = b.as_mut_ptr() as *mut u8;
// REWRITES-NEXT:     stream = fopen({{__v[0-9]+}}, {{__v[0-9]+}});
// REWRITES-NEXT:     loop {
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = stream != ((48 as u64) as *mut core::ffi::c_void);
// REWRITES-NEXT:         if {{__v[0-9]+}} {
// REWRITES-NEXT:             __retval = 31;
// REWRITES-NEXT:             std::process::exit(__retval as i32);
// REWRITES-NEXT:         }
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:         if !({{__v[0-9]+}} != 0) {
...
// REWRITES-X86_64-GNU-NEXT:         let {{__v[0-9]+}}: *mut i8 = a.as_mut_ptr() as *mut i8;
// REWRITES-AARCH64-GNU-NEXT:         let {{__v[0-9]+}}: *mut u8 = a.as_mut_ptr() as *mut u8;
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = fputs({{__v[0-9]+}}, stream as *mut core::ffi::c_void);
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 54;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
// REWRITES-NEXT:             __retval = 32;
// REWRITES-NEXT:             std::process::exit(__retval as i32);
// REWRITES-NEXT:         }
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:         if !({{__v[0-9]+}} != 0) {
...
// REWRITES-NEXT:         let {{__v[0-9]+}}: u64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(count)) };
// REWRITES-NEXT:         let {{__v[0-9]+}}: u64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(count)) };
// REWRITES-NEXT:         let {{__v[0-9]+}}: u64 = fread(
// REWRITES-NEXT:             {{__v[0-9]+}} as *mut core::ffi::c_void,
// REWRITES-NEXT:             {{__v[0-9]+}},
// REWRITES-NEXT:             {{__v[0-9]+}},
// REWRITES-NEXT:             stream as *mut core::ffi::c_void,
// REWRITES-NEXT:         );
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 56;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
// REWRITES-NEXT:             __retval = 34;
// REWRITES-NEXT:             std::process::exit(__retval as i32);
// REWRITES-NEXT:         }
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:         if !({{__v[0-9]+}} != 0) {
...
// REWRITES-NEXT:         let {{__v[0-9]+}}: u64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(count)) };
// REWRITES-NEXT:         let {{__v[0-9]+}}: u64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(count)) };
// REWRITES-NEXT:         let {{__v[0-9]+}}: u64 = fwrite(
// REWRITES-NEXT:             {{__v[0-9]+}} as *mut core::ffi::c_void,
// REWRITES-NEXT:             {{__v[0-9]+}},
// REWRITES-NEXT:             {{__v[0-9]+}},
// REWRITES-NEXT:             stream as *mut core::ffi::c_void,
// REWRITES-NEXT:         );
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 57;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
// REWRITES-NEXT:             __retval = 35;
// REWRITES-NEXT:             std::process::exit(__retval as i32);
// REWRITES-NEXT:         }
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:         if !({{__v[0-9]+}} != 0) {
...
// REWRITES-NEXT:     }
// REWRITES-NEXT:     loop {
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = fclose(stream as *mut core::ffi::c_void);
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 58;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
// REWRITES-NEXT:             __retval = 36;
// REWRITES-NEXT:             std::process::exit(__retval as i32);
// REWRITES-NEXT:         }
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:         if !({{__v[0-9]+}} != 0) {
...
// REWRITES-NEXT:     }
// REWRITES-NEXT:     loop {
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = fflush(stream as *mut core::ffi::c_void);
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 59;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
// REWRITES-NEXT:             __retval = 37;
// REWRITES-NEXT:             std::process::exit(__retval as i32);
// REWRITES-NEXT:         }
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:         if !({{__v[0-9]+}} != 0) {
...
// REWRITES-X86_64-GNU-NEXT:         let {{__v[0-9]+}}: *mut i8 = a.as_mut_ptr() as *mut i8;
// REWRITES-AARCH64-GNU-NEXT:         let {{__v[0-9]+}}: *mut u8 = a.as_mut_ptr() as *mut u8;
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = remove({{__v[0-9]+}});
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 60;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
// REWRITES-NEXT:             __retval = 38;
// REWRITES-NEXT:             std::process::exit(__retval as i32);
// REWRITES-NEXT:         }
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:         if !({{__v[0-9]+}} != 0) {
...
// REWRITES-NEXT:     loop {
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(number)) };
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = toupper({{__v[0-9]+}});
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 61;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
// REWRITES-NEXT:             __retval = 39;
// REWRITES-NEXT:             std::process::exit(__retval as i32);
// REWRITES-NEXT:         }
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:         if !({{__v[0-9]+}} != 0) {
...
// REWRITES-NEXT:     loop {
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(number)) };
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = tolower({{__v[0-9]+}});
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 62;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
// REWRITES-NEXT:             __retval = 40;
// REWRITES-NEXT:             std::process::exit(__retval as i32);
// REWRITES-NEXT:         }
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:         if !({{__v[0-9]+}} != 0) {
...
// REWRITES-NEXT:         let {{__v[0-9]+}}: f64 = sin({{__v[0-9]+}});
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 63.0;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
// REWRITES-NEXT:             __retval = 41;
// REWRITES-NEXT:             std::process::exit(__retval as i32);
// REWRITES-NEXT:         }
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:         if !({{__v[0-9]+}} != 0) {
...
// REWRITES-NEXT:     loop {
// REWRITES-NEXT:         let {{__v[0-9]+}}: f64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(real)) };
// REWRITES-NEXT:         let {{__v[0-9]+}}: f64 = cos({{__v[0-9]+}});
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 64.0;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
...
// REWRITES-NEXT:     loop {
// REWRITES-NEXT:         let {{__v[0-9]+}}: f64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(real)) };
// REWRITES-NEXT:         let {{__v[0-9]+}}: f64 = tan({{__v[0-9]+}});
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 65.0;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
// REWRITES-NEXT:             __retval = 43;
// REWRITES-NEXT:             std::process::exit(__retval as i32);
// REWRITES-NEXT:         }
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:         if !({{__v[0-9]+}} != 0) {
...
// REWRITES-NEXT:     loop {
// REWRITES-NEXT:         let {{__v[0-9]+}}: f64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(real)) };
// REWRITES-NEXT:         let {{__v[0-9]+}}: f64 = log({{__v[0-9]+}});
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 66.0;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
// REWRITES-NEXT:             __retval = 44;
// REWRITES-NEXT:             std::process::exit(__retval as i32);
// REWRITES-NEXT:         }
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:         if !({{__v[0-9]+}} != 0) {
...
// REWRITES-NEXT:     loop {
// REWRITES-NEXT:         let {{__v[0-9]+}}: f64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(real)) };
// REWRITES-NEXT:         let {{__v[0-9]+}}: f64 = log10({{__v[0-9]+}});
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 67.0;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
// REWRITES-NEXT:             __retval = 45;
// REWRITES-NEXT:             std::process::exit(__retval as i32);
// REWRITES-NEXT:         }
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:         if !({{__v[0-9]+}} != 0) {
...
// REWRITES-NEXT:     loop {
// REWRITES-NEXT:         let {{__v[0-9]+}}: f64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(real)) };
// REWRITES-NEXT:         let {{__v[0-9]+}}: f64 = log2({{__v[0-9]+}});
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 68.0;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
// REWRITES-NEXT:             __retval = 46;
// REWRITES-NEXT:             std::process::exit(__retval as i32);
// REWRITES-NEXT:         }
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:         if !({{__v[0-9]+}} != 0) {
...
// REWRITES-NEXT:         let {{__v[0-9]+}}: f64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(real)) };
// REWRITES-NEXT:         let {{__v[0-9]+}}: f64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(real)) };
// REWRITES-NEXT:         let {{__v[0-9]+}}: f64 = pow({{__v[0-9]+}}, {{__v[0-9]+}});
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 69.0;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
...
// REWRITES-NEXT:     loop {
// REWRITES-NEXT:         let {{__v[0-9]+}}: f64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(real)) };
// REWRITES-NEXT:         let {{__v[0-9]+}}: f64 = sqrt({{__v[0-9]+}});
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 70.0;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
// REWRITES-NEXT:             __retval = 48;
// REWRITES-NEXT:             std::process::exit(__retval as i32);
// REWRITES-NEXT:         }
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:         if !({{__v[0-9]+}} != 0) {
...
// REWRITES-NEXT:     loop {
// REWRITES-NEXT:         let {{__v[0-9]+}}: f64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(real)) };
// REWRITES-NEXT:         let {{__v[0-9]+}}: f64 = exp({{__v[0-9]+}});
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 71.0;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
// REWRITES-NEXT:             __retval = 49;
// REWRITES-NEXT:             std::process::exit(__retval as i32);
// REWRITES-NEXT:         }
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:         if !({{__v[0-9]+}} != 0) {
...
// REWRITES-NEXT:     loop {
// REWRITES-NEXT:         let {{__v[0-9]+}}: f64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(real)) };
// REWRITES-NEXT:         let {{__v[0-9]+}}: f64 = exp2({{__v[0-9]+}});
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 72.0;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
// REWRITES-NEXT:             __retval = 50;
// REWRITES-NEXT:             std::process::exit(__retval as i32);
// REWRITES-NEXT:         }
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:         if !({{__v[0-9]+}} != 0) {
...
// REWRITES-NEXT:         let {{__v[0-9]+}}: f64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(real)) };
// REWRITES-NEXT:         let {{__v[0-9]+}}: f64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(real)) };
// REWRITES-NEXT:         let {{__v[0-9]+}}: f64 = fmod({{__v[0-9]+}}, {{__v[0-9]+}});
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 73.0;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
// REWRITES-NEXT:             __retval = 51;
// REWRITES-NEXT:             std::process::exit(__retval as i32);
// REWRITES-NEXT:         }
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:         if !({{__v[0-9]+}} != 0) {
...
// REWRITES-NEXT:     loop {
// REWRITES-NEXT:         let {{__v[0-9]+}}: f64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(real)) };
// REWRITES-NEXT:         let {{__v[0-9]+}}: i64 = lround({{__v[0-9]+}});
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 74;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
// REWRITES-NEXT:             __retval = 52;
// REWRITES-NEXT:             std::process::exit(__retval as i32);
// REWRITES-NEXT:         }
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:         if !({{__v[0-9]+}} != 0) {
...
// REWRITES-NEXT:     loop {
// REWRITES-NEXT:         let {{__v[0-9]+}}: f64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(real)) };
// REWRITES-NEXT:         let {{__v[0-9]+}}: i64 = llround({{__v[0-9]+}});
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 75;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
// REWRITES-NEXT:             __retval = 53;
// REWRITES-NEXT:             std::process::exit(__retval as i32);
// REWRITES-NEXT:         }
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:         if !({{__v[0-9]+}} != 0) {
...
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = pthread_create(
// REWRITES-NEXT:             std::ptr::addr_of_mut!(thread),
// REWRITES-NEXT:             {{__v[0-9]+}} as *mut core::ffi::c_void,
// REWRITES-NEXT:             Some(start),
// REWRITES-NEXT:             ptr as *mut core::ffi::c_void,
// REWRITES-NEXT:         );
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 78;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
// REWRITES-NEXT:             __retval = 54;
// REWRITES-NEXT:             std::process::exit(__retval as i32);
// REWRITES-NEXT:         }
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:         if !({{__v[0-9]+}} != 0) {
...
// REWRITES-NEXT:     }
// REWRITES-NEXT:     loop {
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = pthread_join(thread, std::ptr::addr_of_mut!(ptr));
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != 79;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
// REWRITES-NEXT:             __retval = 55;
// REWRITES-NEXT:             std::process::exit(__retval as i32);
// REWRITES-NEXT:         }
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:         if !({{__v[0-9]+}} != 0) {
...
// REWRITES-NEXT:     }
// REWRITES-NEXT:     qsort(
// REWRITES-NEXT:         a.as_mut_ptr() as *mut core::ffi::c_void,
// REWRITES-NEXT:         unsafe { std::ptr::read_volatile(std::ptr::addr_of!(count)) },
// REWRITES-NEXT:         unsafe { std::ptr::read_volatile(std::ptr::addr_of!(count)) },
// REWRITES-NEXT:         Some(compare),
// REWRITES-NEXT:     );
// REWRITES-NEXT:     loop {
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = (unsafe { project_state }) != 76;
// REWRITES-NEXT:         if {{__v[0-9]+}} {
// REWRITES-NEXT:             __retval = 56;
// REWRITES-NEXT:             std::process::exit(__retval as i32);
// REWRITES-NEXT:         }
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:         if !({{__v[0-9]+}} != 0) {
...
// REWRITES-NEXT:         let {{__v[0-9]+}}: u64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(count)) };
// REWRITES-NEXT:         let {{__v[0-9]+}}: u64 = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(count)) };
// REWRITES-NEXT:         let {{__v[0-9]+}}: *mut core::ffi::c_void = bsearch(
// REWRITES-NEXT:             {{__v[0-9]+}} as *mut core::ffi::c_void,
// REWRITES-NEXT:             {{__v[0-9]+}} as *mut core::ffi::c_void,
// REWRITES-NEXT:             {{__v[0-9]+}},
// REWRITES-NEXT:             {{__v[0-9]+}},
// REWRITES-NEXT:             Some(compare),
// REWRITES-NEXT:         );
// REWRITES-NEXT:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != ((56 as u64) as *mut core::ffi::c_void);
// REWRITES-NEXT:         if {{__v[0-9]+}} {
// REWRITES-NEXT:             __retval = 57;
// REWRITES-NEXT:             std::process::exit(__retval as i32);
// REWRITES-NEXT:         }
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:         if !({{__v[0-9]+}} != 0) {
...
// REWRITES-NEXT:         }
// REWRITES-NEXT:     }
// REWRITES-NEXT:     exit(0);
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = 1;
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = 58;
// REWRITES-NEXT:     __retval = if (unsafe { project_state }) == 80 {
// REWRITES-NEXT:         {{__v[0-9]+}}
// REWRITES-NEXT:     } else {
// REWRITES-NEXT:         {{__v[0-9]+}}
// REWRITES-NEXT:     };
...
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:     (if {{arg[0-9]+}} != std::ptr::null_mut() {
// REWRITES-NEXT:         {{__v[0-9]+}}
// REWRITES-NEXT:     } else {
// REWRITES-NEXT:         {{__v[0-9]+}}
...
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: fn malloc({{arg[0-9]+}}: u64) -> *mut core::ffi::c_void {
// REWRITES-NEXT:     let {{__v[0-9]+}}: *mut core::ffi::c_void = (16 as u64) as *mut core::ffi::c_void;
// REWRITES-NEXT:     let {{__v[0-9]+}}: *mut core::ffi::c_void = std::ptr::null_mut();
// REWRITES-NEXT:     if {{arg[0-9]+}} != 0 { {{__v[0-9]+}} } else { {{__v[0-9]+}} }
// REWRITES-NEXT: }
// REWRITES-EMPTY:
...
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = 77;
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:     unsafe {
// REWRITES-NEXT:         project_state = if {{arg[0-9]+}} != std::ptr::null_mut() {
// REWRITES-NEXT:             {{__v[0-9]+}}
// REWRITES-NEXT:         } else {
// REWRITES-NEXT:             {{__v[0-9]+}}
// REWRITES-NEXT:         };
...
// REWRITES-NEXT:     mut dst: *mut core::ffi::c_void,
...
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = 41;
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:     if {{arg[0-9]+}} != std::ptr::null_mut() {
// REWRITES-NEXT:         {{__v[0-9]+}}
// REWRITES-NEXT:     } else {
...
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = 52;
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:     if {{arg[0-9]+}} != std::ptr::null_mut() {
// REWRITES-NEXT:         {{__v[0-9]+}}
// REWRITES-NEXT:     } else {
...
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: fn fflush({{arg[0-9]+}}: *mut core::ffi::c_void) -> i32 {
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = 59;
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:     if {{arg[0-9]+}} != std::ptr::null_mut() {
// REWRITES-NEXT:         {{__v[0-9]+}}
// REWRITES-NEXT:     } else {
...
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: fn toupper({{arg[0-9]+}}: i32) -> i32 {
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = 61;
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:     if {{arg[0-9]+}} != 0 { {{__v[0-9]+}} } else { {{__v[0-9]+}} }
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: fn tolower({{arg[0-9]+}}: i32) -> i32 {
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = 62;
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:     if {{arg[0-9]+}} != 0 { {{__v[0-9]+}} } else { {{__v[0-9]+}} }
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: fn sin({{arg[0-9]+}}: f64) -> f64 {
// REWRITES-NEXT:     let {{__v[0-9]+}}: f64 = 63.0;
// REWRITES-NEXT:     let {{__v[0-9]+}}: f64 = 0.0;
// REWRITES-NEXT:     if {{arg[0-9]+}} != 0.0 { {{__v[0-9]+}} } else { {{__v[0-9]+}} }
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: fn cos({{arg[0-9]+}}: f64) -> f64 {
// REWRITES-NEXT:     let {{__v[0-9]+}}: f64 = 64.0;
// REWRITES-NEXT:     let {{__v[0-9]+}}: f64 = 0.0;
// REWRITES-NEXT:     if {{arg[0-9]+}} != 0.0 { {{__v[0-9]+}} } else { {{__v[0-9]+}} }
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: fn tan({{arg[0-9]+}}: f64) -> f64 {
// REWRITES-NEXT:     let {{__v[0-9]+}}: f64 = 65.0;
// REWRITES-NEXT:     let {{__v[0-9]+}}: f64 = 0.0;
// REWRITES-NEXT:     if {{arg[0-9]+}} != 0.0 { {{__v[0-9]+}} } else { {{__v[0-9]+}} }
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: fn log({{arg[0-9]+}}: f64) -> f64 {
// REWRITES-NEXT:     let {{__v[0-9]+}}: f64 = 66.0;
// REWRITES-NEXT:     let {{__v[0-9]+}}: f64 = 0.0;
// REWRITES-NEXT:     if {{arg[0-9]+}} != 0.0 { {{__v[0-9]+}} } else { {{__v[0-9]+}} }
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: fn log10({{arg[0-9]+}}: f64) -> f64 {
// REWRITES-NEXT:     let {{__v[0-9]+}}: f64 = 67.0;
// REWRITES-NEXT:     let {{__v[0-9]+}}: f64 = 0.0;
// REWRITES-NEXT:     if {{arg[0-9]+}} != 0.0 { {{__v[0-9]+}} } else { {{__v[0-9]+}} }
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: fn log2({{arg[0-9]+}}: f64) -> f64 {
// REWRITES-NEXT:     let {{__v[0-9]+}}: f64 = 68.0;
// REWRITES-NEXT:     let {{__v[0-9]+}}: f64 = 0.0;
// REWRITES-NEXT:     if {{arg[0-9]+}} != 0.0 { {{__v[0-9]+}} } else { {{__v[0-9]+}} }
// REWRITES-NEXT: }
// REWRITES-EMPTY:
...
// REWRITES-NEXT:     let {{__v[0-9]+}}: f64 = 70.0;
// REWRITES-NEXT:     let {{__v[0-9]+}}: f64 = 0.0;
// REWRITES-NEXT:     if {{arg[0-9]+}} != 0.0 { {{__v[0-9]+}} } else { {{__v[0-9]+}} }
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: fn exp({{arg[0-9]+}}: f64) -> f64 {
// REWRITES-NEXT:     let {{__v[0-9]+}}: f64 = 71.0;
// REWRITES-NEXT:     let {{__v[0-9]+}}: f64 = 0.0;
// REWRITES-NEXT:     if {{arg[0-9]+}} != 0.0 { {{__v[0-9]+}} } else { {{__v[0-9]+}} }
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: fn exp2({{arg[0-9]+}}: f64) -> f64 {
// REWRITES-NEXT:     let {{__v[0-9]+}}: f64 = 72.0;
// REWRITES-NEXT:     let {{__v[0-9]+}}: f64 = 0.0;
// REWRITES-NEXT:     if {{arg[0-9]+}} != 0.0 { {{__v[0-9]+}} } else { {{__v[0-9]+}} }
// REWRITES-NEXT: }
// REWRITES-EMPTY:
...
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = 74;
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:     (if {{arg[0-9]+}} != 0.0 { {{__v[0-9]+}} } else { {{__v[0-9]+}} }) as i64
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: fn llround({{arg[0-9]+}}: f64) -> i64 {
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = 75;
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:     (if {{arg[0-9]+}} != 0.0 { {{__v[0-9]+}} } else { {{__v[0-9]+}} }) as i64
// REWRITES-NEXT: }
// REWRITES-EMPTY:
...
// REWRITES-NEXT:     mut attr: *mut core::ffi::c_void,
// REWRITES-NEXT:     mut start: Option<
// REWRITES-NEXT:         unsafe extern "C-unwind" fn(*mut core::ffi::c_void) -> *mut core::ffi::c_void,
// REWRITES-NEXT:     >,
...
// REWRITES-NEXT:     mut count: u64,
// REWRITES-NEXT:     mut size: u64,
// REWRITES-NEXT:     mut callback: Option<
...
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:     unsafe {
// REWRITES-NEXT:         project_state = if {{__v[0-9]+}} { {{__v[0-9]+}} } else { {{__v[0-9]+}} };
// REWRITES-NEXT:     }
// REWRITES-NEXT:     return;
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: extern "C-unwind" fn compare({{arg[0-9]+}}: *mut core::ffi::c_void, {{arg[0-9]+}}: *mut core::ffi::c_void) -> i32 {
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = 1;
// REWRITES-NEXT:     if {{arg[0-9]+}} == {{arg[0-9]+}} { {{__v[0-9]+}} } else { {{__v[0-9]+}} }
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: fn bsearch(
// REWRITES-NEXT:     {{arg[0-9]+}}: *mut core::ffi::c_void,
// REWRITES-NEXT:     mut base: *mut core::ffi::c_void,
// REWRITES-NEXT:     mut count: u64,
// REWRITES-NEXT:     mut size: u64,
// REWRITES-NEXT:     mut callback: Option<
// REWRITES-NEXT:         unsafe extern "C-unwind" fn(*mut core::ffi::c_void, *mut core::ffi::c_void) -> i32,
...
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: fn exit({{arg[0-9]+}}: i32) {
// REWRITES-NEXT:     unsafe {
// REWRITES-NEXT:         project_state = {{arg[0-9]+}} + 80;
// REWRITES-NEXT:     }
// REWRITES-NEXT:     return;
// REWRITES-NEXT: }
