...
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = iand({{__v[0-9]+}}, {{__v[0-9]+}});
...
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: u32 = 60;
...
// COMMON-LOWERING-NEXT: }
// COMMON-LOWERING-EMPTY:
// COMMON-LOWERING-NEXT: fn iand({{arg[0-9]+}}: i32, {{arg[0-9]+}}: i32) -> i32 {
...
// COMMON-REWRITES-NEXT:     unsafe { printf(c"%d\n".as_ptr(), iand(-1, 6)) };
// COMMON-REWRITES-NEXT:     let {{__v[0-9]+}}: u32 = 60;
// COMMON-REWRITES-NEXT:     let {{__v[0-9]+}}: u32 = 240 & {{__v[0-9]+}};
// COMMON-REWRITES-NEXT:     unsafe { printf(c"%u\n".as_ptr(), {{__v[0-9]+}}) };
// COMMON-REWRITES-NEXT:     std::process::exit(0 as i32);
// COMMON-REWRITES-NEXT: }
// COMMON-REWRITES-EMPTY:
// COMMON-REWRITES-NEXT: fn iand({{arg[0-9]+}}: i32, {{arg[0-9]+}}: i32) -> i32 {
