...
// REWRITES-NEXT: unsafe { printf({{_v[0-9]+}} as *const i8, ({{_v[0-9]+}} == {{_v[0-9]+}}) as i32) };
...
// REWRITES-NEXT: unsafe { printf({{_v[0-9]+}} as *const i8, {{_v[0-9]+}}[({{_v[0-9]+}} as usize)], {{_v[0-9]+}}[({{_v[0-9]+}} as usize)], {{_v[0-9]+}}[({{_v[0-9]+}} as usize)], {{_v[0-9]+}}[({{_v[0-9]+}} as usize)]) };
// REWRITES-NEXT: let {{_v[0-9]+}}: i32 = 0;
