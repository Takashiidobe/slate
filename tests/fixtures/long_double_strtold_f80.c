...
// REWRITES-NEXT:                     unsafe { printf({{_v[0-9]+}} as *const i8, bytes[((i as i64) as usize)] as i32) };
// REWRITES-NEXT:                     i = i + 1;
// REWRITES-NEXT:         }
// REWRITES-NEXT: }
...
// REWRITES-NEXT: unsafe { printf({{_v[0-9]+}} as *const i8, (((unsafe { *end }) as i32) == {{_v[0-9]+}}) as i32) };
// REWRITES-NEXT: let {{_v[0-9]+}}: i32 = 0;
