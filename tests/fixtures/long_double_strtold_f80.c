...
// LOWERING-NEXT:     fn strtold(_0: *const i8, _1: *mut *mut i8) -> LongDouble;
...
// LOWERING-NEXT:     let _v1: *mut i8 = b"0x1.0000000000000002p0\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let _v2: LongDouble = unsafe { __slate_strtold__rf80_pi8_ppi8(_v1 as *const i8, std::ptr::addr_of_mut!(end) as *mut *mut i8) };
// LOWERING-NEXT:     value = _v2;
// LOWERING-NEXT:     let _v3: *mut i8 = b"strtold\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let _v4: LongDouble = value;
// LOWERING-NEXT:     dump80(_v3, _v4);
// LOWERING-NEXT:     let _v5: *mut i8 = b"%d\n\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let _v6: *mut i8 = end;
...
// LOWERING-NEXT:     let _v12: i32 = unsafe { printf(_v5 as *const i8, _v11) };
...
// LOWERING-NEXT:     fn __slate_strtold__rf80_pi8_ppi8(_0: *const i8, _1: *mut *mut i8) -> LongDouble;
// LOWERING-NEXT: }
...
// REWRITES-NEXT:     fn strtold(_0: *const i8, _1: *mut *mut i8) -> LongDouble;
...
// REWRITES-NEXT: let mut end: *mut i8 = std::ptr::null_mut();
// REWRITES-NEXT: let mut value: LongDouble = LongDouble([0; 10]);
// REWRITES-NEXT: __retval = 0;
// REWRITES-NEXT: let _v1: *mut i8 = b"0x1.0000000000000002p0\0".as_ptr() as *mut i8;
// REWRITES-NEXT: value = unsafe { __slate_strtold__rf80_pi8_ppi8(_v1 as *const i8, std::ptr::addr_of_mut!(end) as *mut *mut i8) };
// REWRITES-NEXT: let _v3: *mut i8 = b"strtold\0".as_ptr() as *mut i8;
// REWRITES-NEXT: dump80(_v3, value);
// REWRITES-NEXT: let _v5: *mut i8 = b"%d\n\0".as_ptr() as *mut i8;
// REWRITES-NEXT: let _v9: i32 = 0;
// REWRITES-NEXT: let _v12: i32 = unsafe { printf(_v5 as *const i8, (((unsafe { *end }) as i32) == _v9) as i32) };
// REWRITES-NEXT: __retval = 0;
...
// REWRITES-NEXT:     fn __slate_strtold__rf80_pi8_ppi8(_0: *const i8, _1: *mut *mut i8) -> LongDouble;
// REWRITES-NEXT: }
