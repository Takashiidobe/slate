...
// COMMON-LOWERING-NEXT: }
// COMMON-LOWERING-EMPTY:
// COMMON-LOWERING-NEXT: fn get({{arg[0-9]+}}: *mut i32) -> *mut i32 {
...
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i32 = get(std::ptr::addr_of_mut!(x));
...
// COMMON-REWRITES-NEXT: }
// COMMON-REWRITES-EMPTY:
// COMMON-REWRITES-NEXT: fn get({{arg[0-9]+}}: &i32) -> *mut i32 {
// COMMON-REWRITES-NEXT:     ({{arg[0-9]+}} as *const i32) as *mut i32
// COMMON-REWRITES-NEXT: }
// COMMON-REWRITES-EMPTY:
// COMMON-REWRITES-NEXT: fn main() {
// COMMON-REWRITES-NEXT:     let mut x: i32 = 0;
// COMMON-REWRITES-NEXT:     x = 5;
// COMMON-REWRITES-NEXT:     let {{__v[0-9]+}}: *mut i32 = get(unsafe { &(*std::ptr::addr_of_mut!(x)) });
