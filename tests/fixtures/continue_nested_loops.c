...
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = sum_grid({{__v[0-9]+}});
...
// REWRITES-NEXT:     println!("{}", sum_grid(5));
// REWRITES-NEXT:     let _ = std::io::Write::flush(&mut std::io::stdout());
// REWRITES-NEXT:     println!("{}", sum_grid(1));
// REWRITES-NEXT:     let _ = std::io::Write::flush(&mut std::io::stdout());
// REWRITES-NEXT:     println!("{}", sum_grid(0));
// REWRITES-NEXT:     let _ = std::io::Write::flush(&mut std::io::stdout());
...
// REWRITES-NEXT:             j = 0;
// REWRITES-NEXT:             '__loop1: while j < n {
