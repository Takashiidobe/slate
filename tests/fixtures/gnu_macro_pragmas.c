...
// LOWERING-NEXT: )]
// LOWERING-EMPTY:
// LOWERING-NEXT: static mut macro_inner: i32 = 11;
// LOWERING-EMPTY:
// LOWERING-NEXT: static mut macro_outer: i32 = 7;
// LOWERING-EMPTY:
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { macro_inner };
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { macro_outer };
