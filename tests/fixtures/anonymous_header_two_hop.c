...
// LOWERING-NEXT:     value: anon_0,
// LOWERING-NEXT: }
// LOWERING-EMPTY:
// LOWERING-EMPTY:
// LOWERING-NEXT: fn main() {
// LOWERING-NEXT:     let mut __retval: i32 = 0;
// LOWERING-NEXT:     let mut state: anonymous_header_state = anonymous_header_state { count: 0, value: anon_0 { wide: 0 } };
// LOWERING-NEXT:     let _v0: i32 = 0;
// LOWERING-NEXT:     __retval = _v0;
// LOWERING-NEXT:     state = anonymous_header_state { count: 0, value: anon_0 { wide: 0 } };
// LOWERING-NEXT:     let _v1: i32 = 7;
// LOWERING-NEXT:     unsafe {
// LOWERING-NEXT:         state.value.wide = _v1;
// LOWERING-NEXT:     }
// LOWERING-NEXT:     let _v2: i32 = state.count;
// LOWERING-NEXT:     let _v3: i32 = unsafe { state.value.wide };
// LOWERING-NEXT:     let _v4: i32 = 7;
// LOWERING-NEXT:     let _v5: bool = _v3 != _v4;
// LOWERING-NEXT:     let _v6: i32 = _v5 as i32;
// LOWERING-NEXT:     let _v7: i32 = _v2 + _v6;
...
// REWRITES-NEXT:     value: anon_0,
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-EMPTY:
// REWRITES-NEXT: fn main() {
// REWRITES-NEXT: let mut __retval: i32 = 0;
// REWRITES-NEXT: let mut state: anonymous_header_state = anonymous_header_state { count: 0, value: anon_0 { wide: 0 } };
// REWRITES-NEXT: __retval = 0;
// REWRITES-NEXT: state = anonymous_header_state { count: 0, value: anon_0 { wide: 0 } };
// REWRITES-NEXT: unsafe {
// REWRITES-NEXT:         state.value.wide = 7;
// REWRITES-NEXT: }
// REWRITES-NEXT: let _v4: i32 = 7;
// REWRITES-NEXT: __retval = state.count + (((unsafe { state.value.wide }) != _v4) as i32);
