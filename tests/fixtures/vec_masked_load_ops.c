...
// LOWERING-NEXT:         bitint::BInt::<1, 1, 1>::from_u128(({{arg[0-9]+}} >> 3u8 & 1u8) as u128),
// LOWERING-NEXT:         bitint::BInt::<1, 1, 1>::from_u128(({{arg[0-9]+}} >> 4u8 & 1u8) as u128),
// LOWERING-NEXT:         bitint::BInt::<1, 1, 1>::from_u128(({{arg[0-9]+}} >> 5u8 & 1u8) as u128),
...
// REWRITES-NEXT:         masked_load_probe(
// REWRITES-NEXT:             data.as_mut_ptr() as *mut i32,
// REWRITES-NEXT:             5,
...
// REWRITES-NEXT:         bitint::BInt::<1, 1, 1>::from_u128(({{arg[0-9]+}} >> 3u8 & 1u8) as u128),
// REWRITES-NEXT:         bitint::BInt::<1, 1, 1>::from_u128(({{arg[0-9]+}} >> 4u8 & 1u8) as u128),
// REWRITES-NEXT:         bitint::BInt::<1, 1, 1>::from_u128(({{arg[0-9]+}} >> 5u8 & 1u8) as u128),
