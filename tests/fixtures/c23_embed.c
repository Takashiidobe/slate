...
// REWRITES-NEXT:     framed_ok = (8 == {{__v[0-9]+}}
// REWRITES-NEXT:         && ((unsafe { main_framed[0] }) as i32) == 170
// REWRITES-NEXT:         && ((unsafe { main_framed[1] }) as i32) == 187
// REWRITES-NEXT:         && ((unsafe { main_framed[2] }) as i32) == 67
// REWRITES-NEXT:         && ((unsafe { main_framed[3] }) as i32) == 50
// REWRITES-NEXT:         && ((unsafe { main_framed[4] }) as i32) == 51
// REWRITES-NEXT:         && ((unsafe { main_framed[5] }) as i32) == 10
// REWRITES-NEXT:         && ((unsafe { main_framed[6] }) as i32) == 204
// REWRITES-NEXT:         && ((unsafe { main_framed[7] }) as i32) == 221) as i32;
// REWRITES-NEXT:     let {{__v[0-9]+}}: u64 = 1;
// REWRITES-NEXT:     empty_ok = (1 == {{__v[0-9]+}} && ((unsafe { main_empty[0] }) as i32) == 238) as i32;
// REWRITES-NEXT:     let {{__v[0-9]+}}: u64 = 4;
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = 1;
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = if 4 == {{__v[0-9]+}}
// REWRITES-NEXT:         && ((unsafe { main_data[0] }) as i32) == 67
// REWRITES-NEXT:         && ((unsafe { main_data[1] }) as i32) == 50
// REWRITES-NEXT:         && ((unsafe { main_data[2] }) as i32) == 51
// REWRITES-NEXT:         && ((unsafe { main_data[3] }) as i32) == 10
// REWRITES-NEXT:         && framed_ok != 0
// REWRITES-NEXT:         && empty_ok != 0
// REWRITES-NEXT:     {
