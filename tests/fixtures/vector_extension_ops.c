...
// LOWERING-NEXT:     let {{__v[0-9]+}}: [i32; 4] = [1, 2, 3, 4];
// LOWERING-NEXT:     let {{__v[0-9]+}}: [i32; 4] = [5, 6, 7, 8];
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: [i32; 4] = [{{__v[0-9]+}}[0usize], {{__v[0-9]+}}, {{__v[0-9]+}}[2usize], {{__v[0-9]+}}[3usize]];
// LOWERING-NEXT:     let {{__v[0-9]+}}: [i32; 4] = [{{__v[0-9]+}}[3usize], {{__v[0-9]+}}[2usize], {{__v[0-9]+}}[1usize], {{__v[0-9]+}}[0usize]];
...
// REWRITES-NEXT:     let {{__v[0-9]+}}: [i32; 4] = [1, 2, 3, 4];
// REWRITES-NEXT:     let {{__v[0-9]+}}: [i32; 4] = [5, 6, 7, 8];
