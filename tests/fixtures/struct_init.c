...
// LOWERING-NEXT:     let {{__v[0-9]+}}: Triple = Triple { x: 1, y: 2, z: 3 };
// LOWERING-NEXT:     full = {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: Triple = Triple { x: 4, y: 5, z: 0 };
// LOWERING-NEXT:     partial = {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: Triple = Triple { x: 7, y: 0, z: 9 };
// LOWERING-NEXT:     designated = {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"%d %d %d\n\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = full.x;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = full.y;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = full.z;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { printf({{__v[0-9]+}} as *const core::ffi::c_char, {{__v[0-9]+}}, {{__v[0-9]+}}, {{__v[0-9]+}}) };
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"%d %d %d\n\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = partial.x;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = partial.y;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = partial.z;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { printf({{__v[0-9]+}} as *const core::ffi::c_char, {{__v[0-9]+}}, {{__v[0-9]+}}, {{__v[0-9]+}}) };
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"%d %d %d\n\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = designated.x;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = designated.y;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = designated.z;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { printf({{__v[0-9]+}} as *const core::ffi::c_char, {{__v[0-9]+}}, {{__v[0-9]+}}, {{__v[0-9]+}}) };
// LOWERING-NEXT:     copy = full;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 42;
// LOWERING-NEXT:     copy.x = {{__v[0-9]+}};
