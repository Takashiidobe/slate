...
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"slate_perror_intervening_missing.tmp\0".as_ptr() as *mut i8;
...
// LOWERING-NEXT:             let {{__v[0-9]+}}: *mut i8 = b"remove failed\0".as_ptr() as *mut i8;
