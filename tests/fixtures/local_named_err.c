...
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = describe({{__v[0-9]+}});
...
// LOWERING-NEXT:         } else {
// LOWERING-NEXT:             let {{__v[0-9]+}}: *mut i8 = b"bad\0".as_ptr() as *mut i8;
// LOWERING-NEXT:             Err_ = {{__v[0-9]+}};
// LOWERING-NEXT:         }
// LOWERING-NEXT:     }
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = Err_;
...
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: fn describe(mut {{__v[0-9]+}}: i32) -> *mut i8 {
