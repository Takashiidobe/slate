...
// LOWERING-NEXT:     let _v2: Option<unsafe extern "C" fn(i32) -> i32> = callback.handler;
// LOWERING-NEXT:     let _v3: i32 = 41;
// LOWERING-NEXT:     let _v4: i32 = unsafe { _v2.unwrap()(_v3) };
...
// REWRITES-NEXT: let _v3: i32 = 41;
// REWRITES-NEXT: let _v4: i32 = unsafe { callback.handler.unwrap()(_v3) };
