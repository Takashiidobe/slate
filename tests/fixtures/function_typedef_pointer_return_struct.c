...
// LOWERING-NEXT:         std::mem::transmute::<*const (), Option<unsafe extern "C" fn(*mut i32) -> *mut i32>>(
...
// REWRITES-NEXT:         std::mem::transmute::<*const (), Option<unsafe extern "C" fn(*mut i32) -> *mut i32>>(
