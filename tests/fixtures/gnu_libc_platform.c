...
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = gnu_environment_extensions();
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = gnu_time_extensions();
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = gnu_pattern_extensions();
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = gnu_runtime_extensions();
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"SLATE_GNU_LIBC_VALUE\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"ready\0".as_ptr() as *mut i8;
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} + {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"SLATE_GNU_LIBC_VALUE\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = (unsafe { secure_getenv({{__v[0-9]+}} as *const core::ffi::c_char) }) as *mut i8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"ready\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = unsafe {
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} + {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"SLATE_GNU_LIBC_VALUE\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { unsetenv({{__v[0-9]+}} as *const core::ffi::c_char) };
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} == {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} as i32;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} + {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = (unsafe { get_current_dir_name() }) as *mut i8;
// LOWERING-NEXT:     directory = {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = b".\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 =
// LOWERING-NEXT:         (unsafe { canonicalize_file_name({{__v[0-9]+}} as *const core::ffi::c_char) }) as *mut i8;
// LOWERING-NEXT:     canonical = {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = current.as_mut_ptr() as *mut i8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: u64 = 4096;
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 =
// LOWERING-NEXT:         (unsafe { getcwd({{__v[0-9]+}} as *mut core::ffi::c_char, {{__v[0-9]+}} as usize) }) as *mut i8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut core::ffi::c_void = std::ptr::null_mut();
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = {{__v[0-9]+}} as *mut i8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} as i32;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} + {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = directory;
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut core::ffi::c_void = std::ptr::null_mut();
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = {{__v[0-9]+}} as *mut i8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} as i32;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} + {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = canonical;
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut core::ffi::c_void = std::ptr::null_mut();
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = {{__v[0-9]+}} as *mut i8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = if {{__v[0-9]+}} {
...
// LOWERING-NEXT:     let mut bi_alloca: Vec<u8> = vec![0; {{__v[0-9]+}} as usize];
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut core::ffi::c_void = bi_alloca.as_mut_ptr() as *mut core::ffi::c_void;
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = {{__v[0-9]+}} as *mut i8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"slate\0".as_ptr() as *mut i8;
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} as i32;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} + {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"slate-truncated\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: u64 = 5;
// LOWERING-NEXT:     let {{__v[0-9]+}}: u64 = (unsafe { strnlen({{__v[0-9]+}} as *const core::ffi::c_char, {{__v[0-9]+}} as usize) }) as u64;
// LOWERING-NEXT:     let {{__v[0-9]+}}: u64 = 1;
// LOWERING-NEXT:     let {{__v[0-9]+}}: u64 = {{__v[0-9]+}} + {{__v[0-9]+}};
// LOWERING-NEXT:     let mut bi_alloca2: Vec<u8> = vec![0; {{__v[0-9]+}} as usize];
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut core::ffi::c_void = bi_alloca2.as_mut_ptr() as *mut core::ffi::c_void;
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"slate-truncated\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"slate-truncated\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: u64 = 5;
// LOWERING-NEXT:     let {{__v[0-9]+}}: u64 = (unsafe { strnlen({{__v[0-9]+}} as *const core::ffi::c_char, {{__v[0-9]+}} as usize) }) as u64;
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = __slate_strndupa_finish({{__v[0-9]+}} as *mut core::ffi::c_void, {{__v[0-9]+}}, {{__v[0-9]+}});
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"slate\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = unsafe {
// LOWERING-NEXT:         strcmp(
// LOWERING-NEXT:             {{__v[0-9]+}} as *const core::ffi::c_char,
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 70;
// LOWERING-NEXT:     epoch.tm_year = {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// LOWERING-NEXT:     epoch.tm_mon = {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 1;
// LOWERING-NEXT:     epoch.tm_mday = {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: i64 = unsafe { timegm(std::ptr::addr_of_mut!(epoch) as *mut tm) };
// LOWERING-NEXT:     let {{__v[0-9]+}}: i64 = 0;
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} == {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} as i32;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} + {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 70;
// LOWERING-NEXT:     local.tm_year = {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// LOWERING-NEXT:     local.tm_mon = {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 2;
// LOWERING-NEXT:     local.tm_mday = {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: i64 = unsafe { timelocal(std::ptr::addr_of_mut!(local) as *mut tm) };
...
// LOWERING-NEXT:         __reserved2: [std::ptr::null_mut(); 5],
// LOWERING-NEXT:     };
// LOWERING-NEXT:     paths = {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"file-+(one|two).c\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"file-two.c\0".as_ptr() as *mut i8;
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: u64 = {{__v[0-9]+}} << {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: u64 = {{__v[0-9]+}} | {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: u64 = unsafe { re_set_syntax({{__v[0-9]+}} as u64) };
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"sl(a|e)te\0".as_ptr() as *mut i8;
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"/dev/{null,zero}\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 1024;
// LOWERING-NEXT:     let {{__v[0-9]+}}: Option<unsafe extern "C-unwind" fn(*mut i8, i32) -> i32> = None;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = unsafe {
// LOWERING-NEXT:         glob(
// LOWERING-NEXT:             {{__v[0-9]+}} as *const core::ffi::c_char,
// LOWERING-NEXT:             {{__v[0-9]+}} as i32,
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} as i32;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} + {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: u64 = paths.gl_pathc;
// LOWERING-NEXT:     let {{__v[0-9]+}}: u64 = 2;
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} == {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} as i32;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} + {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: i64 = 0;
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut *mut i8 = paths.gl_pathv;
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut *mut i8 = unsafe { {{__v[0-9]+}}.add(0) };
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = unsafe { *{{__v[0-9]+}} };
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: i64 = 1;
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut *mut i8 = paths.gl_pathv;
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut *mut i8 = unsafe { {{__v[0-9]+}}.add(1) };
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = unsafe { *{{__v[0-9]+}} };
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"/dev/zero\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = unsafe {
// LOWERING-NEXT:         strcmp(
// LOWERING-NEXT:             {{__v[0-9]+}} as *const core::ffi::c_char,
// LOWERING-NEXT:             {{__v[0-9]+}} as *const core::ffi::c_char,
...
// LOWERING-NEXT:     };
// LOWERING-NEXT:     let {{__v[0-9]+}}: Dl_info = Dl_info {
// LOWERING-NEXT:         dli_fname: std::ptr::null_mut(),
// LOWERING-NEXT:         dli_fbase: std::ptr::null_mut(),
// LOWERING-NEXT:         dli_sname: std::ptr::null_mut(),
// LOWERING-NEXT:         dli_saddr: std::ptr::null_mut(),
// LOWERING-NEXT:     };
// LOWERING-NEXT:     information = {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 30;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i64 = unsafe { sysconf({{__v[0-9]+}} as i32) };
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// LOWERING-NEXT:     let {{__v[0-9]+}}: u64 = 6;
// LOWERING-NEXT:     let {{__v[0-9]+}}: u64 = unsafe { getauxval({{__v[0-9]+}} as u64) };
// LOWERING-NEXT:     let {{__v[0-9]+}}: u64 = {{__v[0-9]+}} as u64;
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} == {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} as i32;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} + {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { gettid() };
// LOWERING-NEXT:     let {{__v[0-9]+}}: i64 = 186;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i64 = unsafe { syscall({{__v[0-9]+}} as i64) };
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} as i32;
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} == {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} as i32;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} + {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut u8 = random_bytes.as_mut_ptr() as *mut u8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut core::ffi::c_void = {{__v[0-9]+}} as *mut core::ffi::c_void;
// LOWERING-NEXT:     let {{__v[0-9]+}}: u64 = 8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { getentropy({{__v[0-9]+}} as *mut core::ffi::c_void, {{__v[0-9]+}} as usize) };
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} == {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} as i32;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} + {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: u32 = 1;
// LOWERING-NEXT:     let {{__v[0-9]+}}: u32 = unsafe { arc4random_uniform({{__v[0-9]+}} as u32) };
// LOWERING-NEXT:     let {{__v[0-9]+}}: u32 = 0;
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} == {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} as i32;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} + {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { get_nprocs() };
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} > {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} as i32;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} + {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: i64 = unsafe { get_phys_pages() };
// LOWERING-NEXT:     let {{__v[0-9]+}}: i64 = 0;
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} > {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} as i32;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} + {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut *mut core::ffi::c_void = frames.as_mut_ptr() as *mut *mut core::ffi::c_void;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { backtrace({{__v[0-9]+}} as *mut *mut core::ffi::c_void, {{__v[0-9]+}} as i32) };
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} > {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} as i32;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} + {{__v[0-9]+}};
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} as i32;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} + {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = information.dli_fname;
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut core::ffi::c_void = std::ptr::null_mut();
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = {{__v[0-9]+}} as *mut i8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} as i32;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} + {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: i64 = 0;
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = (unsafe { gnu_get_libc_version() }) as *mut i8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = unsafe { {{__v[0-9]+}}.add(0) };
// LOWERING-NEXT:     let {{__v[0-9]+}}: i8 = unsafe { *{{__v[0-9]+}} };
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} as i32;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} as i32;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} + {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = unsafe { program_invocation_name };
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut core::ffi::c_void = std::ptr::null_mut();
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = {{__v[0-9]+}} as *mut i8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} as i32;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} + {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = unsafe { program_invocation_short_name };
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut core::ffi::c_void = std::ptr::null_mut();
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = {{__v[0-9]+}} as *mut i8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} as i32;
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = unsafe { {{__v[0-9]+}}.add({{arg[0-9]+}} as usize) };
...
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = gnu_environment_extensions();
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = gnu_time_extensions();
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = gnu_pattern_extensions();
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = gnu_runtime_extensions();
...
// REWRITES-NEXT:     let {{__v[0-9]+}}: *mut i8 = (unsafe { secure_getenv(c"SLATE_GNU_LIBC_VALUE".as_ptr()) }) as *mut i8;
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { strcmp({{__v[0-9]+}} as *const core::ffi::c_char, c"ready".as_ptr()) };
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} + (({{__v[0-9]+}} == 0) as i32);
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { unsetenv(c"SLATE_GNU_LIBC_VALUE".as_ptr()) };
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} + (({{__v[0-9]+}} == 0) as i32);
...
// REWRITES-NEXT:     let {{__v[0-9]+}}: *mut i8 = current.as_mut_ptr() as *mut i8;
// REWRITES-NEXT:     let {{__v[0-9]+}}: *mut i8 =
// REWRITES-NEXT:         (unsafe { getcwd({{__v[0-9]+}} as *mut core::ffi::c_char, (4096 as u64) as usize) }) as *mut i8;
// REWRITES-NEXT:     let {{__v[0-9]+}}: *mut core::ffi::c_void = std::ptr::null_mut();
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} + (({{__v[0-9]+}} != ({{__v[0-9]+}} as *mut i8)) as i32);
// REWRITES-NEXT:     let {{__v[0-9]+}}: *mut core::ffi::c_void = std::ptr::null_mut();
// REWRITES-NEXT:     let {{__v[0-9]+}}: bool = directory != ({{__v[0-9]+}} as *mut i8);
// REWRITES-NEXT:     let {{__v[0-9]+}}: bool = if {{__v[0-9]+}} {
// REWRITES-NEXT:         let {{__v[0-9]+}}: *mut i8 = directory;
// REWRITES-NEXT:         let {{__v[0-9]+}}: *mut i8 = current.as_mut_ptr() as *mut i8;
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = unsafe {
...
// REWRITES-NEXT:     let {{__v[0-9]+}}: *mut core::ffi::c_void = std::ptr::null_mut();
// REWRITES-NEXT:     let {{__v[0-9]+}}: bool = canonical != ({{__v[0-9]+}} as *mut i8);
// REWRITES-NEXT:     let {{__v[0-9]+}}: bool = if {{__v[0-9]+}} {
// REWRITES-NEXT:         let {{__v[0-9]+}}: *mut i8 = canonical;
// REWRITES-NEXT:         let {{__v[0-9]+}}: *mut i8 = current.as_mut_ptr() as *mut i8;
// REWRITES-NEXT:         let {{__v[0-9]+}}: i32 = unsafe {
// REWRITES-NEXT:             strcmp(
// REWRITES-NEXT:                 {{__v[0-9]+}} as *const core::ffi::c_char,
...
// REWRITES-NEXT:     let mut bi_alloca: Vec<u8> = vec![0; (5 + {{__v[0-9]+}}) as usize];
// REWRITES-NEXT:     let {{__v[0-9]+}}: *mut core::ffi::c_void = bi_alloca.as_mut_ptr() as *mut core::ffi::c_void;
// REWRITES-NEXT:     let {{__v[0-9]+}}: *mut i8 =
// REWRITES-NEXT:         (unsafe { strcpy({{__v[0-9]+}} as *mut core::ffi::c_char, c"slate".as_ptr()) }) as *mut i8;
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { strcmp({{__v[0-9]+}} as *const core::ffi::c_char, c"slate".as_ptr()) };
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} + (({{__v[0-9]+}} == 0) as i32);
...
// REWRITES-NEXT:     let mut bi_alloca2: Vec<u8> = vec![0; ({{__v[0-9]+}} + 1) as usize];
// REWRITES-NEXT:     let {{__v[0-9]+}}: *mut core::ffi::c_void = bi_alloca2.as_mut_ptr() as *mut core::ffi::c_void;
// REWRITES-NEXT:     let {{__v[0-9]+}}: *mut i8 = c"slate-truncated".as_ptr() as *mut i8;
// REWRITES-NEXT:     let {{__v[0-9]+}}: u64 = (unsafe {
// REWRITES-NEXT:         "slate-truncated"
// REWRITES-NEXT:             .as_bytes()
// REWRITES-NEXT:             .iter()
...
// REWRITES-NEXT:             .min((5 as u64) as usize)
// REWRITES-NEXT:     }) as u64;
// REWRITES-NEXT:     let {{__v[0-9]+}}: *mut i8 = __slate_strndupa_finish({{__v[0-9]+}} as *mut core::ffi::c_void, {{__v[0-9]+}}, {{__v[0-9]+}});
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { strcmp({{__v[0-9]+}} as *const core::ffi::c_char, c"slate".as_ptr()) };
...
// REWRITES-NEXT:     let {{__v[0-9]+}}: i64 = unsafe { timegm(std::ptr::addr_of_mut!(epoch) as *mut tm) };
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} + (({{__v[0-9]+}} == 0) as i32);
// REWRITES-NEXT:     local.tm_year = 70;
// REWRITES-NEXT:     local.tm_mon = 0;
// REWRITES-NEXT:     local.tm_mday = 2;
// REWRITES-NEXT:     let {{__v[0-9]+}}: i64 = unsafe { timelocal(std::ptr::addr_of_mut!(local) as *mut tm) };
// REWRITES-NEXT:     {{__v[0-9]+}} + (({{__v[0-9]+}} != -1) as i32)
// REWRITES-NEXT: }
// REWRITES-EMPTY:
...
// REWRITES-NEXT:         )
// REWRITES-NEXT:     };
// REWRITES-NEXT:     let {{__v[0-9]+}}: *mut i8 = (unsafe {
...
// REWRITES-NEXT:     let {{__v[0-9]+}}: Option<unsafe extern "C-unwind" fn(*mut i8, i32) -> i32> = None;
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = unsafe {
// REWRITES-NEXT:         glob(
...
// REWRITES-NEXT:         )
// REWRITES-NEXT:     };
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} + (({{__v[0-9]+}} == 0) as i32) + ((paths.gl_pathc == 2) as i32);
// REWRITES-NEXT:     let {{__v[0-9]+}}: *mut *mut i8 = paths.gl_pathv;
// REWRITES-NEXT:     let {{__v[0-9]+}}: *mut *mut i8 = unsafe { {{__v[0-9]+}}.add(0) };
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = unsafe {
// REWRITES-NEXT:         strcmp(
// REWRITES-NEXT:             (unsafe { *{{__v[0-9]+}} }) as *const core::ffi::c_char,
// REWRITES-NEXT:             c"/dev/null".as_ptr(),
// REWRITES-NEXT:         )
// REWRITES-NEXT:     };
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} + (({{__v[0-9]+}} == 0) as i32);
// REWRITES-NEXT:     let {{__v[0-9]+}}: *mut *mut i8 = paths.gl_pathv;
// REWRITES-NEXT:     let {{__v[0-9]+}}: *mut *mut i8 = unsafe { {{__v[0-9]+}}.add(1) };
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = unsafe {
// REWRITES-NEXT:         strcmp(
// REWRITES-NEXT:             (unsafe { *{{__v[0-9]+}} }) as *const core::ffi::c_char,
...
// REWRITES-NEXT:         dli_saddr: std::ptr::null_mut(),
// REWRITES-NEXT:     };
// REWRITES-NEXT:     let {{__v[0-9]+}}: i64 = unsafe { sysconf(30 as i32) };
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// REWRITES-NEXT:     let {{__v[0-9]+}}: u64 = unsafe { getauxval(6 as u64) };
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} + (({{__v[0-9]+}} == ({{__v[0-9]+}} as u64)) as i32);
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { gettid() };
// REWRITES-NEXT:     let {{__v[0-9]+}}: i64 = unsafe { syscall(186 as i64) };
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} + (({{__v[0-9]+}} == ({{__v[0-9]+}} as i32)) as i32);
// REWRITES-NEXT:     let {{__v[0-9]+}}: *mut u8 = random_bytes.as_mut_ptr() as *mut u8;
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { getentropy({{__v[0-9]+}} as *mut core::ffi::c_void, (8 as u64) as usize) };
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} + (({{__v[0-9]+}} == 0) as i32);
// REWRITES-NEXT:     let {{__v[0-9]+}}: u32 = unsafe { arc4random_uniform(1 as u32) };
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} + (({{__v[0-9]+}} == 0) as i32);
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { get_nprocs() };
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} + (({{__v[0-9]+}} > 0) as i32);
// REWRITES-NEXT:     let {{__v[0-9]+}}: i64 = unsafe { get_phys_pages() };
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} + (({{__v[0-9]+}} > 0) as i32);
// REWRITES-NEXT:     let {{__v[0-9]+}}: *mut *mut core::ffi::c_void = frames.as_mut_ptr() as *mut *mut core::ffi::c_void;
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { backtrace({{__v[0-9]+}} as *mut *mut core::ffi::c_void, 8 as i32) };
// REWRITES-NEXT:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} + (({{__v[0-9]+}} > 0) as i32);
...
// REWRITES-NEXT:         {{__v[0-9]+}} + (({{__v[0-9]+}} != 0) as i32) + ((information.dli_fname != ({{__v[0-9]+}} as *mut i8)) as i32);
// REWRITES-NEXT:     let {{__v[0-9]+}}: *mut i8 = (unsafe { gnu_get_libc_version() }) as *mut i8;
// REWRITES-NEXT:     let {{__v[0-9]+}}: *mut i8 = unsafe { {{__v[0-9]+}}.add(0) };
// REWRITES-NEXT:     let {{__v[0-9]+}}: *mut core::ffi::c_void = std::ptr::null_mut();
// REWRITES-NEXT:     let {{__v[0-9]+}}: *mut core::ffi::c_void = std::ptr::null_mut();
// REWRITES-NEXT:     {{__v[0-9]+}} + ((((unsafe { *{{__v[0-9]+}} }) as i32) != 0) as i32)
// REWRITES-NEXT:         + (((unsafe { program_invocation_name }) != ({{__v[0-9]+}} as *mut i8)) as i32)
// REWRITES-NEXT:         + (((unsafe { program_invocation_short_name }) != ({{__v[0-9]+}} as *mut i8)) as i32)
// REWRITES-NEXT: }
// REWRITES-EMPTY:
...
// REWRITES-NEXT:         )
// REWRITES-NEXT:     };
// REWRITES-NEXT:     let {{__v[0-9]+}}: i8 = 0;
// REWRITES-NEXT:     let {{__v[0-9]+}}: *mut i8 = unsafe { {{__v[0-9]+}}.add({{arg[0-9]+}} as usize) };
// REWRITES-NEXT:     unsafe {
