...
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: u32 = 400;
...
// COMMON-REWRITES-NEXT:     let {{__v[0-9]+}}: u32 = 400;
// COMMON-REWRITES-NEXT:     unsafe {
// COMMON-REWRITES-NEXT:         printf(
// COMMON-REWRITES-NEXT:             c"%.2hhd %.3hd %#hhx %08hhx\n".as_ptr(),
...
// COMMON-REWRITES-NEXT:         )
// COMMON-REWRITES-NEXT:     };
// COMMON-REWRITES-NEXT:     unsafe { printf(c"%.4hho %.2hhx %hhu\n".as_ptr(), {{__v[0-9]+}}, {{__v[0-9]+}}, {{__v[0-9]+}}) };
// COMMON-REWRITES-NEXT:     unsafe { printf(c"%.5hd %#hx\n".as_ptr(), {{__v[0-9]+}}, {{__v[0-9]+}}) };
