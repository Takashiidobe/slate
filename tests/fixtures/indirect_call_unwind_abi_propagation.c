...
// LOWERING-NEXT:                             }
// LOWERING-NEXT:                             let {{__v[0-9]+}}: *mut i8 = b"recovered quiet %d\n\0".as_ptr() as *mut i8;
// LOWERING-NEXT:                             let {{__v[0-9]+}}: i32 = i;
...
// LOWERING-NEXT:                         }
// LOWERING-NEXT:                     }
// LOWERING-NEXT:                     let {{__v[0-9]+}}: Option<unsafe extern "C-unwind" fn(i32, i32)> = c.run;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i32 = i;
// LOWERING-NEXT:                     let {{__v[0-9]+}}: i32 = 0;
...
// LOWERING-NEXT:                                 failures = {{__v[0-9]+}};
// LOWERING-NEXT:                             }
// LOWERING-NEXT:                             let {{__v[0-9]+}}: *mut i8 = b"recovered panicky %d\n\0".as_ptr() as *mut i8;
// LOWERING-NEXT:                             let {{__v[0-9]+}}: i32 = i2;
// LOWERING-NEXT:                             let {{__v[0-9]+}}: i32 =
// LOWERING-NEXT:                                 unsafe { printf({{__v[0-9]+}} as *const core::ffi::c_char, {{__v[0-9]+}}) };
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"quiet %d\n\0".as_ptr() as *mut i8;
...
// LOWERING-NEXT:         }
// LOWERING-NEXT:     }
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"panicky %d\n\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = x;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { printf({{__v[0-9]+}} as *const core::ffi::c_char, {{__v[0-9]+}}) };
// LOWERING-NEXT:     return;
// LOWERING-NEXT: }
...
// REWRITES-NEXT:     '__loop0: while i < 2 {
