...
// LOWERING-NEXT: }
// LOWERING-EMPTY:
// LOWERING-NEXT: extern "C" fn dispatcher(arg2: i32, arg3: i32) {
// LOWERING-NEXT:     let mut x: i32 = 0;
// LOWERING-NEXT:     let mut y: i32 = 0;
// LOWERING-NEXT:     x = arg2;
// LOWERING-NEXT:     y = arg3;
// LOWERING-NEXT:     let _v0: i32 = y;
// LOWERING-NEXT:     let _v1: Option<unsafe extern "C" fn(i32)> = unsafe { g_callback };
// LOWERING-NEXT:     let _v2: i32 = x;
// LOWERING-NEXT:     unsafe { _v1.unwrap()(_v2) };
// LOWERING-NEXT:     return;
// LOWERING-NEXT: }
// LOWERING-EMPTY:
// LOWERING-NEXT: extern "C" fn quiet_callback(arg1: i32) {
// LOWERING-NEXT:     let mut x: i32 = 0;
// LOWERING-NEXT:     x = arg1;
// LOWERING-NEXT:     let _v0: *mut i8 = b"quiet %d\n\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let _v1: i32 = x;
// LOWERING-NEXT:     let _v2: i32 = unsafe { printf(_v0 as *const i8, _v1) };
// LOWERING-NEXT:     return;
// LOWERING-NEXT: }
// LOWERING-EMPTY:
// LOWERING-NEXT: extern "C" fn panicky_callback(arg0: i32) {
// LOWERING-NEXT:     let mut x: i32 = 0;
...
// LOWERING-NEXT:         }
// LOWERING-NEXT:     }
// LOWERING-NEXT:     let _v5: *mut i8 = b"panicky %d\n\0".as_ptr() as *mut i8;
...
// LOWERING-NEXT:     c.run = unsafe { std::mem::transmute::<*const (), Option<unsafe extern "C" fn(i32, i32)>>(dispatcher as *const ()) };
// LOWERING-NEXT:     unsafe {
// LOWERING-NEXT:         g_callback = unsafe { std::mem::transmute::<*const (), Option<unsafe extern "C" fn(i32)>>(quiet_callback as *const ()) };
// LOWERING-NEXT:     }
// LOWERING-NEXT:     {
...
// LOWERING-NEXT:                             }
// LOWERING-NEXT:                             let _v10: *mut i8 = b"recovered quiet %d\n\0".as_ptr() as *mut i8;
...
// LOWERING-NEXT:                         }
// LOWERING-NEXT:                     }
// LOWERING-NEXT:                     let _v13: Option<unsafe extern "C" fn(i32, i32)> = c.run;
// LOWERING-NEXT:                     let _v14: i32 = i;
// LOWERING-NEXT:                     let _v15: i32 = 0;
// LOWERING-NEXT:                     unsafe { _v13.unwrap()(_v14, _v15) };
// LOWERING-NEXT:                 }
// LOWERING-NEXT:             }
...
// LOWERING-NEXT:                             }
// LOWERING-NEXT:                             let _v27: *mut i8 = b"recovered panicky %d\n\0".as_ptr() as *mut i8;
...
// LOWERING-NEXT:                         }
// LOWERING-NEXT:                     }
// LOWERING-NEXT:                     let _v30: Option<unsafe extern "C" fn(i32, i32)> = c.run;
// LOWERING-NEXT:                     let _v31: i32 = i2;
// LOWERING-NEXT:                     let _v32: i32 = 0;
// LOWERING-NEXT:                     unsafe { _v30.unwrap()(_v31, _v32) };
// LOWERING-NEXT:                 }
// LOWERING-NEXT:             }
...
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: extern "C" fn dispatcher(arg2: i32, arg3: i32) {
// REWRITES-NEXT: let mut x: i32 = arg2;
// REWRITES-NEXT: let mut y: i32 = arg3;
// REWRITES-NEXT: let _v0: i32 = y;
// REWRITES-NEXT: unsafe { unsafe { g_callback }.unwrap()(x) };
// REWRITES-NEXT: return;
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: extern "C" fn quiet_callback(arg1: i32) {
// REWRITES-NEXT: let mut x: i32 = arg1;
// REWRITES-NEXT: let _v0: *mut i8 = b"quiet %d\n\0".as_ptr() as *mut i8;
// REWRITES-NEXT: let _v2: i32 = unsafe { printf(_v0 as *const i8, x) };
// REWRITES-NEXT: return;
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: extern "C" fn panicky_callback(arg0: i32) {
...
// REWRITES-NEXT:         }
// REWRITES-NEXT: }
// REWRITES-NEXT: let _v5: *mut i8 = b"panicky %d\n\0".as_ptr() as *mut i8;
...
// REWRITES-NEXT: c.run = unsafe { std::mem::transmute::<*const (), Option<unsafe extern "C" fn(i32, i32)>>(dispatcher as *const ()) };
// REWRITES-NEXT: unsafe {
// REWRITES-NEXT:         g_callback = unsafe { std::mem::transmute::<*const (), Option<unsafe extern "C" fn(i32)>>(quiet_callback as *const ()) };
// REWRITES-NEXT: }
// REWRITES-NEXT: {
