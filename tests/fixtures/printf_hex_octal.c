...
// LOWERING-NEXT:     let {{_v[0-9]+}}: u64 = 511;
...
// LOWERING-NEXT:     let {{_v[0-9]+}}: *mut i8 = b"%08x|%-4X|%5o\n\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let {{_v[0-9]+}}: u32 = mask;
// LOWERING-NEXT:     let {{_v[0-9]+}}: u32 = mask;
// LOWERING-NEXT:     let {{_v[0-9]+}}: u32 = mask;
// LOWERING-NEXT:     let {{_v[0-9]+}}: i32 = unsafe { printf({{_v[0-9]+}} as *const i8, {{_v[0-9]+}}, {{_v[0-9]+}}, {{_v[0-9]+}}) };
...
// REWRITES-NEXT: let {{_v[0-9]+}}: i32 = unsafe { printf({{_v[0-9]+}} as *const i8, value, mask, wide) };
// REWRITES-NEXT: let {{_v[0-9]+}}: *mut i8 = b"%08x|%-4X|%5o\n\0".as_ptr() as *mut i8;
// REWRITES-NEXT: let {{_v[0-9]+}}: i32 = unsafe { printf({{_v[0-9]+}} as *const i8, mask, mask, mask) };
// REWRITES-NEXT: __retval = 0;
