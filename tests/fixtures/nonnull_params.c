...
// LOWERING-NEXT: }
// LOWERING-EMPTY:
// LOWERING-NEXT: unsafe fn add(arg0: *mut i32, arg1: *mut i32) -> i32 {
...
// LOWERING-NEXT:     let _v4: i32 = unsafe { add(std::ptr::addr_of_mut!(x), std::ptr::addr_of_mut!(y)) };
...
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: unsafe fn add(arg0: *mut i32, arg1: *mut i32) -> i32 {
...
// REWRITES-NEXT: let _v4: i32 = unsafe { add(std::ptr::addr_of_mut!(x), std::ptr::addr_of_mut!(y)) };
