...
// COMMON-LOWERING-DAG: let {{__v[0-9]+}}: *mut u8 = dst_a.as_mut_ptr() as *mut u8;
// COMMON-LOWERING-DAG: let {{__v[0-9]+}}: *mut core::ffi::c_void = {{__v[0-9]+}} as *mut core::ffi::c_void;
// COMMON-LOWERING-DAG: let {{__v[0-9]+}}: *mut u8 = src_a.as_mut_ptr() as *mut u8;
// COMMON-LOWERING-DAG: let {{__v[0-9]+}}: *mut core::ffi::c_void = {{__v[0-9]+}} as *mut core::ffi::c_void;
...
// COMMON-REWRITES-DAG: dst_a.as_mut_ptr() as *mut u8;
// COMMON-REWRITES-DAG: src_a.as_mut_ptr() as *mut u8;
// COMMON-REWRITES-DAG: unsafe { dst_a[(0usize..4usize)].copy_from_slice(&src_a[(0usize..4usize)]) };
// COMMON-REWRITES-DAG: dst_b.as_mut_ptr() as *mut u8;
// COMMON-REWRITES-DAG: src_b.as_mut_ptr() as *mut u8;
// COMMON-REWRITES-DAG: unsafe { dst_b[(0usize..5usize)].copy_from_slice(&src_b[(0usize..5usize)]) };
// COMMON-REWRITES-DAG: self_c.as_mut_ptr() as *mut u8;
// COMMON-REWRITES-DAG: self_c.as_mut_ptr() as *mut u8;
// COMMON-REWRITES-DAG: unsafe { self_c.copy_within(0usize..8usize, 0usize) };
// COMMON-REWRITES-DAG: dst_d.as_mut_ptr() as *mut u8;
// COMMON-REWRITES-DAG: unsafe { dst_d[(0usize..5usize)].fill((65 as i32) as u8) };
// COMMON-REWRITES-DAG: let {{__v[0-9]+}}: *mut u8 = dst_e.as_mut_ptr() as *mut u8;
// COMMON-REWRITES-DAG: let {{__v[0-9]+}}: *mut core::ffi::c_void = {{__v[0-9]+}} as *mut core::ffi::c_void;
// COMMON-REWRITES-DAG: let {{__v[0-9]+}}: *mut u8 = src_e.as_mut_ptr() as *mut u8;
// COMMON-REWRITES-DAG: let {{__v[0-9]+}}: *mut u8 = unsafe { {{__v[0-9]+}}.add(2) };
...
// COMMON-REWRITES-DAG: };
// COMMON-REWRITES-DAG: let {{__v[0-9]+}}: *mut u8 = dst_f.as_mut_ptr() as *mut u8;
// COMMON-REWRITES-DAG: let {{__v[0-9]+}}: *mut core::ffi::c_void = {{__v[0-9]+}} as *mut core::ffi::c_void;
// COMMON-REWRITES-DAG: let {{__v[0-9]+}}: *mut u8 = src_f.as_mut_ptr() as *mut u8;
// COMMON-REWRITES-DAG: unsafe {
...
// COMMON-REWRITES-DAG:     )
// COMMON-REWRITES-DAG: };
// COMMON-REWRITES-DAG: let {{__v[0-9]+}}: *mut u8 = dst_g.as_mut_ptr() as *mut u8;
// COMMON-REWRITES-DAG: unsafe {
// COMMON-REWRITES-DAG:     std::ptr::copy_nonoverlapping({{__v[0-9]+}} as *const u8, {{__v[0-9]+}} as *mut u8, (4 as u64) as usize)
// COMMON-REWRITES-DAG: };
