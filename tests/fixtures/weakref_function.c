...
// COMMON-LOWERING: #![feature(linkage)]
...
// COMMON-LOWERING-NEXT:     #[linkage = "extern_weak"]
// COMMON-LOWERING-NEXT:     static abs: Option<unsafe extern "C-unwind" fn(i32) -> i32>;
// COMMON-LOWERING-NEXT: }
// COMMON-LOWERING-EMPTY:
// COMMON-LOWERING-NEXT: fn weakref_target({{arg[0-9]+}}: i32) -> i32 {
...
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = weakref_target({{__v[0-9]+}});
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 41;
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = weakref_target({{__v[0-9]+}});
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = -53;
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { abs.unwrap()({{__v[0-9]+}} as i32) };
...
// COMMON-REWRITES: #![feature(linkage)]
...
// COMMON-REWRITES-NEXT:     #[linkage = "extern_weak"]
// COMMON-REWRITES-NEXT:     static abs: Option<unsafe extern "C-unwind" fn(i32) -> i32>;
// COMMON-REWRITES-NEXT: }
// COMMON-REWRITES-EMPTY:
// COMMON-REWRITES-NEXT: fn weakref_target({{arg[0-9]+}}: i32) -> i32 {
...
// COMMON-REWRITES-NEXT:             weakref_target(35 as i32),
// COMMON-REWRITES-NEXT:             weakref_target(41),
// COMMON-REWRITES-NEXT:             unsafe { abs.unwrap()(-53 as i32) },
// COMMON-REWRITES-NEXT:         )
// COMMON-REWRITES-NEXT:     };
