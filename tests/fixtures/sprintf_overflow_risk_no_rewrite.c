...
// LOWERING-NEXT:     let _v2: *mut i8 = b"%d\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let _v3: i32 = 7;
// LOWERING-NEXT:     let _v4: i32 = unsafe { sprintf(_v1 as *mut i8, _v2 as *const i8, _v3) };
// LOWERING-NEXT:     let _v5: *mut i8 = buf.as_mut_ptr() as *mut i8;
// LOWERING-NEXT:     let _v6: i32 = unsafe { puts(_v5 as *const i8) };
...
// REWRITES-NEXT: let _v2: *mut i8 = b"%d\0".as_ptr() as *mut i8;
// REWRITES-NEXT: let _v3: i32 = 7;
// REWRITES-NEXT: let _v4: i32 = unsafe { sprintf(_v1 as *mut i8, _v2 as *const i8, _v3) };
// REWRITES-NEXT: let _v5: *mut i8 = buf.as_mut_ptr() as *mut i8;
// REWRITES-NEXT: let _v6: i32 = unsafe { puts(_v5 as *const i8) };
// REWRITES-NEXT: __retval = 0;
