...
// REWRITES-NEXT: let {{_v[0-9]+}}: u64 = 4;
// REWRITES-NEXT: let {{_v[0-9]+}}: u64 = 4;
// REWRITES-NEXT: let {{_v[0-9]+}}: *mut core::ffi::c_void = unsafe { realloc(({{_v[0-9]+}} as *mut core::ffi::c_void) as *mut core::ffi::c_void, ({{_v[0-9]+}} * {{_v[0-9]+}}) as usize) };
// REWRITES-NEXT: let {{_v[0-9]+}}: *mut i32 = {{_v[0-9]+}} as *mut i32;
...
// REWRITES-NEXT: let {{_v[0-9]+}}: i32 = {{_v[0-9]+}} + unsafe { *{{_v[0-9]+}} };
// REWRITES-NEXT: let {{_v[0-9]+}}: *mut i32 = unsafe { {{_v[0-9]+}}.add(3) };
// REWRITES-NEXT: unsafe { printf({{_v[0-9]+}} as *const i8, {{_v[0-9]+}} + unsafe { *{{_v[0-9]+}} }) };
