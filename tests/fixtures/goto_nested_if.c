...
// COMMON-REWRITES-NEXT:     a = 3;
// COMMON-REWRITES-NEXT:     b = -1;
// COMMON-REWRITES-NEXT:     if a > 0 {
// COMMON-REWRITES-NEXT:         if b > 0 {
// COMMON-REWRITES-NEXT:             r = 1;
// COMMON-REWRITES-NEXT:         } else {
// COMMON-REWRITES-NEXT:             r = 2;
// COMMON-REWRITES-NEXT:         }
// COMMON-REWRITES-NEXT:     } else {
// COMMON-REWRITES-NEXT:         r = 3;
// COMMON-REWRITES-NEXT:     }
