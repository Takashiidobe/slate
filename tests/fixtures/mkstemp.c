...
// LOWERING-NEXT:     let {{__v[0-9]+}}: [i8; 13] = [115, 108, 97, 116, 101, 45, 88, 88, 88, 88, 88, 88, 0];
// LOWERING-NEXT:     path = {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = path.as_mut_ptr() as *mut i8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { mkstemp({{__v[0-9]+}} as *mut core::ffi::c_char) };
// LOWERING-NEXT:     fd = {{__v[0-9]+}};
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"%d\n\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = fd;
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
...
// LOWERING-NEXT:             let {{__v[0-9]+}}: i32 = fd;
// LOWERING-NEXT:             let {{__v[0-9]+}}: i32 = unsafe { close({{__v[0-9]+}} as i32) };
// LOWERING-NEXT:             let {{__v[0-9]+}}: *mut i8 = path.as_mut_ptr() as *mut i8;
...
// REWRITES-NEXT:     let {{__v[0-9]+}}: *mut i8 = path.as_mut_ptr() as *mut i8;
