...
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"%s %c %c %d\n\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"tag\0".as_ptr() as *mut i8;
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"literal=%s\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"tail\0".as_ptr() as *mut i8;
