...
// LOWERING-NEXT: }
// LOWERING-EMPTY:
// LOWERING-NEXT: fn imod(arg0: i32, arg1: i32) -> i32 {
...
// LOWERING-NEXT:     let _v4: i32 = imod(_v2, _v3);
...
// LOWERING-NEXT:     let _v9: i32 = imod(_v7, _v8);
...
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: fn imod(arg0: i32, arg1: i32) -> i32 {
...
// REWRITES-NEXT: let _v4: i32 = imod(_v2, _v3);
...
// REWRITES-NEXT: let _v9: i32 = imod(_v7, _v8);
