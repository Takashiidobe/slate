...
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = imod({{__v[0-9]+}}, {{__v[0-9]+}});
...
// REWRITES-NEXT:     println!("{}", imod(-7, 3));
// REWRITES-NEXT:     let _ = std::io::Write::flush(&mut std::io::stdout());
// REWRITES-NEXT:     println!("{}", imod(7, -3));
// REWRITES-NEXT:     let _ = std::io::Write::flush(&mut std::io::stdout());
// REWRITES-NEXT:     let {{__v[0-9]+}}: u32 = 7;
// REWRITES-NEXT:     let {{__v[0-9]+}}: u32 = 100 % {{__v[0-9]+}};
// REWRITES-NEXT:     let _ = std::io::Write::flush(&mut std::io::stdout());
