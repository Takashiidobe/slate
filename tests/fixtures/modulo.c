...
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = imod({{__v[0-9]+}}, {{__v[0-9]+}});
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { printf({{__v[0-9]+}} as *const core::ffi::c_char, {{__v[0-9]+}}) };
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 7;
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = -3;
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = imod({{__v[0-9]+}}, {{__v[0-9]+}});
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = unsafe { printf({{__v[0-9]+}} as *const core::ffi::c_char, {{__v[0-9]+}}) };
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: u32 = 100;
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: u32 = 7;
...
// COMMON-LOWERING-NEXT: }
// COMMON-LOWERING-EMPTY:
// COMMON-LOWERING-NEXT: fn imod({{arg[0-9]+}}: i32, {{arg[0-9]+}}: i32) -> i32 {
...
// COMMON-REWRITES-NEXT:     unsafe { printf(c"%d\n".as_ptr(), imod(7, -3)) };
// COMMON-REWRITES-NEXT:     let {{__v[0-9]+}}: u32 = 7;
// COMMON-REWRITES-NEXT:     let {{__v[0-9]+}}: u32 = 100 % {{__v[0-9]+}};
// COMMON-REWRITES-NEXT:     unsafe { printf(c"%u\n".as_ptr(), {{__v[0-9]+}}) };
// COMMON-REWRITES-NEXT:     std::process::exit(0 as i32);
// COMMON-REWRITES-NEXT: }
// COMMON-REWRITES-EMPTY:
// COMMON-REWRITES-NEXT: fn imod({{arg[0-9]+}}: i32, {{arg[0-9]+}}: i32) -> i32 {
