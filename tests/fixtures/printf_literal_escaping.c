...
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: u32 = 171;
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 88;
...
// COMMON-REWRITES-NEXT:             c"{%d} %% \"quoted\" back\\slash %s|%c|%x\n".as_ptr(),
// COMMON-REWRITES-NEXT:             {{__v[0-9]+}},
// COMMON-REWRITES-NEXT:             88 as i32,
// COMMON-REWRITES-NEXT:             171 as u32,
// COMMON-REWRITES-NEXT:         )
// COMMON-REWRITES-NEXT:     };
