...
// LOWERING-X86_64-GNU-NEXT:     v: LongDouble,
// LOWERING-AARCH64-GNU-NEXT:     v: f128,
// LOWERING-NEXT: }
// LOWERING-EMPTY:
...
// LOWERING-X86_64-GNU-NEXT:         v: LongDouble([0; 10]),
// LOWERING-X86_64-GNU-NEXT:     };
// LOWERING-AARCH64-GNU-NEXT:     let mut b: ld_box = ld_box { v: 0.0f128 };
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
// LOWERING-NEXT:     let {{__v[0-9]+}}: ld_box = ld_box {
// LOWERING-X86_64-GNU-NEXT:         v: LongDouble([120, 111, 94, 77, 60, 43, 26, 137, 59, 64]),
// LOWERING-AARCH64-GNU-NEXT:         v: 1234907033823333871.0625f128,
// LOWERING-NEXT:     };
// LOWERING-NEXT:     b = {{__v[0-9]+}};
// LOWERING-X86_64-GNU-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"before\0".as_ptr() as *mut i8;
// LOWERING-X86_64-GNU-NEXT:     let {{__v[0-9]+}}: LongDouble = b.v;
// LOWERING-AARCH64-GNU-NEXT:     let {{__v[0-9]+}}: *mut u8 = b"before\0".as_ptr() as *mut u8;
// LOWERING-AARCH64-GNU-NEXT:     let {{__v[0-9]+}}: f128 = b.v;
...
// LOWERING-NEXT:     b.v = {{__v[0-9]+}};
// LOWERING-X86_64-GNU-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"after\0".as_ptr() as *mut i8;
// LOWERING-X86_64-GNU-NEXT:     let {{__v[0-9]+}}: LongDouble = b.v;
// LOWERING-AARCH64-GNU-NEXT:     let {{__v[0-9]+}}: *mut u8 = b"after\0".as_ptr() as *mut u8;
// LOWERING-AARCH64-GNU-NEXT:     let {{__v[0-9]+}}: f128 = b.v;
// LOWERING-NEXT:     dump80({{__v[0-9]+}}, {{__v[0-9]+}});
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = 0;
...
// REWRITES-X86_64-GNU-NEXT:     v: LongDouble,
// REWRITES-AARCH64-GNU-NEXT:     v: f128,
// REWRITES-NEXT: }
// REWRITES-EMPTY:
...
// REWRITES-X86_64-GNU-NEXT:         v: LongDouble([0; 10]),
// REWRITES-AARCH64-GNU-NEXT:     let mut b: ld_box = ld_box { v: 0.0f128 };
// REWRITES-AARCH64-GNU-NEXT:     let {{__v[0-9]+}}: ld_box = ld_box {
// REWRITES-AARCH64-GNU-NEXT:         v: 1234907033823333871.0625f128,
// REWRITES-NEXT:     };
// REWRITES-X86_64-GNU-NEXT:     b = ld_box {
// REWRITES-X86_64-GNU-NEXT:         v: LongDouble([120, 111, 94, 77, 60, 43, 26, 137, 59, 64]),
// REWRITES-X86_64-GNU-NEXT:     };
// REWRITES-X86_64-GNU-NEXT:     let {{__v[0-9]+}}: LongDouble = b.v;
// REWRITES-X86_64-GNU-NEXT:     dump80(c"before".as_ptr() as *mut i8, {{__v[0-9]+}});
// REWRITES-X86_64-GNU-NEXT:     b.v += LongDouble([0, 0, 0, 0, 0, 0, 0, 128, 255, 63]);
// REWRITES-X86_64-GNU-NEXT:     let {{__v[0-9]+}}: LongDouble = b.v;
// REWRITES-X86_64-GNU-NEXT:     dump80(c"after".as_ptr() as *mut i8, {{__v[0-9]+}});
// REWRITES-AARCH64-GNU-NEXT:     b = {{__v[0-9]+}};
// REWRITES-AARCH64-GNU-NEXT:     let {{__v[0-9]+}}: f128 = b.v;
// REWRITES-AARCH64-GNU-NEXT:     dump80(c"before".as_ptr() as *mut u8, {{__v[0-9]+}});
// REWRITES-AARCH64-GNU-NEXT:     let {{__v[0-9]+}}: f128 = b.v;
// REWRITES-AARCH64-GNU-NEXT:     let {{__v[0-9]+}}: f128 = 1.000000e+00f128;
// REWRITES-AARCH64-GNU-NEXT:     b.v = {{__v[0-9]+}} + {{__v[0-9]+}};
// REWRITES-AARCH64-GNU-NEXT:     let {{__v[0-9]+}}: f128 = b.v;
// REWRITES-AARCH64-GNU-NEXT:     dump80(c"after".as_ptr() as *mut u8, {{__v[0-9]+}});
