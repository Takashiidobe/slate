...
// COMMON-LOWERING-NEXT:     let mut cls: i32 = 0;
...
// COMMON-LOWERING-NEXT:                 cls = {{__v[0-9]+}};
...
// COMMON-LOWERING-NEXT:                 let {{__v[0-9]+}}: i32 = cls;
...
// COMMON-REWRITES-NEXT:     let mut n: i32 = 0;
// COMMON-REWRITES-NEXT:     let mut cls: i32 = 0;
// COMMON-REWRITES-NEXT:     n = 7;
// COMMON-REWRITES-NEXT:     if n < 0 {
// COMMON-REWRITES-NEXT:         cls = -1;
