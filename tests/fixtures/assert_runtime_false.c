...
// LOWERING-X86_64-GNU-NEXT:         let {{__v[0-9]+}}: *mut i8 = b"argc == 2\0".as_ptr() as *mut i8;
// LOWERING-X86_64-GNU-NEXT:         let {{__v[0-9]+}}: *mut i8 = b"{{.*}}tests/fixtures/assert_runtime_false.c\0"
...
// LOWERING-AARCH64-GNU-NEXT:         let {{__v[0-9]+}}: *mut u8 = b"argc == 2\0".as_ptr() as *mut u8;
// LOWERING-AARCH64-GNU-NEXT:         let {{__v[0-9]+}}: *mut u8 = b"{{.*}}tests/fixtures/assert_runtime_false.c\0"
...
// COMMON-REWRITES-NEXT:     let {{__v[0-9]+}}: bool = {{arg[0-9]+}} == 2;
...
// COMMON-REWRITES-NEXT:                 c"argc == 2".as_ptr(),
// COMMON-REWRITES-NEXT:                 c"{{.*}}tests/fixtures/assert_runtime_false.c".as_ptr(),
