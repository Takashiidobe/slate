...
// COMMON-LOWERING-NEXT: }
// COMMON-LOWERING-EMPTY:
// COMMON-LOWERING-NEXT: fn die({{arg[0-9]+}}: i32) -> ! {
...
// COMMON-LOWERING-NEXT:             die({{__v[0-9]+}});
// COMMON-LOWERING-NEXT:         }
// COMMON-LOWERING-NEXT:     }
...
// LOWERING-X86_64-GNU-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"dying with %d\n\0".as_ptr() as *mut i8;
// LOWERING-X86_64-GNU-NEXT:     let {{__v[0-9]+}}: *mut i8 = b"main\n\0".as_ptr() as *mut i8;
// SLATE-FILECHECK-END lowering-x86_64-gnu

// SLATE-FILECHECK-BEGIN lowering-aarch64-gnu
// LOWERING-AARCH64-GNU-NEXT:     let {{__v[0-9]+}}: *mut u8 = b"dying with %d\n\0".as_ptr() as *mut u8;
...
// COMMON-REWRITES-NEXT: }
// COMMON-REWRITES-EMPTY:
// COMMON-REWRITES-NEXT: fn die({{arg[0-9]+}}: i32) -> ! {
// COMMON-REWRITES-NEXT:     unsafe { printf(c"dying with %d\n".as_ptr(), {{arg[0-9]+}}) };
