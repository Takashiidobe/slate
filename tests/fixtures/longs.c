...
// LOWERING-NEXT:     let {{__v[0-9]+}}: i64 = 5000000000i64;
// LOWERING-NEXT:     let {{__v[0-9]+}}: u64 = 9000000000u64;
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: i64 = ladd({{__v[0-9]+}}, {{__v[0-9]+}});
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: i64 = {{arg[0-9]+}} + {{arg[0-9]+}};
...
// REWRITES-NEXT:     let {{__v[0-9]+}}: i64 = 5000000000i64;
// REWRITES-NEXT:     let {{__v[0-9]+}}: u64 = 9000000000u64;
// REWRITES-NEXT:     unsafe { printf(c"%ld\n".as_ptr(), ladd({{__v[0-9]+}}, 1)) };
// REWRITES-NEXT:     unsafe { printf(c"%lu\n".as_ptr(), {{__v[0-9]+}}) };
// REWRITES-NEXT:     std::process::exit(0 as i32);
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: fn ladd({{arg[0-9]+}}: i64, {{arg[0-9]+}}: i64) -> i64 {
