...
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i64 = 5000000000i64;
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: u64 = 9000000000u64;
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i64 = 1;
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i64 = ladd({{__v[0-9]+}}, {{__v[0-9]+}});
...
// COMMON-LOWERING-NEXT: }
// COMMON-LOWERING-EMPTY:
// COMMON-LOWERING-NEXT: fn ladd({{arg[0-9]+}}: i64, {{arg[0-9]+}}: i64) -> i64 {
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i64 = {{arg[0-9]+}} + {{arg[0-9]+}};
...
// COMMON-REWRITES-NEXT:     let {{__v[0-9]+}}: i64 = 5000000000i64;
// COMMON-REWRITES-NEXT:     let {{__v[0-9]+}}: u64 = 9000000000u64;
// COMMON-REWRITES-NEXT:     unsafe { printf(c"%ld\n".as_ptr(), ladd({{__v[0-9]+}}, 1)) };
// COMMON-REWRITES-NEXT:     unsafe { printf(c"%lu\n".as_ptr(), {{__v[0-9]+}}) };
// COMMON-REWRITES-NEXT:     std::process::exit(0 as i32);
// COMMON-REWRITES-NEXT: }
// COMMON-REWRITES-EMPTY:
// COMMON-REWRITES-NEXT: fn ladd({{arg[0-9]+}}: i64, {{arg[0-9]+}}: i64) -> i64 {
