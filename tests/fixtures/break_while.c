...
// COMMON-LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = countdown({{__v[0-9]+}});
...
// COMMON-LOWERING-NEXT: }
// COMMON-LOWERING-EMPTY:
// COMMON-LOWERING-NEXT: fn countdown({{arg[0-9]+}}: i32) -> i32 {
...
// COMMON-REWRITES-NEXT: }
// COMMON-REWRITES-EMPTY:
// COMMON-REWRITES-NEXT: fn countdown(mut n: i32) -> i32 {
...
// COMMON-REWRITES-NEXT:             break;
// COMMON-REWRITES-NEXT:         }
// COMMON-REWRITES-NEXT:         n /= 2;
// COMMON-REWRITES-NEXT:         steps += 1;
// COMMON-REWRITES-NEXT:     }
// COMMON-REWRITES-NEXT:     steps
// COMMON-REWRITES-NEXT: }
