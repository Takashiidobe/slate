...
// LOWERING-NEXT: }
// LOWERING-EMPTY:
// LOWERING-NEXT: fn ior(arg0: i32, arg1: i32) -> i32 {
...
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: fn ior(arg0: i32, arg1: i32) -> i32 {
