...
// LOWERING-NEXT: }
// LOWERING-EMPTY:
// LOWERING-NEXT: fn ior({{arg[0-9]+}}: i32, {{arg[0-9]+}}: i32) -> i32 {
...
// LOWERING-NEXT:     let {{_v[0-9]+}}: i32 = ior({{_v[0-9]+}}, {{_v[0-9]+}});
...
// LOWERING-NEXT:     let {{_v[0-9]+}}: u32 = 15;
...
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: fn ior({{arg[0-9]+}}: i32, {{arg[0-9]+}}: i32) -> i32 {
...
// REWRITES-NEXT: let {{_v[0-9]+}}: i32 = ior({{_v[0-9]+}}, {{_v[0-9]+}});
...
// REWRITES-NEXT: let {{_v[0-9]+}}: u32 = 15;
