...
// LOWERING-NEXT:     let {{__v[0-9]+}}: i32 = ior({{__v[0-9]+}}, {{__v[0-9]+}});
...
// LOWERING-NEXT:     let {{__v[0-9]+}}: u32 = 15;
...
// REWRITES-NEXT:     println!("{}", ior(12, 10));
// REWRITES-NEXT:     let _ = std::io::Write::flush(&mut std::io::stdout());
// REWRITES-NEXT:     println!("{}", ior(-8, 3));
// REWRITES-NEXT:     let _ = std::io::Write::flush(&mut std::io::stdout());
// REWRITES-NEXT:     let {{__v[0-9]+}}: u32 = 15;
// REWRITES-NEXT:     let {{__v[0-9]+}}: u32 = 240 | {{__v[0-9]+}};
// REWRITES-NEXT:     let _ = std::io::Write::flush(&mut std::io::stdout());
