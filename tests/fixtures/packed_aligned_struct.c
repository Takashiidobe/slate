...
// LOWERING-NEXT:     let _v1: i8 = 7;
// LOWERING-NEXT:     s.a = _v1;
// LOWERING-NEXT:     let _v2: i32 = 4660;
// LOWERING-NEXT:     s.b = _v2;
// LOWERING-NEXT:     let _v3: *mut i8 = b"%zu %zu\n\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let _v4: u64 = std::mem::size_of::<PackedAligned>() as u64;
// LOWERING-NEXT:     let _v5: u64 = std::mem::align_of::<PackedAligned>() as u64;
// LOWERING-NEXT:     let _v6: i32 = unsafe { printf(_v3 as *const i8, _v4, _v5) };
// LOWERING-NEXT:     let _v7: *mut i8 = b"%zu %zu\n\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let _v8: u64 = 0;
// LOWERING-NEXT:     let _v9: u64 = 1;
// LOWERING-NEXT:     let _v10: i32 = unsafe { printf(_v7 as *const i8, _v8, _v9) };
// LOWERING-NEXT:     let _v11: *mut i8 = b"%d %x\n\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let _v12: i8 = s.a;
// LOWERING-NEXT:     let _v13: i32 = _v12 as i32;
// LOWERING-NEXT:     let _v14: i32 = s.b;
// LOWERING-NEXT:     let _v15: i32 = unsafe { printf(_v11 as *const i8, _v13, _v14) };
// LOWERING-NEXT:     let _v16: i32 = s.b;
// LOWERING-NEXT:     let _v17: i32 = 1;
// LOWERING-NEXT:     let _v18: i32 = _v16 + _v17;
// LOWERING-NEXT:     s.b = _v18;
// LOWERING-NEXT:     let _v19: *mut i8 = b"%x\n\0".as_ptr() as *mut i8;
// LOWERING-NEXT:     let _v20: i32 = s.b;
...
// REWRITES-NEXT: let _v3: *mut i8 = b"%zu %zu\n\0".as_ptr() as *mut i8;
// REWRITES-NEXT: let _v4: u64 = std::mem::size_of::<PackedAligned>() as u64;
// REWRITES-NEXT: let _v5: u64 = std::mem::align_of::<PackedAligned>() as u64;
// REWRITES-NEXT: let _v6: i32 = unsafe { printf(_v3 as *const i8, _v4, _v5) };
// REWRITES-NEXT: let _v7: *mut i8 = b"%zu %zu\n\0".as_ptr() as *mut i8;
// REWRITES-NEXT: let _v8: u64 = 0;
// REWRITES-NEXT: let _v9: u64 = 1;
// REWRITES-NEXT: let _v10: i32 = unsafe { printf(_v7 as *const i8, _v8, _v9) };
// REWRITES-NEXT: let _v11: *mut i8 = b"%d %x\n\0".as_ptr() as *mut i8;
// REWRITES-NEXT: let _v14: i32 = s.b;
// REWRITES-NEXT: let _v15: i32 = unsafe { printf(_v11 as *const i8, s.a as i32, _v14) };
// REWRITES-NEXT: let _v17: i32 = 1;
// REWRITES-NEXT: s.b = s.b + _v17;
// REWRITES-NEXT: let _v19: *mut i8 = b"%x\n\0".as_ptr() as *mut i8;
// REWRITES-NEXT: let _v20: i32 = s.b;
