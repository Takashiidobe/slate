...
// LOWERING-NEXT: }
// LOWERING-EMPTY:
// LOWERING-NEXT: fn pick(arg0: i32) -> i32 {
...
// LOWERING-NEXT:     let _v2: i32 = 4;
// LOWERING-NEXT:     let _v3: i32 = pick(_v2);
// LOWERING-NEXT:     let _v4: i32 = 9;
// LOWERING-NEXT:     let _v5: i32 = pick(_v4);
// LOWERING-NEXT:     let _v6: i32 = 2;
// LOWERING-NEXT:     let _v7: i32 = pick(_v6);
...
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: fn pick(arg0: i32) -> i32 {
...
// REWRITES-NEXT:                                                             out = out + _v2;
// REWRITES-NEXT:                                                             break '__switch0;
// REWRITES-NEXT:                                         }
// REWRITES-NEXT:                                         1 => {
// REWRITES-NEXT:                                                             let _v5: i32 = 9;
// REWRITES-NEXT:                                                             out = out + _v5;
// REWRITES-NEXT:                                                             break '__switch0;
// REWRITES-NEXT:                                         }
// REWRITES-NEXT:                                         _ => {
// REWRITES-NEXT:                                                             break '__switch0;
...
// REWRITES-NEXT: let _v2: i32 = 4;
// REWRITES-NEXT: let _v3: i32 = pick(_v2);
// REWRITES-NEXT: let _v4: i32 = 9;
// REWRITES-NEXT: let _v5: i32 = pick(_v4);
// REWRITES-NEXT: let _v6: i32 = 2;
// REWRITES-NEXT: let _v7: i32 = pick(_v6);
