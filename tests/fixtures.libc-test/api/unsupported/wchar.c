...
static void f() {
  ...
  {
    size_t (*p)(wchar_t *restrict, const char *restrict, size_t,
  ...
  {
    int (*p)(wchar_t *restrict, size_t, const wchar_t *restrict, ...) =
        swprintf;
  }
  {
  ...
  {
    int (*p)(wchar_t *restrict, size_t, const wchar_t *restrict, va_list) =
        vswprintf;
  }
  {
    int (*p)(const wchar_t *restrict, const wchar_t *restrict, va_list) =
        vswscanf;
  }
  {
  ...
  {
    size_t (*p)(wchar_t *restrict, size_t, const wchar_t *restrict,
  ...
  {
    size_t (*p)(char *restrict, const wchar_t **restrict, size_t,
                mbstate_t *restrict) = wcsrtombs;
  }
  {
  ...
  {
    wchar_t *(*p)(wchar_t *restrict, const wchar_t *restrict,
  ...
  {
    unsigned long (*p)(const wchar_t *restrict, wchar_t **restrict, int) =
        wcstoul;
  }
  {
    unsigned long long (*p)(const wchar_t *restrict, wchar_t **restrict, int) =
        wcstoull;
  }
  {
...
#ifdef _POSIX_C_SOURCE
  {
    size_t (*p)(wchar_t *restrict, const char **restrict, size_t, size_t,
                mbstate_t *restrict) = mbsnrtowcs;
  }
  {
  ...
  {
    int (*p)(const wchar_t *, const wchar_t *, size_t, locale_t) =
        wcsncasecmp_l;
  }
  {
  ...
  {
    size_t (*p)(char *restrict, const wchar_t **restrict, size_t, size_t,
                mbstate_t *restrict) = wcsnrtombs;
  }
  {
    size_t (*p)(wchar_t *restrict, const wchar_t *restrict, size_t, locale_t) =
        wcsxfrm_l;
  }
#endif
#ifdef _XOPEN_SOURCE
