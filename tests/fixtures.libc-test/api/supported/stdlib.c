...
#define I(t, e)                                                                \
  {                                                                            \
    t x[sizeof(t) == sizeof(e)] = {e};                                         \
  }
static void f() {
  C(EXIT_FAILURE)
  C(EXIT_SUCCESS)
  C(RAND_MAX)
  I(size_t, MB_CUR_MAX) { void *x = NULL; }
  T(div_t)
  T(ldiv_t)
  T(lldiv_t)
  T(size_t)
  ...
  {
    void (*p)(void *, size_t, size_t, int (*)(const void *, const void *)) =
        qsort;
  }
  {
    int (*p)(void) = rand;
  ...
  {
    unsigned long long (*p)(const char *restrict, char **restrict, int) =
        strtoull;
  }
  {
