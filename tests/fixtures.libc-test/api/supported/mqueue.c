...
static void f() {
  ...
  {
    int (*p)(mqd_t, const struct mq_attr *restrict, struct mq_attr *restrict) =
        mq_setattr;
  }
  {
...
static void g() {
  {
    ssize_t (*p)(mqd_t, char *restrict, size_t, unsigned *restrict,
                 const struct timespec *restrict) = mq_timedreceive;
  }
  {
    int (*p)(mqd_t, const char *, size_t, unsigned, const struct timespec *) =
        mq_timedsend;
  }
}
#endif
