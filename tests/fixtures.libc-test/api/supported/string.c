...
static void f() {
  ...
  T(locale_t) { char *(*p)(char *restrict, const char *restrict) = stpcpy; }
  {
  ...
  {
    char *(*p)(char *restrict, const char *restrict, char **restrict) =
        strtok_r;
  }
  {
    size_t (*p)(char *restrict, const char *restrict, size_t, locale_t) =
        strxfrm_l;
  }
#endif
#ifdef _XOPEN_SOURCE
