...
static void f() {
  ...
  C(TIMER_ABSTIME) { char *(*p)(const struct tm *) = asctime; }
  {
  ...
  {
    size_t (*p)(char *restrict, size_t, const char *restrict,
  ...
  {
    int (*p)(clockid_t, int, const struct timespec *, struct timespec *) =
        clock_nanosleep;
  }
  {
  ...
  {
    size_t (*p)(char *restrict, size_t, const char *restrict,
                const struct tm *restrict, locale_t) = strftime_l;
  }
  {
    int (*p)(clockid_t, struct sigevent *restrict, timer_t *restrict) =
        timer_create;
  }
  {
  ...
  {
    int (*p)(timer_t, int, const struct itimerspec *restrict,
             struct itimerspec *restrict) = timer_settime;
  }
  {
    char **x = tzname;
  }
  ...
  {
    char *(*p)(const char *restrict, const char *restrict,
               struct tm *restrict) = strptime;
  }
  {
    long i = timezone;
  }
