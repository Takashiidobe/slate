...
static void f() {
  ...
  {
    int (*p)(struct obstack *, int, int, void *(*)(long), void (*)(void *)) =
        _obstack_begin;
  }
  {
    int (*p)(struct obstack *, int, int, void *(*)(void *, long),
             void (*)(void *, void *), void *) = _obstack_begin_1;
  }
  {
  ...
  obstack_specify_allocation_with_arg(&x, length, length, allocate_with_arg,
                                      free_with_arg, value);
