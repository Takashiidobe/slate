...
#if _POSIX_V7_ILP32_OFFBIG <= 0 && _POSIX_V7_LP64_OFF64 <= 0 &&                \
    _POSIX_V7_LPBIG_OFFBIG <= 0
#error _POSIX_V7_ILP32_OFFBIG<=0 && _POSIX_V7_LP64_OFF64<=0 && _POSIX_V7_LPBIG_OFFBIG<=0
  ...
  {
    ssize_t (*p)(int, const char *restrict, char *restrict, size_t) =
        readlinkat;
  }
  {
