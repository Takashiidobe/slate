...
static void f() {
  ...
  C(PTHREAD_CANCEL_DISABLE) { void *x = PTHREAD_CANCELED; }
  ...
  C(PTHREAD_ONCE_INIT)
#if defined(POSIX_THREAD_ROBUST_PRIO_INHERIT) ||                               \
    defined(POSIX_THREAD_PRIO_INHERIT)
  C(PTHREAD_PRIO_INHERIT)
#endif
#if defined(POSIX_THREAD_ROBUST_PRIO_INHERIT) ||                               \
    defined(POSIX_THREAD_PRIO_INHERIT) ||                                      \
    defined(POSIX_THREAD_ROBUST_PRIO_PROTECT) ||                               \
    defined(POSIX_THREAD_PRIO_PROTECT)
  C(PTHREAD_PRIO_NONE)
#endif
#if defined(POSIX_THREAD_ROBUST_PRIO_PROTECT) ||                               \
    defined(POSIX_THREAD_PRIO_PROTECT)
  ...
  {
    int (*p)(const pthread_attr_t *restrict, size_t *restrict) =
        pthread_attr_getguardsize;
  }
  {
    int (*p)(const pthread_attr_t *restrict, struct sched_param *restrict) =
        pthread_attr_getschedparam;
  }
  {
    int (*p)(const pthread_attr_t *restrict, void **restrict,
             size_t *restrict) = pthread_attr_getstack;
  }
  {
    int (*p)(const pthread_attr_t *restrict, size_t *restrict) =
  ...
  {
    int (*p)(pthread_attr_t *restrict, const struct sched_param *restrict) =
  ...
  {
    int (*p)(pthread_barrier_t *restrict, const pthread_barrierattr_t *restrict,
  ...
  {
    int (*p)(const pthread_barrierattr_t *restrict, int *restrict) =
  ...
  {
    int (*p)(pthread_cond_t *restrict, const pthread_condattr_t *restrict) =
        pthread_cond_init;
  }
  {
  ...
  {
    int (*p)(pthread_cond_t *restrict, pthread_mutex_t *restrict,
             const struct timespec *restrict) = pthread_cond_timedwait;
  }
  {
    int (*p)(pthread_cond_t *restrict, pthread_mutex_t *restrict) =
        pthread_cond_wait;
  ...
  {
    int (*p)(const pthread_condattr_t *restrict, clockid_t *restrict) =
        pthread_condattr_getclock;
  }
  {
    int (*p)(const pthread_condattr_t *restrict, int *restrict) =
  ...
  {
    int (*p)(pthread_t *restrict, const pthread_attr_t *restrict,
             void *(*)(void *), void *restrict) = pthread_create;
  }
  {
  ...
  {
    int (*p)(pthread_mutex_t *restrict, const pthread_mutexattr_t *restrict) =
        pthread_mutex_init;
  }
  {
  ...
  }
  {
    ...
    defined(POSIX_THREAD_PRIO_PROTECT)
  {
    int (*p)(const pthread_mutexattr_t *restrict, int *restrict) =
  ...
  {
    int (*p)(pthread_rwlock_t *restrict, const pthread_rwlockattr_t *restrict) =
        pthread_rwlock_init;
  }
  {
  ...
  {
    int (*p)(const pthread_rwlockattr_t *restrict, int *restrict) =
  ...
  }
  {
    ...
    defined(POSIX_THREAD_PRIO_PROTECT)
  {
    int (*p)(const pthread_mutex_t *restrict, int *restrict) =
        pthread_mutex_getprioceiling;
  }
  {
    int (*p)(pthread_mutex_t *restrict, int, int *restrict) =
...
#ifdef POSIX_THREAD_PRIORITY_SCHEDULING
  {
    int (*p)(const pthread_attr_t *restrict, int *restrict) =
  ...
  {
    int (*p)(pthread_t, int *restrict, struct sched_param *restrict) =
        pthread_getschedparam;
  }
  {
    int (*p)(pthread_t, int, const struct sched_param *) =
...
static void g() {
  ...
  {
    int (*p)(pthread_mutex_t *restrict, const struct timespec *restrict) =
        pthread_mutex_timedlock;
  }
  {
    int (*p)(pthread_rwlock_t *restrict, const struct timespec *restrict) =
