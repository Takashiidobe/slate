...
// LOWERING-DAG: /// PR c/47473
// LOWERING-DAG: /// { dg-do run }
// LOWERING-DAG: /// { dg-options "-std=c99" }
...
// REWRITES-DAG: /// PR c/47473
// REWRITES-DAG: /// { dg-do run }
// REWRITES-DAG: /// { dg-options "-std=c99" }
