...
// LOWERING-DAG:     {
// LOWERING-DAG:         let {{__v[0-9]+}}: i32 = unsafe { max };
// LOWERING-DAG:         let {{__v[0-9]+}}: i32 = unsafe { expected };
// LOWERING-DAG:         let {{__v[0-9]+}}: Result<i32, i32> = unsafe {
// LOWERING-DAG:             std::sync::atomic::AtomicI32::from_ptr(std::ptr::addr_of_mut!(v)).compare_exchange(
...
// LOWERING-DAG:             )
// LOWERING-DAG:         };
// LOWERING-DAG:         let {{__v[0-9]+}}: i32 = match {{__v[0-9]+}} {
...
// LOWERING-DAG:     }
// LOWERING-DAG:     {
// LOWERING-DAG:         let {{__v[0-9]+}}: i32 = unsafe { v };
// LOWERING-DAG:         let {{__v[0-9]+}}: i32 = 0;
// LOWERING-DAG:         let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// LOWERING-DAG:         if {{__v[0-9]+}} {
// LOWERING-DAG:             unsafe { abort() };
...
// LOWERING-DAG:     }
// LOWERING-DAG:     {
// LOWERING-DAG:         let {{__v[0-9]+}}: i32 = unsafe { desired };
// LOWERING-DAG:         let {{__v[0-9]+}}: i32 = unsafe { expected };
// LOWERING-DAG:         let {{__v[0-9]+}}: Result<i32, i32> = unsafe {
// LOWERING-DAG:             std::sync::atomic::AtomicI32::from_ptr(std::ptr::addr_of_mut!(v)).compare_exchange(
// LOWERING-DAG:                 {{__v[0-9]+}},
...
// LOWERING-DAG:     {
// LOWERING-DAG:         let {{__v[0-9]+}}: i32 = unsafe { expected };
// LOWERING-DAG:         let {{__v[0-9]+}}: i32 = unsafe { zero };
// LOWERING-DAG:         let {{__v[0-9]+}}: Result<i32, i32> = unsafe {
// LOWERING-DAG:             std::sync::atomic::AtomicI32::from_ptr(std::ptr::addr_of_mut!(v)).compare_exchange(
// LOWERING-DAG:                 {{__v[0-9]+}},
// LOWERING-DAG:                 {{__v[0-9]+}},
...
// REWRITES-DAG:     let {{__v[0-9]+}}: i32 = unsafe { max };
// REWRITES-DAG:     let {{__v[0-9]+}}: i32 = unsafe { expected };
// REWRITES-DAG:     let {{__v[0-9]+}}: Result<i32, i32> = unsafe {
// REWRITES-DAG:         std::sync::atomic::AtomicI32::from_ptr(std::ptr::addr_of_mut!(v)).compare_exchange(
...
// REWRITES-DAG:         )
// REWRITES-DAG:     };
// REWRITES-DAG:     let {{__v[0-9]+}}: i32 = match {{__v[0-9]+}} {
...
// REWRITES-DAG:         unsafe { abort() };
// REWRITES-DAG:     }
// REWRITES-DAG:     let {{__v[0-9]+}}: i32 = unsafe { v };
// REWRITES-DAG:     let {{__v[0-9]+}}: i32 = 0;
// REWRITES-DAG:     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// REWRITES-DAG:     if {{__v[0-9]+}} {
// REWRITES-DAG:         unsafe { abort() };
// REWRITES-DAG:     }
// REWRITES-DAG:     let {{__v[0-9]+}}: i32 = unsafe { desired };
// REWRITES-DAG:     let {{__v[0-9]+}}: i32 = unsafe { expected };
// REWRITES-DAG:     let {{__v[0-9]+}}: Result<i32, i32> = unsafe {
// REWRITES-DAG:         std::sync::atomic::AtomicI32::from_ptr(std::ptr::addr_of_mut!(v)).compare_exchange(
// REWRITES-DAG:             {{__v[0-9]+}},
...
// REWRITES-DAG:     }
// REWRITES-DAG:     let {{__v[0-9]+}}: i32 = unsafe { expected };
// REWRITES-DAG:     let {{__v[0-9]+}}: i32 = unsafe { zero };
// REWRITES-DAG:     let {{__v[0-9]+}}: Result<i32, i32> = unsafe {
// REWRITES-DAG:         std::sync::atomic::AtomicI32::from_ptr(std::ptr::addr_of_mut!(v)).compare_exchange(
// REWRITES-DAG:             {{__v[0-9]+}},
// REWRITES-DAG:             {{__v[0-9]+}},
