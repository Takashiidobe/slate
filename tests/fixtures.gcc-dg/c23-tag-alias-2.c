...
// LOWERING-NEXT: }
// LOWERING-EMPTY:
// LOWERING-NEXT: /// These tests check that compatible definitions of
// LOWERING-NEXT: /// tagged types can alias the original definitions
// LOWERING-NEXT: /// with LTO.
// LOWERING-NEXT: #[repr(C)]
...
// REWRITES-NEXT: }
// REWRITES-EMPTY:
// REWRITES-NEXT: /// These tests check that compatible definitions of
// REWRITES-NEXT: /// tagged types can alias the original definitions
// REWRITES-NEXT: /// with LTO.
// REWRITES-NEXT: #[repr(C)]
...
// REWRITES-NEXT:     }
// REWRITES-NEXT:     unsafe {
// REWRITES-NEXT:         (*({{arg[0-9]+}} as *mut foo_0)).x = 2;
// REWRITES-NEXT:     }
