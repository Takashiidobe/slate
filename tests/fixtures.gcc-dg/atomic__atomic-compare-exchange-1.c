...
// REWRITES-DAG:     let {{__v[0-9]+}}: i8 = unsafe { max };
// REWRITES-DAG:     let {{__v[0-9]+}}: i8 = unsafe { expected };
...
// REWRITES-DAG:         unsafe { abort() };
// REWRITES-DAG:     }
// REWRITES-DAG:     let {{__v[0-9]+}}: i8 = unsafe { v };
// REWRITES-DAG:     let {{__v[0-9]+}}: i32 = {{__v[0-9]+}} as i32;
// REWRITES-DAG:     let {{__v[0-9]+}}: i32 = 0;
// REWRITES-DAG:     let {{__v[0-9]+}}: bool = {{__v[0-9]+}} != {{__v[0-9]+}};
// REWRITES-DAG:     if {{__v[0-9]+}} {
// REWRITES-DAG:         unsafe { abort() };
// REWRITES-DAG:     }
// REWRITES-DAG:     let {{__v[0-9]+}}: i8 = unsafe { desired };
// REWRITES-DAG:     let {{__v[0-9]+}}: i8 = unsafe { expected };
// REWRITES-DAG:     let {{__v[0-9]+}}: Result<i8, i8> = unsafe {
// REWRITES-DAG:         std::sync::atomic::AtomicI8::from_ptr(std::ptr::addr_of_mut!(v)).compare_exchange(
// REWRITES-DAG:             {{__v[0-9]+}},
...
// REWRITES-DAG:     }
// REWRITES-DAG:     let {{__v[0-9]+}}: i8 = unsafe { expected };
// REWRITES-DAG:     let {{__v[0-9]+}}: i8 = unsafe { zero };
// REWRITES-DAG:     let {{__v[0-9]+}}: Result<i8, i8> = unsafe {
// REWRITES-DAG:         std::sync::atomic::AtomicI8::from_ptr(std::ptr::addr_of_mut!(v)).compare_exchange(
// REWRITES-DAG:             {{__v[0-9]+}},
// REWRITES-DAG:             {{__v[0-9]+}},
