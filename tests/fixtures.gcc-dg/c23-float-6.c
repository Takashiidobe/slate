...
// LOWERING-DAG:         let {{_v[0-9]+}}: bool = ({{_v[0-9]+}} as f64).is_nan();
// LOWERING-DAG:         let {{_v[0-9]+}}: bool = !{{_v[0-9]+}};
// LOWERING-DAG:         if {{_v[0-9]+}} {
// LOWERING-DAG:             unsafe { abort() };
// LOWERING-DAG:         }
...
// LOWERING-DAG:         let {{_v[0-9]+}}: bool = {{_v[0-9]+}}.is_nan();
// LOWERING-DAG:         let {{_v[0-9]+}}: bool = !{{_v[0-9]+}};
// LOWERING-DAG:         if {{_v[0-9]+}} {
// LOWERING-DAG:             unsafe { abort() };
// LOWERING-DAG:         }
...
// LOWERING-DAG:     }
// LOWERING-DAG:     {
// LOWERING-DAG:         let {{_v[0-9]+}}: LongDouble = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(ld)) };
// LOWERING-DAG:         let {{_v[0-9]+}}: bool = __slate_f80_is_fp_class({{_v[0-9]+}}, 3);
// LOWERING-DAG:         let {{_v[0-9]+}}: bool = !{{_v[0-9]+}};
// LOWERING-DAG:         if {{_v[0-9]+}} {
// LOWERING-DAG:             unsafe { abort() };
// LOWERING-DAG:         }
...
// REWRITES-DAG:     let {{_v[0-9]+}}: bool = ({{_v[0-9]+}} as f64).is_nan();
...
// REWRITES-DAG:     let {{_v[0-9]+}}: bool = {{_v[0-9]+}}.is_nan();
// REWRITES-DAG:     let {{_v[0-9]+}}: bool = !{{_v[0-9]+}};
// REWRITES-DAG:     if {{_v[0-9]+}} {
// REWRITES-DAG:         unsafe { abort() };
// REWRITES-DAG:     }
...
// REWRITES-DAG:         unsafe { abort() };
// REWRITES-DAG:     }
// REWRITES-DAG:     let {{_v[0-9]+}}: LongDouble = unsafe { std::ptr::read_volatile(std::ptr::addr_of!(ld)) };
// REWRITES-DAG:     let {{_v[0-9]+}}: bool = __slate_f80_is_fp_class({{_v[0-9]+}}, 3);
// REWRITES-DAG:     let {{_v[0-9]+}}: bool = !{{_v[0-9]+}};
// REWRITES-DAG:     if {{_v[0-9]+}} {
// REWRITES-DAG:         unsafe { abort() };
// REWRITES-DAG:     }
