...
int main(int argc, char *argv[]) {
  ...
  struct B e = {argc,        2,           .c[2] = {},  .c[1] = {9},
                .c[0] = {},  .c[0].a = 3, .c[0].b = 4, .c[1].a = 5,
                .c[1].b = 6, .c[2].a = 7, .c[2].b = 8};

  /* Padding bits might not be initialized according to C23 but GCC treats
     the explicitly initialized padding of c as contagious */
  struct B f = {argc,        2,           {},          .c[0].a = 3, .c[0].b = 4,
                .c[1].a = 5, .c[1].b = 6, .c[2].a = 7, .c[2].b = 8};

  struct B g = {
      argc,        2,           .c[0].a = 3, .c[0].b = 4,
      .c[1].a = 5, .c[1].b = 6, /* { dg-warning "padding might not be initialized to zero" } */
      .c[2].a = 7, .c[2].b = 8};

  union U h = {}; /* ZI because it omits a, b */
  union U i = {
      argc}; /* { dg-warning "padding might not be initialized to zero" } */
  union U j = {
      .a =
          argc}; /* { dg-warning "padding might not be initialized to zero" } */
  ...
  struct F t = {
      ...
      .b = {
          .a =
              2}}; /* { dg-warning "padding might not be initialized to zero" } */
