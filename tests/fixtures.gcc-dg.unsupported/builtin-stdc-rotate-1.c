...
unsigned long long rotate_left(unsigned char a, unsigned short b,
                               unsigned int c, unsigned long d,
                               unsigned long long e, int n) {
  return (__builtin_stdc_rotate_left(a, n) + __builtin_stdc_rotate_left(b, n) +
          __builtin_stdc_rotate_left(c, n) + __builtin_stdc_rotate_left(d, n) +
          __builtin_stdc_rotate_left(e, n));
}

unsigned long long rotate_right(unsigned char a, unsigned short b,
                                unsigned int c, unsigned long d,
                                unsigned long long e, int n) {
  return (
      __builtin_stdc_rotate_right(a, n) + __builtin_stdc_rotate_right(b, n) +
      __builtin_stdc_rotate_right(c, n) + __builtin_stdc_rotate_right(d, n) +
...
main() {
  if (__builtin_stdc_rotate_left((unsigned char)0, 0) != 0 ||
      ...
      !expr_has_type(
          __builtin_stdc_rotate_left((unsigned char)1, (unsigned char)1),
          unsigned char) ||
      ...
      !expr_has_type(
          __builtin_stdc_rotate_left((unsigned short)0, (signed char)0),
          unsigned short) ||
      __builtin_stdc_rotate_left((unsigned short)1, 13) != (1U << 13) ||
      !expr_has_type(__builtin_stdc_rotate_left((unsigned short)1, 13),
                     unsigned short) ||
      __builtin_stdc_rotate_left((unsigned short)~1U, 7) !=
          (unsigned short)~0x80U ||
      ...
      __builtin_stdc_rotate_left(2UL + __LONG_MAX__,
                                 (int)(sizeof(unsigned long) * __CHAR_BIT__) +
                                     1) != 3 ||
  ...
  if (__builtin_stdc_rotate_right((unsigned char)0, 0) != 0 ||
      ...
      !expr_has_type(__builtin_stdc_rotate_right((unsigned char)0, 0),
                     unsigned char) ||
      __builtin_stdc_rotate_right((unsigned char)1, 1) !=
          (1U + __SCHAR_MAX__) ||
      ...
      __builtin_stdc_rotate_right((unsigned char)3, 1) !=
          (2U + __SCHAR_MAX__) ||
      __builtin_stdc_rotate_right((unsigned short)0, 0) != 0 ||
      __builtin_stdc_rotate_right((unsigned short)0xdcabU, 0) != 0xdcabU ||
      __builtin_stdc_rotate_right((unsigned short)0xdcabU,
                                  sizeof(unsigned short) * __CHAR_BIT__) !=
          0xdcabU ||
      !expr_has_type(__builtin_stdc_rotate_right((unsigned short)0, 0),
                     unsigned short) ||
      __builtin_stdc_rotate_right((unsigned short)(1U << 13), 12) != 2 ||
      !expr_has_type(__builtin_stdc_rotate_right((unsigned short)(1U << 13), 2),
                     unsigned short) ||
      __builtin_stdc_rotate_right((unsigned short)~1U, 7) !=
          (unsigned short)~((1U + __SHRT_MAX__) >> 6) ||
      __builtin_stdc_rotate_right((unsigned short)3, 1) !=
          (2U + __SHRT_MAX__) ||
      ...
      __builtin_stdc_rotate_right(3U, (int)(sizeof(unsigned) * __CHAR_BIT__) +
                                          1) != (2U + __INT_MAX__) ||
      ...
      !expr_has_type(__builtin_stdc_rotate_right(1UL << 30, 27),
                     unsigned long) ||
      ...
      __builtin_stdc_rotate_right(0xdc897143985734baULL, 0) !=
          0xdc897143985734baULL ||
      !expr_has_type(__builtin_stdc_rotate_right(0ULL, 0),
                     unsigned long long) ||
      __builtin_stdc_rotate_right(1ULL << 62, 60) != 4ULL ||
      !expr_has_type(__builtin_stdc_rotate_right(1ULL << 62, 60),
                     unsigned long long) ||
      __builtin_stdc_rotate_right(~1ULL, 53) !=
          ~((1ULL + __LONG_LONG_MAX__) >> 52) ||
      __builtin_stdc_rotate_right(3ULL, 1) != (2ULL + __LONG_LONG_MAX__))
    __builtin_abort();
#ifdef __SIZEOF_INT128__
  if (__builtin_stdc_rotate_left((unsigned __int128)0U, 0) != 0 ||
      __builtin_stdc_rotate_left(
          ((unsigned __int128)0x43256567547ULL) << 64 | 0xdc897143985734baULL,
          0) != (((unsigned __int128)0x43256567547ULL) << 64 |
                 0xdc897143985734baULL) ||
      !expr_has_type(__builtin_stdc_rotate_left((unsigned __int128)0U, 0),
                     unsigned __int128) ||
      __builtin_stdc_rotate_left((unsigned __int128)1U, 115) !=
          ((unsigned __int128)1U << 115) ||
      !expr_has_type(__builtin_stdc_rotate_left((unsigned __int128)1U, 115),
                     unsigned __int128) ||
  ...
  if (__builtin_stdc_rotate_right(0ULL, 0) != 0 ||
      __builtin_stdc_rotate_right(
          ...
          0) != (((unsigned __int128)0x43256567547ULL) << 64 |
                 0xdc897143985734baULL) ||
      !expr_has_type(__builtin_stdc_rotate_right((unsigned __int128)0U, 0),
                     unsigned __int128) ||
      ...
      __builtin_stdc_rotate_right((unsigned __int128)3ULL, 1) !=
          1U + ((unsigned __int128)1U << 127))
    __builtin_abort();
#endif
...
#error __builtin_stdc_rotate_right not implemented
  ...
  if (__builtin_stdc_rotate_left((unsigned _BitInt(2))0, 0) != 0 ||
      __builtin_stdc_rotate_left((unsigned _BitInt(2))1, (_BitInt(27))1) !=
          2uwb ||
      !expr_has_type(__builtin_stdc_rotate_left((unsigned _BitInt(2))0, 0),
                     unsigned _BitInt(2)) ||
  ...
  if (__builtin_stdc_rotate_right((unsigned _BitInt(2))0, (_BitInt(3))0) != 0 ||
      ...
      !expr_has_type(__builtin_stdc_rotate_right((unsigned _BitInt(2))0, 0),
                     unsigned _BitInt(2)) ||
      __builtin_stdc_rotate_right((unsigned _BitInt(2))1, 1) != 2 ||
      !expr_has_type(__builtin_stdc_rotate_right((unsigned _BitInt(2))1, 1),
                     unsigned _BitInt(2)) ||
      __builtin_stdc_rotate_right((unsigned _BitInt(2))2, 1) != 1)
    __builtin_abort();
  if (__builtin_stdc_rotate_left((unsigned _BitInt(59))0U, 0) != 0 ||
      __builtin_stdc_rotate_left((unsigned _BitInt(59))0x43256567547ULL, 0) !=
          ((unsigned _BitInt(59))0x43256567547ULL) ||
      !expr_has_type(__builtin_stdc_rotate_left((unsigned _BitInt(59))0U, 0),
                     unsigned _BitInt(59)) ||
      __builtin_stdc_rotate_left((unsigned _BitInt(59))1U, 57) !=
          ((unsigned _BitInt(59))1U << 57) ||
      !expr_has_type(__builtin_stdc_rotate_left((unsigned _BitInt(59))1U, 57),
                     unsigned _BitInt(59)) ||
      __builtin_stdc_rotate_left(~(unsigned _BitInt(59))1ULL, 53) !=
          ~(unsigned _BitInt(59))0x20000000000000ULL ||
      __builtin_stdc_rotate_left(1uwb + ((unsigned _BitInt(59))1U << 58), 1) !=
          3)
    __builtin_abort();
  if (__builtin_stdc_rotate_right(0ULL, 0) != 0 ||
      __builtin_stdc_rotate_right((unsigned _BitInt(59))0x43256567547ULL, 0) !=
          ((unsigned _BitInt(59))0x43256567547ULL) ||
      !expr_has_type(__builtin_stdc_rotate_right((unsigned _BitInt(59))0U, 0),
                     unsigned _BitInt(59)) ||
      __builtin_stdc_rotate_right((unsigned _BitInt(59))1ULL << 57, 55) != 4U ||
      !expr_has_type(
          __builtin_stdc_rotate_right((unsigned _BitInt(59))1U << 57, 55),
          unsigned _BitInt(59)) ||
      __builtin_stdc_rotate_right(~(unsigned _BitInt(59))1ULL, 53) !=
          ~((unsigned _BitInt(59))1 << 6) ||
      __builtin_stdc_rotate_right((unsigned _BitInt(59))3ULL, 1) !=
          1uwb + ((unsigned _BitInt(59))1U << 58))
    __builtin_abort();
#endif
#if __BITINT_MAXWIDTH__ >= 512
  if (__builtin_stdc_rotate_left((unsigned _BitInt(510))0U, (_BitInt(503))0) !=
          0 ||
      __builtin_stdc_rotate_left(
          ((unsigned _BitInt(510))0x43256567547ULL) << 64 |
              0xdc897143985734baULL,
          0) != (((unsigned _BitInt(510))0x43256567547ULL) << 64 |
                 0xdc897143985734baULL) ||
      __builtin_stdc_rotate_left(
          ((unsigned _BitInt(510))0x43256567547ULL) << 64 |
              0xdc897143985734baULL,
          510) != (((unsigned _BitInt(510))0x43256567547ULL) << 64 |
                   0xdc897143985734baULL) ||
      !expr_has_type(__builtin_stdc_rotate_left((unsigned _BitInt(510))0U, 0),
                     unsigned _BitInt(510)) ||
      __builtin_stdc_rotate_left((unsigned _BitInt(510))1U, 508) !=
          ((unsigned _BitInt(510))1U << 508) ||
      !expr_has_type(__builtin_stdc_rotate_left((unsigned _BitInt(510))1U,
                                                (unsigned _BitInt(505))508),
                     unsigned _BitInt(510)) ||
      __builtin_stdc_rotate_left(~(unsigned _BitInt(510))1ULL, 53) !=
          ~(unsigned _BitInt(510))0x20000000000000ULL ||
      __builtin_stdc_rotate_left(1uwb + ((unsigned _BitInt(510))1U << 509),
                                 1) != 3 ||
      __builtin_stdc_rotate_left(1uwb + ((unsigned _BitInt(510))1U << 509),
                                 511U) != 3)
    __builtin_abort();
  if (__builtin_stdc_rotate_right(0ULL, 0) != 0 ||
      ...
      __builtin_stdc_rotate_right(
          ((unsigned _BitInt(510))0x43256567547ULL) << 64 |
              0xdc897143985734baULL,
          510U * 2) != (((unsigned _BitInt(510))0x43256567547ULL) << 64 |
                        0xdc897143985734baULL) ||
      !expr_has_type(__builtin_stdc_rotate_right((unsigned _BitInt(510))0U, 0),
                     unsigned _BitInt(510)) ||
      __builtin_stdc_rotate_right((unsigned _BitInt(510))1ULL << 508, 503) !=
          32U ||
      !expr_has_type(
          __builtin_stdc_rotate_right((unsigned _BitInt(510))1ULL << 508, 503),
          unsigned _BitInt(510)) ||
      ...
      __builtin_stdc_rotate_right((unsigned _BitInt(510))3ULL, 1) !=
