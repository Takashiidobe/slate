...
unsigned int leading_zeros(unsigned char a, unsigned short b, unsigned int c,
                           unsigned long d, unsigned long long e) {
  return (__builtin_stdc_leading_zeros(a) + __builtin_stdc_leading_zeros(b) +
          __builtin_stdc_leading_zeros(c) + __builtin_stdc_leading_zeros(d) +
          __builtin_stdc_leading_zeros(e));
}

unsigned int leading_ones(unsigned char a, unsigned short b, unsigned int c,
                          unsigned long d, unsigned long long e) {
  return (__builtin_stdc_leading_ones(a) + __builtin_stdc_leading_ones(b) +
          __builtin_stdc_leading_ones(c) + __builtin_stdc_leading_ones(d) +
          __builtin_stdc_leading_ones(e));
}

unsigned int trailing_zeros(unsigned char a, unsigned short b, unsigned int c,
                            unsigned long d, unsigned long long e) {
  return (__builtin_stdc_trailing_zeros(a) + __builtin_stdc_trailing_zeros(b) +
          __builtin_stdc_trailing_zeros(c) + __builtin_stdc_trailing_zeros(d) +
          __builtin_stdc_trailing_zeros(e));
}

unsigned int trailing_ones(unsigned char a, unsigned short b, unsigned int c,
                           unsigned long d, unsigned long long e) {
  return (__builtin_stdc_trailing_ones(a) + __builtin_stdc_trailing_ones(b) +
          __builtin_stdc_trailing_ones(c) + __builtin_stdc_trailing_ones(d) +
          __builtin_stdc_trailing_ones(e));
}

unsigned int first_leading_zero(unsigned char a, unsigned short b,
...
unsigned int first_leading_one(unsigned char a, unsigned short b,
                               unsigned int c, unsigned long d,
                               unsigned long long e) {
...
unsigned int first_trailing_zero(unsigned char a, unsigned short b,
                                 unsigned int c, unsigned long d,
                                 unsigned long long e) {
...
unsigned int first_trailing_one(unsigned char a, unsigned short b,
                                unsigned int c, unsigned long d,
                                unsigned long long e) {
...
unsigned int count_zeros(unsigned char a, unsigned short b, unsigned int c,
                         unsigned long d, unsigned long long e) {
  return (__builtin_stdc_count_zeros(a) + __builtin_stdc_count_zeros(b) +
          __builtin_stdc_count_zeros(c) + __builtin_stdc_count_zeros(d) +
          __builtin_stdc_count_zeros(e));
}

unsigned int count_ones(unsigned char a, unsigned short b, unsigned int c,
                        unsigned long d, unsigned long long e) {
  return (__builtin_stdc_count_ones(a) + __builtin_stdc_count_ones(b) +
          __builtin_stdc_count_ones(c) + __builtin_stdc_count_ones(d) +
          __builtin_stdc_count_ones(e));
}

unsigned int has_single_bit(unsigned char a, unsigned short b, unsigned int c,
                            unsigned long d, unsigned long long e) {
  return (__builtin_stdc_has_single_bit(a) ||
          __builtin_stdc_has_single_bit(b) ||
          __builtin_stdc_has_single_bit(c) ||
          __builtin_stdc_has_single_bit(d) || __builtin_stdc_has_single_bit(e));
}

unsigned int bit_width(unsigned char a, unsigned short b, unsigned int c,
                       unsigned long d, unsigned long long e) {
  return (__builtin_stdc_bit_width(a) + __builtin_stdc_bit_width(b) +
          __builtin_stdc_bit_width(c) + __builtin_stdc_bit_width(d) +
          __builtin_stdc_bit_width(e));
}

unsigned long long bit_floor(unsigned char a, unsigned short b, unsigned int c,
                             unsigned long d, unsigned long long e) {
  return (__builtin_stdc_bit_floor(a) + __builtin_stdc_bit_floor(b) +
          __builtin_stdc_bit_floor(c) + __builtin_stdc_bit_floor(d) +
          __builtin_stdc_bit_floor(e));
}

unsigned long long bit_ceil(unsigned char a, unsigned short b, unsigned int c,
                            unsigned long d, unsigned long long e) {
  return (__builtin_stdc_bit_ceil(a) + __builtin_stdc_bit_ceil(b) +
          __builtin_stdc_bit_ceil(c) + __builtin_stdc_bit_ceil(d) +
...
main() {
  if (__builtin_stdc_leading_zeros((unsigned char)0) != __CHAR_BIT__ ||
      !expr_has_type(__builtin_stdc_leading_zeros((unsigned char)0),
                     unsigned int) ||
      __builtin_stdc_leading_zeros((unsigned short)0) !=
          __SIZEOF_SHORT__ * __CHAR_BIT__ ||
      !expr_has_type(__builtin_stdc_leading_zeros((unsigned short)0),
                     unsigned int) ||
      ...
      __builtin_stdc_leading_zeros(0ULL) !=
  ...
  if (__builtin_stdc_leading_zeros((unsigned char)3) != __CHAR_BIT__ - 2 ||
      __builtin_stdc_leading_zeros((unsigned short)9) !=
          __SIZEOF_SHORT__ * __CHAR_BIT__ - 4 ||
      __builtin_stdc_leading_zeros(34U) != __SIZEOF_INT__ * __CHAR_BIT__ - 6 ||
      __builtin_stdc_leading_zeros(130UL) !=
          __SIZEOF_LONG__ * __CHAR_BIT__ - 8 ||
      __builtin_stdc_leading_zeros(512ULL) !=
          __SIZEOF_LONG_LONG__ * __CHAR_BIT__ - 10)
    __builtin_abort();
  if (__builtin_stdc_leading_ones((unsigned char)0) != 0 ||
      !expr_has_type(__builtin_stdc_leading_ones((unsigned char)0),
                     unsigned int) ||
      __builtin_stdc_leading_ones((unsigned short)0) != 0 ||
      !expr_has_type(__builtin_stdc_leading_ones((unsigned short)0),
                     unsigned int) ||
  ...
  if (__builtin_stdc_leading_ones((unsigned char)~0U) != __CHAR_BIT__ ||
      __builtin_stdc_leading_ones((unsigned short)~0U) !=
          __SIZEOF_SHORT__ * __CHAR_BIT__ ||
  ...
  if (__builtin_stdc_leading_ones((unsigned char)~3) != __CHAR_BIT__ - 2 ||
      __builtin_stdc_leading_ones((unsigned short)~9) !=
          __SIZEOF_SHORT__ * __CHAR_BIT__ - 4 ||
      __builtin_stdc_leading_ones(~34U) != __SIZEOF_INT__ * __CHAR_BIT__ - 6 ||
      __builtin_stdc_leading_ones(~130UL) !=
          __SIZEOF_LONG__ * __CHAR_BIT__ - 8 ||
      __builtin_stdc_leading_ones(~512ULL) !=
          __SIZEOF_LONG_LONG__ * __CHAR_BIT__ - 10)
    __builtin_abort();
  if (__builtin_stdc_trailing_zeros((unsigned char)0) != __CHAR_BIT__ ||
      !expr_has_type(__builtin_stdc_trailing_zeros((unsigned char)0),
                     unsigned int) ||
      __builtin_stdc_trailing_zeros((unsigned short)0) !=
          __SIZEOF_SHORT__ * __CHAR_BIT__ ||
      !expr_has_type(__builtin_stdc_trailing_zeros((unsigned short)0),
                     unsigned int) ||
      ...
      __builtin_stdc_trailing_zeros(0ULL) !=
          __SIZEOF_LONG_LONG__ * __CHAR_BIT__ ||
  ...
  if (__builtin_stdc_trailing_ones((unsigned char)0) != 0 ||
      !expr_has_type(__builtin_stdc_trailing_ones((unsigned char)0),
                     unsigned int) ||
      __builtin_stdc_trailing_ones((unsigned short)0) != 0 ||
      !expr_has_type(__builtin_stdc_trailing_ones((unsigned short)0),
                     unsigned int) ||
  ...
  if (__builtin_stdc_trailing_ones((unsigned char)5) != 1 ||
      ...
      __builtin_stdc_trailing_ones(~0ULL >> 2) !=
          __SIZEOF_LONG_LONG__ * __CHAR_BIT__ - 2)
    __builtin_abort();
  if (__builtin_stdc_first_leading_zero((unsigned char)0) != 1 ||
      !expr_has_type(__builtin_stdc_first_leading_zero((unsigned char)0),
                     unsigned int) ||
      __builtin_stdc_first_leading_zero((unsigned short)0) != 1 ||
      !expr_has_type(__builtin_stdc_first_leading_zero((unsigned short)0),
                     unsigned int) ||
  ...
  if (__builtin_stdc_first_leading_zero((unsigned char)~0U) != 0 ||
    ...
    __builtin_abort();
  if (__builtin_stdc_first_leading_zero((unsigned char)~3U) !=
          __CHAR_BIT__ - 1 ||
      __builtin_stdc_first_leading_zero((unsigned short)~15U) !=
          __SIZEOF_SHORT__ * __CHAR_BIT__ - 3 ||
      __builtin_stdc_first_leading_zero(~63U) !=
          __SIZEOF_INT__ * __CHAR_BIT__ - 5 ||
      __builtin_stdc_first_leading_zero(~255UL) !=
          __SIZEOF_LONG__ * __CHAR_BIT__ - 7 ||
      __builtin_stdc_first_leading_zero(~1023ULL) !=
          __SIZEOF_LONG_LONG__ * __CHAR_BIT__ - 9)
    __builtin_abort();
  if (__builtin_stdc_first_leading_one((unsigned char)0) != 0 ||
      !expr_has_type(__builtin_stdc_first_leading_one((unsigned char)0),
                     unsigned int) ||
      __builtin_stdc_first_leading_one((unsigned short)0) != 0 ||
      !expr_has_type(__builtin_stdc_first_leading_one((unsigned short)0),
                     unsigned int) ||
  ...
  if (__builtin_stdc_first_leading_one((unsigned char)3) != __CHAR_BIT__ - 1 ||
      __builtin_stdc_first_leading_one((unsigned short)9) !=
          __SIZEOF_SHORT__ * __CHAR_BIT__ - 3 ||
      __builtin_stdc_first_leading_one(34U) !=
          __SIZEOF_INT__ * __CHAR_BIT__ - 5 ||
      __builtin_stdc_first_leading_one(130UL) !=
          __SIZEOF_LONG__ * __CHAR_BIT__ - 7 ||
      __builtin_stdc_first_leading_one(512ULL) !=
          __SIZEOF_LONG_LONG__ * __CHAR_BIT__ - 9)
    __builtin_abort();
  if (__builtin_stdc_first_trailing_zero((unsigned char)0) != 1 ||
      !expr_has_type(__builtin_stdc_first_trailing_zero((unsigned char)0),
                     unsigned int) ||
      __builtin_stdc_first_trailing_zero((unsigned short)0) != 1 ||
      !expr_has_type(__builtin_stdc_first_trailing_zero((unsigned short)0),
                     unsigned int) ||
  ...
  if (__builtin_stdc_first_trailing_one((unsigned char)0) != 0 ||
      !expr_has_type(__builtin_stdc_first_trailing_one((unsigned char)0),
                     unsigned int) ||
      __builtin_stdc_first_trailing_one((unsigned short)0) != 0 ||
      !expr_has_type(__builtin_stdc_first_trailing_one((unsigned short)0),
                     unsigned int) ||
  ...
  if (__builtin_stdc_count_zeros((unsigned char)0) != __CHAR_BIT__ ||
      !expr_has_type(__builtin_stdc_count_zeros((unsigned char)0),
                     unsigned int) ||
      __builtin_stdc_count_zeros((unsigned short)0) !=
          __SIZEOF_SHORT__ * __CHAR_BIT__ ||
      !expr_has_type(__builtin_stdc_count_zeros((unsigned short)0),
                     unsigned int) ||
  ...
  if (__builtin_stdc_count_zeros((unsigned char)1U) != __CHAR_BIT__ - 1 ||
      __builtin_stdc_count_zeros((unsigned short)42) !=
          __SIZEOF_SHORT__ * __CHAR_BIT__ - 3 ||
      __builtin_stdc_count_zeros(291U) != __SIZEOF_INT__ * __CHAR_BIT__ - 4 ||
      __builtin_stdc_count_zeros(~1315UL) != 5 ||
      __builtin_stdc_count_zeros(3363ULL) !=
          __SIZEOF_LONG_LONG__ * __CHAR_BIT__ - 6)
    __builtin_abort();
  if (__builtin_stdc_count_ones((unsigned char)0) != 0 ||
      !expr_has_type(__builtin_stdc_count_ones((unsigned char)0),
                     unsigned int) ||
      __builtin_stdc_count_ones((unsigned short)0) != 0 ||
      !expr_has_type(__builtin_stdc_count_ones((unsigned short)0),
                     unsigned int) ||
  ...
  if (__builtin_stdc_count_ones((unsigned char)~0U) != __CHAR_BIT__ ||
      __builtin_stdc_count_ones((unsigned short)~0U) !=
          __SIZEOF_SHORT__ * __CHAR_BIT__ ||
  ...
  if (__builtin_stdc_bit_width((unsigned char)0) != 0 ||
      !expr_has_type(__builtin_stdc_bit_width((unsigned char)0),
                     unsigned int) ||
      __builtin_stdc_bit_width((unsigned short)0) != 0 ||
      !expr_has_type(__builtin_stdc_bit_width((unsigned short)0),
                     unsigned int) ||
  ...
  if (__builtin_stdc_bit_width((unsigned char)~0U) != __CHAR_BIT__ ||
      __builtin_stdc_bit_width((unsigned short)~0U) !=
          __SIZEOF_SHORT__ * __CHAR_BIT__ ||
  ...
  if (__builtin_stdc_bit_floor((unsigned char)0) != 0 ||
    ...
    __builtin_abort();
  if (__builtin_stdc_bit_floor((unsigned char)~0U) !=
          (1U << (__CHAR_BIT__ - 1)) ||
      __builtin_stdc_bit_floor((unsigned short)~0U) !=
          (1U << (__SIZEOF_SHORT__ * __CHAR_BIT__ - 1)) ||
      __builtin_stdc_bit_floor(~0U) !=
          (1U << (__SIZEOF_INT__ * __CHAR_BIT__ - 1)) ||
      __builtin_stdc_bit_floor(~0UL) !=
          (1UL << (__SIZEOF_LONG__ * __CHAR_BIT__ - 1)) ||
      __builtin_stdc_bit_floor(~0ULL) !=
          (1ULL << (__SIZEOF_LONG_LONG__ * __CHAR_BIT__ - 1)))
    __builtin_abort();
  ...
  if (__builtin_stdc_bit_ceil((unsigned char)0) != 1 ||
      !expr_has_type(__builtin_stdc_bit_ceil((unsigned char)0),
                     unsigned char) ||
      __builtin_stdc_bit_ceil((unsigned short)0) != 1 ||
      !expr_has_type(__builtin_stdc_bit_ceil((unsigned short)0),
                     unsigned short) ||
  ...
  if (__builtin_stdc_bit_ceil((unsigned char)~0U) != 0 ||
    ...
    __builtin_abort();
  if (__builtin_stdc_bit_ceil((unsigned char)((unsigned char)~0U >> 1)) !=
          (1U << (__CHAR_BIT__ - 1)) ||
      __builtin_stdc_bit_ceil((unsigned char)((unsigned char)~0U >> 1)) !=
          (1U << (__CHAR_BIT__ - 1)) ||
      __builtin_stdc_bit_ceil((unsigned short)((unsigned short)~0U >> 1)) !=
          (1U << (__SIZEOF_SHORT__ * __CHAR_BIT__ - 1)) ||
      __builtin_stdc_bit_ceil((unsigned short)((unsigned short)~0U >> 1)) !=
          (1U << (__SIZEOF_SHORT__ * __CHAR_BIT__ - 1)) ||
      __builtin_stdc_bit_ceil(~0U >> 1) !=
          (1U << (__SIZEOF_INT__ * __CHAR_BIT__ - 1)) ||
      __builtin_stdc_bit_ceil(1U << (__SIZEOF_INT__ * __CHAR_BIT__ - 1)) !=
          (1U << (__SIZEOF_INT__ * __CHAR_BIT__ - 1)) ||
      __builtin_stdc_bit_ceil(~0UL >> 1) !=
          (1UL << (__SIZEOF_LONG__ * __CHAR_BIT__ - 1)) ||
      __builtin_stdc_bit_ceil(~0UL >> 1) !=
          (1UL << (__SIZEOF_LONG__ * __CHAR_BIT__ - 1)) ||
      __builtin_stdc_bit_ceil(1ULL
                              << (__SIZEOF_LONG_LONG__ * __CHAR_BIT__ - 1)) !=
          (1ULL << (__SIZEOF_LONG_LONG__ * __CHAR_BIT__ - 1)) ||
      __builtin_stdc_bit_ceil(~0ULL >> 1) !=
          (1ULL << (__SIZEOF_LONG_LONG__ * __CHAR_BIT__ - 1)))
    __builtin_abort();
  ...
  if (__builtin_stdc_leading_zeros((unsigned __int128)0) !=
          __SIZEOF_INT128__ * __CHAR_BIT__ ||
      !expr_has_type(__builtin_stdc_leading_zeros((unsigned __int128)0),
                     unsigned int) ||
      __builtin_stdc_leading_zeros(~(unsigned __int128)0) != 0)
    __builtin_abort();
  if (__builtin_stdc_leading_ones((unsigned __int128)0) != 0 ||
      !expr_has_type(__builtin_stdc_leading_ones((unsigned __int128)0),
                     unsigned int) ||
      __builtin_stdc_leading_ones(~(unsigned __int128)0) !=
          __SIZEOF_INT128__ * __CHAR_BIT__)
    __builtin_abort();
  if (__builtin_stdc_trailing_zeros((unsigned __int128)0) !=
          __SIZEOF_INT128__ * __CHAR_BIT__ ||
      !expr_has_type(__builtin_stdc_trailing_zeros((unsigned __int128)0),
                     unsigned int) ||
      __builtin_stdc_trailing_zeros(~(unsigned __int128)0) != 0)
    __builtin_abort();
  if (__builtin_stdc_trailing_ones((unsigned __int128)0) != 0 ||
      !expr_has_type(__builtin_stdc_trailing_ones((unsigned __int128)0),
                     unsigned int) ||
      __builtin_stdc_trailing_ones(~(unsigned __int128)0) !=
          __SIZEOF_INT128__ * __CHAR_BIT__)
    __builtin_abort();
  if (__builtin_stdc_first_leading_zero((unsigned __int128)0) != 1 ||
      !expr_has_type(__builtin_stdc_first_leading_zero((unsigned __int128)0),
                     unsigned int) ||
      __builtin_stdc_first_leading_zero(~(unsigned __int128)0) != 0)
    __builtin_abort();
  if (__builtin_stdc_first_leading_one((unsigned __int128)0) != 0 ||
      !expr_has_type(__builtin_stdc_first_leading_one((unsigned __int128)0),
                     unsigned int) ||
      __builtin_stdc_first_leading_one(~(unsigned __int128)0) != 1)
    __builtin_abort();
  if (__builtin_stdc_first_trailing_zero((unsigned __int128)0) != 1 ||
      !expr_has_type(__builtin_stdc_first_trailing_zero((unsigned __int128)0),
                     unsigned int) ||
      __builtin_stdc_first_trailing_zero(~(unsigned __int128)0) != 0)
    __builtin_abort();
  if (__builtin_stdc_first_trailing_one((unsigned __int128)0) != 0 ||
      !expr_has_type(__builtin_stdc_first_trailing_one((unsigned __int128)0),
                     unsigned int) ||
      __builtin_stdc_first_trailing_one(~(unsigned __int128)0) != 1)
    __builtin_abort();
  if (__builtin_stdc_count_zeros((unsigned __int128)0) !=
          __SIZEOF_INT128__ * __CHAR_BIT__ ||
      !expr_has_type(__builtin_stdc_count_zeros((unsigned __int128)0),
                     unsigned int) ||
      __builtin_stdc_count_zeros(~(unsigned __int128)0) != 0)
    __builtin_abort();
  if (__builtin_stdc_count_ones((unsigned __int128)0) != 0 ||
      !expr_has_type(__builtin_stdc_count_ones((unsigned __int128)0),
                     unsigned int) ||
      __builtin_stdc_count_ones(~(unsigned __int128)0) !=
          __SIZEOF_INT128__ * __CHAR_BIT__)
    __builtin_abort();
  if (__builtin_stdc_has_single_bit((unsigned __int128)0) ||
      !expr_has_type(__builtin_stdc_has_single_bit((unsigned __int128)0),
                     _Bool) ||
      __builtin_stdc_has_single_bit(~(unsigned __int128)0))
    __builtin_abort();
  if (__builtin_stdc_bit_width((unsigned __int128)0) != 0 ||
      !expr_has_type(__builtin_stdc_bit_width((unsigned __int128)0),
                     unsigned int) ||
      __builtin_stdc_bit_width(~(unsigned __int128)0) !=
          __SIZEOF_INT128__ * __CHAR_BIT__)
    __builtin_abort();
  if (__builtin_stdc_bit_floor((unsigned __int128)0) != 0 ||
      !expr_has_type(__builtin_stdc_bit_floor((unsigned __int128)0),
                     unsigned __int128) ||
      __builtin_stdc_bit_floor(~(unsigned __int128)0) !=
          ((unsigned __int128)1) << (__SIZEOF_INT128__ * __CHAR_BIT__ - 1))
    __builtin_abort();
  if (__builtin_stdc_bit_ceil((unsigned __int128)0) != 1 ||
      !expr_has_type(__builtin_stdc_bit_ceil((unsigned __int128)0),
                     unsigned __int128) ||
      __builtin_stdc_bit_ceil((unsigned __int128)1) != 1 ||
      __builtin_stdc_bit_ceil((~(unsigned __int128)0) >> 1) !=
          ((unsigned __int128)1) << (__SIZEOF_INT128__ * __CHAR_BIT__ - 1) ||
...
#error __builtin_stdc_bit_ceil not implemented
  ...
  if (__builtin_stdc_leading_zeros(a++) != __CHAR_BIT__ - 2 || a != 4)
    __builtin_abort();
  if (__builtin_stdc_leading_zeros(b++) !=
          __SIZEOF_LONG_LONG__ * __CHAR_BIT__ - 2 ||
      b != 4)
    __builtin_abort();
  ...
  if (__builtin_stdc_first_leading_one(a++) != __CHAR_BIT__ - 3 || a != 9)
    __builtin_abort();
  if (__builtin_stdc_first_leading_one(b++) !=
          __SIZEOF_LONG_LONG__ * __CHAR_BIT__ - 3 ||
      b != 9)
    __builtin_abort();
  ...
  if (__builtin_stdc_count_zeros(a++) != __CHAR_BIT__ - 3 || a != 12)
    __builtin_abort();
  if (__builtin_stdc_count_zeros(b++) !=
          __SIZEOF_LONG_LONG__ * __CHAR_BIT__ - 3 ||
      b != 12)
    __builtin_abort();
  ...
  if (__builtin_stdc_leading_zeros((unsigned _BitInt(512))0) != 512 ||
      !expr_has_type(__builtin_stdc_leading_zeros((unsigned _BitInt(512))0),
                     unsigned int) ||
      __builtin_stdc_leading_zeros((unsigned _BitInt(373))0) != 373 ||
      !expr_has_type(__builtin_stdc_leading_zeros((unsigned _BitInt(373))0),
                     unsigned int))
    __builtin_abort();
  ...
  if (__builtin_stdc_leading_ones((unsigned _BitInt(512))0) != 0 ||
      !expr_has_type(__builtin_stdc_leading_ones((unsigned _BitInt(512))0),
                     unsigned int) ||
      __builtin_stdc_leading_ones((unsigned _BitInt(373))0) != 0 ||
      !expr_has_type(__builtin_stdc_leading_ones((unsigned _BitInt(373))0),
                     unsigned int))
    __builtin_abort();
  ...
  if (__builtin_stdc_trailing_zeros((unsigned _BitInt(512))0) != 512 ||
      !expr_has_type(__builtin_stdc_trailing_zeros((unsigned _BitInt(512))0),
                     unsigned int) ||
      __builtin_stdc_trailing_zeros((unsigned _BitInt(373))0) != 373 ||
      !expr_has_type(__builtin_stdc_trailing_zeros((unsigned _BitInt(373))0),
                     unsigned int))
    __builtin_abort();
  ...
  if (__builtin_stdc_trailing_ones((unsigned _BitInt(512))0) != 0 ||
      !expr_has_type(__builtin_stdc_trailing_ones((unsigned _BitInt(512))0),
                     unsigned int) ||
      __builtin_stdc_trailing_ones((unsigned _BitInt(373))0) != 0 ||
      !expr_has_type(__builtin_stdc_trailing_ones((unsigned _BitInt(373))0),
                     unsigned int))
    __builtin_abort();
  ...
  if (__builtin_stdc_first_leading_zero((unsigned _BitInt(512))0) != 1 ||
      !expr_has_type(
          __builtin_stdc_first_leading_zero((unsigned _BitInt(512))0),
          unsigned int) ||
      __builtin_stdc_first_leading_zero((unsigned _BitInt(373))0) != 1 ||
      !expr_has_type(
          __builtin_stdc_first_leading_zero((unsigned _BitInt(373))0),
          unsigned int))
    __builtin_abort();
  if (__builtin_stdc_first_leading_zero(~(unsigned _BitInt(512))0) != 0 ||
      __builtin_stdc_first_leading_zero(~(unsigned _BitInt(373))0) != 0)
    __builtin_abort();
  if (__builtin_stdc_first_leading_zero(~(unsigned _BitInt(512))511) !=
          512 - 8 ||
      __builtin_stdc_first_leading_zero(~(unsigned _BitInt(373))1023) !=
          373 - 9)
    __builtin_abort();
  if (__builtin_stdc_first_leading_one((unsigned _BitInt(512))0) != 0 ||
      !expr_has_type(__builtin_stdc_first_leading_one((unsigned _BitInt(512))0),
                     unsigned int) ||
      __builtin_stdc_first_leading_one((unsigned _BitInt(373))0) != 0 ||
      !expr_has_type(__builtin_stdc_first_leading_one((unsigned _BitInt(373))0),
                     unsigned int))
    __builtin_abort();
  ...
  if (__builtin_stdc_first_trailing_zero((unsigned _BitInt(512))0) != 1 ||
      !expr_has_type(
          __builtin_stdc_first_trailing_zero((unsigned _BitInt(512))0),
          unsigned int) ||
      __builtin_stdc_first_trailing_zero((unsigned _BitInt(373))0) != 1 ||
      !expr_has_type(
          __builtin_stdc_first_trailing_zero((unsigned _BitInt(373))0),
          unsigned int))
    __builtin_abort();
  ...
  if (__builtin_stdc_first_trailing_one((unsigned _BitInt(512))0) != 0 ||
      !expr_has_type(
          __builtin_stdc_first_trailing_one((unsigned _BitInt(512))0),
          unsigned int) ||
      __builtin_stdc_first_trailing_one((unsigned _BitInt(373))0) != 0 ||
      !expr_has_type(
          __builtin_stdc_first_trailing_one((unsigned _BitInt(373))0),
          unsigned int))
    __builtin_abort();
  if (__builtin_stdc_first_trailing_one(~(unsigned _BitInt(512))0) != 1 ||
      __builtin_stdc_first_trailing_one(~(unsigned _BitInt(373))0) != 1)
    __builtin_abort();
  if (__builtin_stdc_first_trailing_one(((unsigned _BitInt(512))255) << 175) !=
          176 ||
      __builtin_stdc_first_trailing_one((~(unsigned _BitInt(373))0) << 311) !=
          312)
    __builtin_abort();
  if (__builtin_stdc_count_zeros((unsigned _BitInt(512))0) != 512 ||
      !expr_has_type(__builtin_stdc_count_zeros((unsigned _BitInt(512))0),
                     unsigned int) ||
      __builtin_stdc_count_zeros((unsigned _BitInt(373))0) != 373 ||
      !expr_has_type(__builtin_stdc_count_zeros((unsigned _BitInt(373))0),
                     unsigned int))
    __builtin_abort();
  ...
  if (__builtin_stdc_count_ones((unsigned _BitInt(512))0) != 0 ||
      !expr_has_type(__builtin_stdc_count_ones((unsigned _BitInt(512))0),
                     unsigned int) ||
      __builtin_stdc_count_ones((unsigned _BitInt(373))0) != 0 ||
      !expr_has_type(__builtin_stdc_count_ones((unsigned _BitInt(373))0),
                     unsigned int))
    __builtin_abort();
  ...
  if (__builtin_stdc_has_single_bit((unsigned _BitInt(512))0) ||
      !expr_has_type(__builtin_stdc_has_single_bit((unsigned _BitInt(512))0),
                     _Bool) ||
      __builtin_stdc_has_single_bit((unsigned _BitInt(373))0) ||
      !expr_has_type(__builtin_stdc_has_single_bit((unsigned _BitInt(373))0),
                     _Bool))
    __builtin_abort();
  if (__builtin_stdc_has_single_bit(~(unsigned _BitInt(512))0) ||
      __builtin_stdc_has_single_bit(~(unsigned _BitInt(373))0))
  ...
  if (__builtin_stdc_bit_width((unsigned _BitInt(512))0) != 0 ||
      !expr_has_type(__builtin_stdc_bit_width((unsigned _BitInt(512))0),
                     unsigned int) ||
      __builtin_stdc_bit_width((unsigned _BitInt(373))0) != 0 ||
      !expr_has_type(__builtin_stdc_bit_width((unsigned _BitInt(373))0),
                     unsigned int))
    __builtin_abort();
  if (__builtin_stdc_bit_width(~(unsigned _BitInt(512))0) != 512 ||
      __builtin_stdc_bit_width(~(unsigned _BitInt(373))0) != 373)
    __builtin_abort();
  if (__builtin_stdc_bit_width(((unsigned _BitInt(512))1023) << 405) !=
          405 + 10 ||
      __builtin_stdc_bit_width(((unsigned _BitInt(373))1024) << 242) !=
          242 + 11)
    __builtin_abort();
  if (__builtin_stdc_bit_floor((unsigned _BitInt(512))0) != 0 ||
      !expr_has_type(__builtin_stdc_bit_floor((unsigned _BitInt(512))0),
                     unsigned _BitInt(512)) ||
      __builtin_stdc_bit_floor((unsigned _BitInt(373))0) != 0 ||
      !expr_has_type(__builtin_stdc_bit_floor((unsigned _BitInt(373))0),
                     unsigned _BitInt(373)))
    __builtin_abort();
  if (__builtin_stdc_bit_floor(~(unsigned _BitInt(512))0) !=
          ((unsigned _BitInt(512))1) << (512 - 1) ||
      __builtin_stdc_bit_floor(~(unsigned _BitInt(373))0) !=
          ((unsigned _BitInt(373))1) << (373 - 1))
    __builtin_abort();
  if (__builtin_stdc_bit_floor(((unsigned _BitInt(512))511) << 405) !=
          (((unsigned _BitInt(512))256) << 405) ||
  ...
  if (__builtin_stdc_bit_ceil((unsigned _BitInt(512))0) != 1 ||
      !expr_has_type(__builtin_stdc_bit_ceil((unsigned _BitInt(512))0),
                     unsigned _BitInt(512)) ||
      __builtin_stdc_bit_ceil((unsigned _BitInt(373))0) != 1 ||
      !expr_has_type(__builtin_stdc_bit_ceil((unsigned _BitInt(373))0),
                     unsigned _BitInt(373)))
    __builtin_abort();
  if (__builtin_stdc_bit_ceil(~(unsigned _BitInt(512))0) != 0 ||
      __builtin_stdc_bit_ceil(~(unsigned _BitInt(373))0) != 0)
    __builtin_abort();
  if (__builtin_stdc_bit_ceil(((unsigned _BitInt(512))1) << (512 - 1)) !=
          ((unsigned _BitInt(512))1) << (512 - 1) ||
      __builtin_stdc_bit_ceil((~(unsigned _BitInt(373))0) >> 1) !=
          ((unsigned _BitInt(373))1) << (373 - 1))
    __builtin_abort();
  if (__builtin_stdc_bit_ceil(((unsigned _BitInt(512))512) << 405) !=
          (((unsigned _BitInt(512))512) << 405) ||
      __builtin_stdc_bit_ceil(((unsigned _BitInt(373))513) << 242) !=
          (((unsigned _BitInt(373))1024) << 242))
    __builtin_abort();
  if (__builtin_stdc_bit_floor((unsigned _BitInt(__BITINT_MAXWIDTH__))0) != 0)
    __builtin_abort();
  if (__builtin_stdc_bit_floor(~(unsigned _BitInt(__BITINT_MAXWIDTH__))0) !=
      ((unsigned _BitInt(__BITINT_MAXWIDTH__))1) << (__BITINT_MAXWIDTH__ - 1))
    __builtin_abort();
  if (__builtin_stdc_bit_floor(((unsigned _BitInt(__BITINT_MAXWIDTH__))511)
                               << 405) !=
          (((unsigned _BitInt(__BITINT_MAXWIDTH__))256) << 405) ||
      __builtin_stdc_bit_floor(((unsigned _BitInt(__BITINT_MAXWIDTH__))512)
                               << 405) !=
          (((unsigned _BitInt(__BITINT_MAXWIDTH__))512) << 405))
    __builtin_abort();
  ...
  if (__builtin_stdc_bit_ceil(~(unsigned _BitInt(__BITINT_MAXWIDTH__))0) != 0)
    __builtin_abort();
  if (__builtin_stdc_bit_ceil(((unsigned _BitInt(__BITINT_MAXWIDTH__))1)
                              << (__BITINT_MAXWIDTH__ - 1)) !=
      ((unsigned _BitInt(__BITINT_MAXWIDTH__))1) << (__BITINT_MAXWIDTH__ - 1))
    __builtin_abort();
  if (__builtin_stdc_bit_ceil(((unsigned _BitInt(__BITINT_MAXWIDTH__))512)
                              << 405) !=
          (((unsigned _BitInt(__BITINT_MAXWIDTH__))512) << 405) ||
      __builtin_stdc_bit_ceil(((unsigned _BitInt(__BITINT_MAXWIDTH__))513)
                              << 405) !=
          (((unsigned _BitInt(__BITINT_MAXWIDTH__))1024) << 405))
    __builtin_abort();
#endif
}
// @rewrite-fn-end
