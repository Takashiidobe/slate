...
static void gnu_attribute_cleanup(int *value) {
  gnu_cleanup_total += *value;
}

static void gnu_attribute_constructor(void) __attribute__((constructor));

static void gnu_attribute_constructor(void) {
  gnu_constructor_total = 5;
}
...
int gnu_attribute_target(int value) {
  return value + 7;
}
...
__attribute__((noinline, cold, used, visibility("hidden"),
               ...
               no_stack_protector))
int gnu_attribute_decorated(int value) {
  return value + 13;
}

static inline __attribute__((always_inline, artificial))
int gnu_attribute_inline(int value) {
  return value + 17;
}

__attribute__((flatten, hot))
static int gnu_attribute_flatten(int value) {
  return gnu_attribute_inline(value);
}

__attribute__((const))
static int gnu_attribute_const(int value) {
  return value * 2;
}

__attribute__((pure))
static int gnu_attribute_pure(const int *value) {
  return *value + 19;
}

__attribute__((nonnull(1)))
static int gnu_attribute_nonnull(const int *value) {
  return *value + 23;
}

__attribute__((warn_unused_result))
static int gnu_attribute_result(int value) {
  return value + 29;
}

__attribute__((deprecated("GNU deprecated attribute")))
static int gnu_attribute_deprecated(int value) {
  return value + 31;
}

__attribute__((format(printf, 1, 2)))
static int gnu_attribute_format(const char *format, ...) {
  return format[0] == 'f';
}

__attribute__((format_arg(1)))
static const char *gnu_attribute_format_arg(const char *format) {
  return format;
}

__attribute__((sentinel))
static int gnu_attribute_sentinel(int value, ...) {
  return value + 37;
}

__attribute__((noreturn))
static void gnu_attribute_noreturn(void) {
  exit(99);
}

__attribute__((returns_twice))
static int gnu_attribute_returns_twice(void) {
  return 41;
}

__attribute__((leaf))
static int gnu_attribute_leaf(int value) {
  return value + 43;
}
...
static int gnu_attribute_layout(void) {
  ...
  return (int)sizeof(packed) +
         (int)offsetof(struct GNUAttributePacked, value) +
         (int)_Alignof(struct GNUAttributeAligned) + packed.tag +
         (int)packed.value + aligned.value + alias_value +
         (int)sizeof(byte_value) + (int)byte_value +
         (int)sizeof(vector_value) + (int)vector_value[0] +
         (int)vector_value[3];
}
...
int main(void) {
  ...
  printf("%d %d %d %d %d %d %d %d %d %d\n",
         gnu_attribute_layout(), gnu_attribute_cleanup_scope(),
         gnu_constructor_total, gnu_attribute_alias(83),
         gnu_attribute_weakref(89), gnu_attribute_weak(),
