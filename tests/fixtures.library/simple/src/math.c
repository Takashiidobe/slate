...
// REWRITES-DAG: fn square({{arg[0-9]+}}: i32) -> i32 {
// REWRITES-DAG: let mut value: shared_value = shared_value { value: 0, mode:
// shared_mode_t::SHARED_IDLE }; REWRITES-DAG: value.value = {{arg[0-9]+}};
