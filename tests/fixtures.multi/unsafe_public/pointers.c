...
// LOWERING-DAG: pub unsafe extern "C-unwind" fn read_ptr({{arg[0-9]+}}: *mut i32) -> i32 {
...
// REWRITES-DAG: pub unsafe extern "C-unwind" fn read_ptr({{arg[0-9]+}}: *mut i32) -> i32 {
...
// LOWERING-X86_64-GNU-DAG: pub unsafe extern "C-unwind" fn read_ptr({{arg[0-9]+}}: *mut i32) -> i32 {
...
// LOWERING-AARCH64-GNU-DAG: pub unsafe extern "C-unwind" fn read_ptr({{arg[0-9]+}}: *mut i32) -> i32 {
...
// REWRITES-X86_64-GNU-DAG: pub unsafe extern "C-unwind" fn read_ptr({{arg[0-9]+}}: *mut i32) -> i32 {
// REWRITES-X86_64-GNU-DAG:     unsafe { *{{arg[0-9]+}} }
// REWRITES-X86_64-GNU-DAG: }
// SLATE-FILECHECK-END rewrites-x86_64-gnu

// SLATE-FILECHECK-BEGIN rewrites-aarch64-gnu
// REWRITES-AARCH64-GNU-DAG: #[unsafe(no_mangle)]
// REWRITES-AARCH64-GNU-DAG: pub unsafe extern "C-unwind" fn read_ptr({{arg[0-9]+}}: *mut i32) -> i32 {
// REWRITES-AARCH64-GNU-DAG:     unsafe { *{{arg[0-9]+}} }
