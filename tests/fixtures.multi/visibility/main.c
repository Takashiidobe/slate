...
int __attribute__((visibility("default"))) default_fn(void) {
    return 1;
}

int __attribute__((visibility("hidden"))) hidden_fn(void) {
    return 2;
}

int __attribute__((visibility("protected"))) protected_fn(void) {
    return 3;
}
