...
extern int slate_oracle_fegetexceptflag(unsigned short *, int);
extern int slate_oracle_fegetmode(femode_t *);
...
extern int slate_oracle_fesetexceptflag(const unsigned short *, int);
extern int slate_oracle_fesetmode(const femode_t *);
extern int slate_oracle_fesetround(int);
extern int slate_oracle_fetestexcept(int);
extern int slate_oracle_fetestexceptflag(const unsigned short *, int);
...
typedef struct femode_t slate_oracle_typedef_femode_t;
...
typedef unsigned short slate_oracle_typedef_fexcept_t;
