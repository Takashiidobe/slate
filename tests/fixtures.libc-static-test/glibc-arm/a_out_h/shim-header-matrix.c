...
_Static_assert(sizeof(struct exec) == 32, "struct exec size differs from oracle");

_Static_assert(_Alignof(struct exec) == 4, "struct exec alignment differs from oracle");
...
_Static_assert(__builtin_offsetof(struct exec, a_text) == 4, "struct exec.a_text offset differs from oracle");
...
_Static_assert(__builtin_offsetof(struct exec, a_data) == 8, "struct exec.a_data offset differs from oracle");
...
_Static_assert(__builtin_offsetof(struct exec, a_bss) == 12, "struct exec.a_bss offset differs from oracle");
...
_Static_assert(__builtin_offsetof(struct exec, a_syms) == 16, "struct exec.a_syms offset differs from oracle");
...
_Static_assert(__builtin_offsetof(struct exec, a_entry) == 20, "struct exec.a_entry offset differs from oracle");
...
_Static_assert(__builtin_offsetof(struct exec, a_trsize) == 24, "struct exec.a_trsize offset differs from oracle");
...
_Static_assert(__builtin_offsetof(struct exec, a_drsize) == 28, "struct exec.a_drsize offset differs from oracle");
