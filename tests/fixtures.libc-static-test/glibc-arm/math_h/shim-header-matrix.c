...
extern long long slate_oracle_fromfp(double, int, unsigned int);
extern long long slate_oracle_fromfpx(double, int, unsigned int);
...
extern unsigned long long slate_oracle_ufromfp(double, int, unsigned int);
extern unsigned long long slate_oracle_ufromfpx(double, int, unsigned int);
