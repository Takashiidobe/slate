...
_Static_assert(__builtin_offsetof(struct aiocb, aio_buf) == 12, "struct aiocb.aio_buf offset differs from oracle");
...
_Static_assert(__builtin_offsetof(struct aiocb, aio_nbytes) == 16, "struct aiocb.aio_nbytes offset differs from oracle");

typedef unsigned int slate_oracle_struct_aiocb_aio_nbytes;
...
typedef int slate_oracle_struct_aiocb___ret;
...
typedef long long slate_oracle_struct_aiocb_aio_offset;
